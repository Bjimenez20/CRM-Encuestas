<?php
   ...
   session_start();
    ...
    $Sel_Cmp = new GESTION_sel_cmp(); 
    $Sel_Cmp->Sel_cmp_init();
   
class GESTION_sel_cmp
{
function Sel_cmp_init()
{
   ...
   $tab_blk_campos[] = "gestiones_numero_intentos_gestion";
   $tab_ger_campos['gestiones_esperado_gestion'] = "on";
   $tab_blk_campos[] = "gestiones_esperado_gestion";
   $tab_ger_campos['gestiones_estado_ctc_gestion'] = "on";
   $tab_blk_campos[] = "gestiones_estado_ctc_gestion";
   $tab_ger_campos['gestiones_estado_farmacia_gestion'] = "on";
   $tab_blk_campos[] = "gestiones_estado_farmacia_gestion";
   ...
   $tab_blk_campos[] = "gestiones_consecutivo_betaferon";
   ...
   $tab_blk_campos[] = "gestiones_dificultad_acceso_gestion";
   $tab_ger_campos['gestiones_tipo_dificultad_gestion'] = "on";
   $tab_blk_campos[] = "gestiones_tipo_dificultad_gestion";
   $tab_ger_campos['gestiones_envios_gestion'] = "on";
   $tab_blk_campos[] = "gestiones_envios_gestion";
   $tab_ger_campos['gestiones_medicamentos_gestion'] = "on";
   $tab_blk_campos[] = "gestiones_medicamentos_gestion";
   $tab_ger_campos['gestiones_tipo_envio_gestion'] = "on";
   $tab_blk_campos[] = "gestiones_tipo_envio_gestion";
   $tab_ger_campos['gestiones_evento_adverso_gestion'] = "on";
   $tab_blk_campos[] = "gestiones_evento_adverso_gestion";
   $tab_ger_campos['gestiones_tipo_evento_adverso'] = "on";
   $tab_blk_campos[] = "gestiones_tipo_evento_adverso";
   $tab_ger_campos['gestiones_genera_solicitud_gestion'] = "on";
   $tab_blk_campos[] = "gestiones_genera_solicitud_gestion";
   $tab_ger_campos['gestiones_fecha_proxima_llamada'] = "on";
   $tab_blk_campos[] = "gestiones_fecha_proxima_llamada";
   $tab_ger_campos['gestiones_motivo_proxima_llamada'] = "on";
   $tab_blk_campos[] = "gestiones_motivo_proxima_llamada";
   $tab_ger_campos['gestiones_observacion_proxima_llamada'] = "on";
   $tab_blk_campos[] = "gestiones_observacion_proxima_llamada";
   ...
   $tab_blk_campos[] = "gestiones_usuario_asigando";
   $tab_ger_campos['gestiones_id_paciente_fk2'] = "on";
   $tab_blk_campos[] = "gestiones_id_paciente_fk2";
   ...
   $tab_blk_campos[] = "gestiones_estado_gestion";
   $tab_ger_campos['gestiones_codigo_argus'] = "on";
   $tab_blk_campos[] = "gestiones_codigo_argus";
   $tab_ger_campos['gestiones_autor_modificacion'] = "on";
   $tab_blk_campos[] = "gestiones_autor_modificacion";
   $tab_ger_campos['gestiones_numero_nebulizaciones'] = "on";
   $tab_blk_campos[] = "gestiones_numero_nebulizaciones";
   $tab_ger_campos['gestiones_fecha_subido'] = "on";
   $tab_blk_campos[] = "gestiones_fecha_subido";
   $tab_ger_campos['gestiones_numero_tabletas_diarias'] = "on";
   $tab_blk_campos[] = "gestiones_numero_tabletas_diarias";
   $tab_ger_campos['gestiones_brindo_apoyo'] = "on";
   $tab_blk_campos[] = "gestiones_brindo_apoyo";
   ...
   $tab_blk_campos[] = "gestiones_informacion_aplicaciones";
   ...
   if (isset($_SESSION['sc_session'][$this->sc_init]['GESTION']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->sc_init]['GESTION']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['GESTION']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (isset($_SESSION['sc_session'][$this->sc_init]['GESTION']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->sc_init]['GESTION']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['GESTION']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
...
function Sel_processa_out()
{
   ...
   $arr_temp = array();
   if (!isset($_SESSION['sc_session'][$this->sc_init]['GESTION']['usr_cmp_sel']))
   {
       $_SESSION['sc_session'][$this->sc_init]['GESTION']['usr_cmp_sel'] = array();
   }
   $arr_order = $_SESSION['sc_session'][$this->sc_init]['GESTION']['field_order'];
   $_SESSION['sc_session'][$this->sc_init]['GESTION']['field_order'] = array();
   $campos_sel = explode("@?@", $this->campos_sel);
   foreach ($campos_sel as $campo_order)
   {
       if (isset($tab_ger_campos[$campo_order]))
       {
           $_SESSION['sc_session'][$this->sc_init]['GESTION']['field_order'][] = $campo_order;
       }
   }
   foreach ($arr_order as $campo_order)
   {
       if (!in_array($campo_order, $_SESSION['sc_session'][$this->sc_init]['GESTION']['field_order']))
       {
           $_SESSION['sc_session'][$this->sc_init]['GESTION']['field_order'][] = $campo_order;
       }
   }
   ...
   $_SESSION['sc_session'][$this->sc_init]['GESTION']['usr_cmp_sel'] = $arr_temp;
?>
...
<?php
   ...
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if ($NM_cada_opc != "on")
           {
               $prep_combo[strtolower($NM_cada_field)] = $_SESSION['sc_session'][$this->sc_init]['GESTION']['labels'][$NM_cada_field];
           }
       }
   }
...
<?php
   if (isset($_SESSION['sc_session'][$this->sc_init]['GESTION']['field_order']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['GESTION']['field_order'] as $NM_cada_field)
       {
           if ($tab_ger_campos[$NM_cada_field] == "on")
           {
               ...
               {
?>
     <li class="sc_ui_litem scAppDivSelectFieldsEnabled" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['GESTION']['labels'][$NM_cada_field]; ?></li>
<?php
               }
               else
               {
?>
     <li class="sc_ui_litem scAppDivSelectFieldsDisabled" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['GESTION']['labels'][$NM_cada_field]; ?></li>
<?php
               }
           }
       }
