...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["fundem_____GESTION"]))
   {
      unset($_SESSION['session_sec_aplicacao']["fundem_____GESTION"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['GESTION']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['GESTION']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['GESTION']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['GESTION']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['GESTION']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['GESTION']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['GESTION']['embutida_filho'] as $ind => $sc_init)
          {
