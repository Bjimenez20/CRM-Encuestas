...
class apoyo_adempas_xls
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".xls";
      $this->tit_doc    = "apoyo_adempas.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['apoyo_adempas']['xls_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['apoyo_adempas']['xls_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['apoyo_adempas']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['apoyo_adempas']['xls_name']);
          $this->xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
   ...
   function NM_export_brindar_apoyo_fecha_apoyo()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->brindar_apoyo_fecha_apoyo, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_brindar_apoyo_motivo()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->brindar_apoyo_motivo, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   //----- brindar_apoyo_dosis
   function NM_export_brindar_apoyo_dosis()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->brindar_apoyo_dosis, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   //----- mes
   ...
   function NM_export_brindar_apoyo_razon_apoyo()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->brindar_apoyo_razon_apoyo, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['apoyo_adempas']['xls_file']);
      if (is_file($this->xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['apoyo_adempas']['xls_file'] = $this->xls_f;
      }
...
<HEAD>
 <TITLE>Apoyo Adempas :: Excel</TITLE>
