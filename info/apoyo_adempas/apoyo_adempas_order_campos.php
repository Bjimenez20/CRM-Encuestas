<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new apoyo_adempas_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class apoyo_adempas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["pacientes_id_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["pacientes_id_paciente"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["pacientes_id_paciente"] : "PAP";
   ...
   $tab_labels["pacientes_estado_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["pacientes_estado_paciente"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["pacientes_estado_paciente"] : "ESTADO PACIENTE";
   ...
   $tab_labels["pacientes_fecha_activacion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["pacientes_fecha_activacion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["pacientes_fecha_activacion_paciente"] : "FECHA ACTIVACION PACIENTE";
   $tab_ger_campos['tratamiento_fecha_inicio_terapia_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_fecha_inicio_terapia_tratamiento'] = "cmp_maior_30_3";
       $tab_converte["cmp_maior_30_3"]   = "tratamiento_fecha_inicio_terapia_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_fecha_inicio_terapia_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["tratamiento_fecha_inicio_terapia_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["tratamiento_fecha_inicio_terapia_tratamiento"] : "FECHA INICIO TERAPIA TRATAMIENTO";
   $tab_ger_campos['brindar_apoyo_fecha_apoyo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['brindar_apoyo_fecha_apoyo'] = "cmp_maior_30_4";
       $tab_converte["cmp_maior_30_4"]   = "brindar_apoyo_fecha_apoyo";
   }
   else
   {
       $tab_def_campos['brindar_apoyo_fecha_apoyo'] = "brindar_apoyo.FECHA_APOYO";
       $tab_converte["brindar_apoyo.FECHA_APOYO"]   = "brindar_apoyo_fecha_apoyo";
   }
   $tab_labels["brindar_apoyo_fecha_apoyo"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["brindar_apoyo_fecha_apoyo"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["brindar_apoyo_fecha_apoyo"] : "FECHA APOYO";
   $tab_ger_campos['brindar_apoyo_motivo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['brindar_apoyo_motivo'] = "brindar_apoyo_motivo";
       $tab_converte["brindar_apoyo_motivo"]   = "brindar_apoyo_motivo";
   }
   else
   {
       $tab_def_campos['brindar_apoyo_motivo'] = "brindar_apoyo.MOTIVO";
       $tab_converte["brindar_apoyo.MOTIVO"]   = "brindar_apoyo_motivo";
   }
   $tab_labels["brindar_apoyo_motivo"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["brindar_apoyo_motivo"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["brindar_apoyo_motivo"] : "MOTIVO";
   $tab_ger_campos['brindar_apoyo_dosis'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['brindar_apoyo_dosis'] = "brindar_apoyo_dosis";
       $tab_converte["brindar_apoyo_dosis"]   = "brindar_apoyo_dosis";
   }
   else
   {
       $tab_def_campos['brindar_apoyo_dosis'] = "brindar_apoyo.DOSIS";
       $tab_converte["brindar_apoyo.DOSIS"]   = "brindar_apoyo_dosis";
   }
   $tab_labels["brindar_apoyo_dosis"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["brindar_apoyo_dosis"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["brindar_apoyo_dosis"] : "DOSIS";
   $tab_ger_campos['mes'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['mes'] = "mes";
       $tab_converte["mes"]   = "mes";
   }
   else
   {
       $tab_def_campos['mes'] = "DATE_FORMAT(brindar_apoyo.FECHA_APOYO,'%m')";
       $tab_converte["DATE_FORMAT(brindar_apoyo.FECHA_APOYO,'%m')"]   = "mes";
   }
   $tab_labels["mes"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["mes"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["mes"] : "MES";
   $tab_ger_campos['brindar_apoyo_razon_apoyo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['brindar_apoyo_razon_apoyo'] = "cmp_maior_30_5";
       $tab_converte["cmp_maior_30_5"]   = "brindar_apoyo_razon_apoyo";
   }
   else
   {
       $tab_def_campos['brindar_apoyo_razon_apoyo'] = "brindar_apoyo.RAZON_APOYO";
       $tab_converte["brindar_apoyo.RAZON_APOYO"]   = "brindar_apoyo_razon_apoyo";
   }
   $tab_labels["brindar_apoyo_razon_apoyo"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["brindar_apoyo_razon_apoyo"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["brindar_apoyo_razon_apoyo"] : "RAZON APOYO";
   $tab_ger_campos['tratamiento_asegurador_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_asegurador_tratamiento'] = "cmp_maior_30_6";
       $tab_converte["cmp_maior_30_6"]   = "tratamiento_asegurador_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_asegurador_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["tratamiento_asegurador_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["tratamiento_asegurador_tratamiento"] : "ASEGURADOR TRATAMIENTO";
   $tab_ger_campos['tratamiento_operador_logistico_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_operador_logistico_tratamiento'] = "cmp_maior_30_7";
       $tab_converte["cmp_maior_30_7"]   = "tratamiento_operador_logistico_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_operador_logistico_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["tratamiento_operador_logistico_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["tratamiento_operador_logistico_tratamiento"] : "OPERADOR LOGISTICO TRATAMIENTO";
   $tab_ger_campos['tratamiento_medico_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_medico_tratamiento'] = "cmp_maior_30_8";
       $tab_converte["cmp_maior_30_8"]   = "tratamiento_medico_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_medico_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["tratamiento_medico_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["tratamiento_medico_tratamiento"] : "MEDICO TRATANTE";
   $tab_ger_campos['pacientes_ciudad_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_ciudad_paciente'] = "cmp_maior_30_9";
       $tab_converte["cmp_maior_30_9"]   = "pacientes_ciudad_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_ciudad_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["pacientes_ciudad_paciente"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["pacientes_ciudad_paciente"] : "CIUDAD PACIENTE";
   $tab_ger_campos['pacientes_departamento_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_departamento_paciente'] = "cmp_maior_30_10";
       $tab_converte["cmp_maior_30_10"]   = "pacientes_departamento_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_departamento_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["pacientes_departamento_paciente"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["pacientes_departamento_paciente"] : "DEPARTAMENTO PACIENTE";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "apoyo_adempas_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
