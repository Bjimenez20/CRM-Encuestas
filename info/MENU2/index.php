<?php
include_once('MENU2_session.php');
session_start();
...
else
{
    ...
    $_SESSION['scriptcase']['MENU2']['glo_nm_path_prod'] = "";
    $_SESSION['scriptcase']['MENU2']['glo_nm_perfil']    = "";
    $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] = "";
    ...
    global $MENU2_menuData;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['MENU2']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
      ...
      //check prod
      if(empty($_SESSION['scriptcase']['MENU2']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['MENU2']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
$path_libs      = $str_root . $_SESSION['scriptcase']['MENU2']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['MENU2']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['MENU2']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "MENU2/img";
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('MENU2');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/MENU2_erro.php");
}
include_once(dirname(__FILE__) . "/MENU2_erro.class.php"); 
$this->Erro = new MENU2_erro();
$str_path = substr($_SESSION['scriptcase']['MENU2']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['MENU2']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['MENU2']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$MENU2_menuData         = array();
$MENU2_menuData['path'] = array();
$MENU2_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $MENU2_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $MENU2_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $MENU2_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $MENU2_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$MENU2_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$MENU2_menuData['url']['web']   = str_replace("\\", '/', $MENU2_menuData['url']['web']);
$MENU2_menuData['path']['root'] = substr($MENU2_menuData['path']['sys'],  0, -1 * strlen($MENU2_menuData['url']['web']));
$MENU2_menuData['path']['app']  = substr($MENU2_menuData['path']['sys'],  0, strrpos($MENU2_menuData['path']['sys'],  '/'));
$MENU2_menuData['path']['link'] = substr($MENU2_menuData['path']['app'],  0, strrpos($MENU2_menuData['path']['app'],  '/'));
$MENU2_menuData['path']['link'] = substr($MENU2_menuData['path']['link'], 0, strrpos($MENU2_menuData['path']['link'], '/')) . '/';
$MENU2_menuData['path']['app'] .= '/';
$MENU2_menuData['url']['app']   = substr($MENU2_menuData['url']['web'],  0, strrpos($MENU2_menuData['url']['web'],  '/'));
$MENU2_menuData['url']['link']  = substr($MENU2_menuData['url']['app'],  0, strrpos($MENU2_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] == "S")
{
    $MENU2_menuData['url']['link']  = substr($MENU2_menuData['url']['link'], 0, strrpos($MENU2_menuData['url']['link'], '/'));
}
$MENU2_menuData['url']['link']  .= '/';
$MENU2_menuData['url']['app']   .= '/';
...
include_once("MENU2_toolbar.php");

$this->tab_grupo[0] = "fundem/";
if ($_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
}

     $_SESSION['scriptcase']['menu_atual'] = "MENU2";
     $_SESSION['scriptcase']['menu_apls']['MENU2'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['MENU2']['glo_nm_conexao']) && $_SESSION['scriptcase']['MENU2']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['MENU2']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['MENU2']['glo_nm_perfil']) && $_SESSION['scriptcase']['MENU2']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['MENU2']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['MENU2']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['MENU2']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
{
    $_SESSION['sc_session'][1]['MENU2']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['MENU2']['init']))
{
    $_SESSION['sc_session'][1]['MENU2']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['MENU2']['init'];
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_MENU2'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_MENU2'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_MENU2'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['MENU2']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['MENU2']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'MENU2'))
{
    $_SESSION['sc_session'][1]['MENU2']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_MENU2'] = "javascript:window.close()";
}
/* Menú de configuración de las variables */
$MENU2_menuData['iframe'] = TRUE;
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("HISTORICO_RECLAMACIONES") . "/HISTORICO_RECLAMACIONES_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['HISTORICO_RECLAMACIONES']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['HISTORICO_RECLAMACIONES'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("BD_General") . "/BD_General_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['BD_General']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['BD_General'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("reconcialiacion") . "/reconcialiacion_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['reconcialiacion']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['reconcialiacion'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("EA") . "/EA_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['EA']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['EA'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[0]))
{
 ...
 $nm_var_lab[1] = "Hist�rico Reclamaci�n";
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_MENU2'];
if (isset($_SESSION['scriptcase']['sc_apl_seg']['ULTIMA_GESTION']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['ULTIMA_GESTION']) == "on")
{
    $MENU2_menuData['data'] .= "item_8|.|" . $nm_var_lab[0] . "|MENU2_form_php.php?sc_item_menu=item_8&sc_apl_menu=ULTIMA_GESTION&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->MENU2_target('_self') . "|" . "\n";
}
else
{
    $MENU2_menuData['data'] .= "item_8|.|" . $nm_var_lab[0] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['HISTORICO_RECLAMACIONES']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['HISTORICO_RECLAMACIONES']) == "on")
{
    $MENU2_menuData['data'] .= "item_7|.|" . $nm_var_lab[1] . "|MENU2_form_php.php?sc_item_menu=item_7&sc_apl_menu=HISTORICO_RECLAMACIONES&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->MENU2_target('_self') . "|" . "\n";
}
else
{
    $MENU2_menuData['data'] .= "item_7|.|" . $nm_var_lab[1] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['BD_General']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['BD_General']) == "on")
{
    $MENU2_menuData['data'] .= "item_3|.|" . $nm_var_lab[2] . "|MENU2_form_php.php?sc_item_menu=item_3&sc_apl_menu=BD_General&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->MENU2_target('_self') . "|" . "\n";
}
else
{
    $MENU2_menuData['data'] .= "item_3|.|" . $nm_var_lab[2] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['Conciliacion_in']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Conciliacion_in']) == "on")
{
    $MENU2_menuData['data'] .= "item_6|.|" . $nm_var_lab[3] . "|MENU2_form_php.php?sc_item_menu=item_6&sc_apl_menu=Conciliacion_in&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->MENU2_target('_self') . "|" . "\n";
}
else
{
    $MENU2_menuData['data'] .= "item_6|.|" . $nm_var_lab[3] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['Conciliacion_out']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Conciliacion_out']) == "on")
{
    $MENU2_menuData['data'] .= "item_4|.|" . $nm_var_lab[4] . "|MENU2_form_php.php?sc_item_menu=item_4&sc_apl_menu=Conciliacion_out&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->MENU2_target('_self') . "|" . "\n";
}
else
{
    $MENU2_menuData['data'] .= "item_4|.|" . $nm_var_lab[4] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['reconcialiacion']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['reconcialiacion']) == "on")
{
    $MENU2_menuData['data'] .= "item_10|.|" . $nm_var_lab[5] . "|MENU2_form_php.php?sc_item_menu=item_10&sc_apl_menu=reconcialiacion&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->MENU2_target('_self') . "|" . "\n";
}
else
{
    $MENU2_menuData['data'] .= "item_10|.|" . $nm_var_lab[5] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['EA']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['EA']) == "on")
{
    $MENU2_menuData['data'] .= "item_11|.|" . $nm_var_lab[6] . "|MENU2_form_php.php?sc_item_menu=item_11&sc_apl_menu=EA&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->MENU2_target('_self') . "|" . "\n";
}
else
{
    $MENU2_menuData['data'] .= "item_11|.|" . $nm_var_lab[6] . "||||_self|disabled\n";
}

$MENU2_menuData['data'] = array();
$str_disabled = "N";
$str_link = "MENU2_form_php.php?sc_item_menu=item_8&sc_apl_menu=ULTIMA_GESTION&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ULTIMA_GESTION']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ULTIMA_GESTION']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $MENU2_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->MENU2_target('_self') . "\"",
        'sc_id'    => "item_8",
        'disabled' => $str_disabled,
    );
$str_disabled = "N";
$str_link = "MENU2_form_php.php?sc_item_menu=item_7&sc_apl_menu=HISTORICO_RECLAMACIONES&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['HISTORICO_RECLAMACIONES']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['HISTORICO_RECLAMACIONES']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "MENU2_form_php.php?sc_item_menu=item_3&sc_apl_menu=BD_General&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['BD_General']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['BD_General']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "MENU2_form_php.php?sc_item_menu=item_6&sc_apl_menu=Conciliacion_in&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Conciliacion_in']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Conciliacion_in']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "MENU2_form_php.php?sc_item_menu=item_4&sc_apl_menu=Conciliacion_out&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Conciliacion_out']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Conciliacion_out']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "MENU2_form_php.php?sc_item_menu=item_10&sc_apl_menu=reconcialiacion&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['reconcialiacion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['reconcialiacion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "MENU2_form_php.php?sc_item_menu=item_11&sc_apl_menu=EA&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['EA']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['EA']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['MENU2']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['MENU2']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'MENU2');
    $MENU2_menuData['data'] = $str_menu_usu;
}
if (is_file("MENU2_help.txt"))
{
    $Arq_WebHelp = file("MENU2_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $MENU2_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->MENU2_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                );
            }
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['MENU2']) && !empty($_SESSION['scriptcase']['sc_menu_del']['MENU2']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($MENU2_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['MENU2']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($MENU2_menuData['data'][$i_menu]);
       }
    ...
    $MENU2_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['MENU2']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['MENU2']))
{
    $disable_menu = false;
    foreach ($MENU2_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['MENU2']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $MENU2_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabecera HTML */
if ($MENU2_menuData['iframe'])
{
    $MENU2_menuData['height'] = '100%';
?>
...
{
    $MENU2_menuData['height'] = '30px';
}

/* Archivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['MENU2']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['MENU2']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['MENU2']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
<?php
 $seq = 0;
 foreach ($MENU2_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'MENU2_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    tmp += "</div>";
    var home_style="";
    if(str_id === 'MENU2'){ home_style=";padding-left:4px;min-height:14px;"; }
...
function mudaIframe(str_id)
{
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            Iframe_atual = "MENU2_" + Tab_iframes[i] + '_iframe';
        } else {
...
{
    str_target_sv = "";
    if (str_id != "iframe_MENU2")
    {
        str_target_sv = str_id + "_iframe";
        str_id        = str_id.replace("MENU2_","");
    }
    str_link   = $('#' + str_id).attr('item-href');
    str_target = $('#' + str_id).attr('item-target');
    if (str_target == "MENU2_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        ...
        if (str_id != "MENU2" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
...
<div id="idDivMenu">
<?php
echo $this->MENU2_escreveMenu($MENU2_menuData['data']);
?>
</div>
       </td></tr></table>
<?php
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $MENU2_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
    ...
    <td id="Iframe_control" style="border-width: 1px; height: 100%; padding: 0px;vertical-align:top;text-align:center;">
      <iframe id="iframe_MENU2" name="MENU2_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "MENU2_pag_ini.php"); ?>"></iframe>
<?php
 foreach ($MENU2_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
         echo "      <iframe id=\"iframe_" . $dados_menu['id'] . "\" name= \"MENU2_" . $dados_menu['id'] . "_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;width: 100%; height: 100%;\" src=\"\"></iframe>
";
     }
 }
}
...
/* Control de Target */
function MENU2_escreveMenu($arr_menu)
{
    $last      = '';
    $itemClass = ' topfirst';
    $subSize   = 2;
...
?>
<?php echo str_repeat(' ', $tabSpace * $intMult); ?><a href="#" onclick="openMenuItem('MENU2_<?php echo $aMenuItemList[$i]['id']; ?>');" item-href="<?php echo $aMenuItemList[$i]['link']; ?>" id="<?php echo $aMenuItemList[$i]['id']; ?>" title="<?php echo $aMenuItemList[$i]['hint']; ?>"<?php echo $aMenuItemList[$i]['target'] . $sDisabledClass; ?>><?php echo $iconHtml . $aMenuItemList[$i]['label']; ?></a>
<?php
        }
        if (($aMenuItemList[$i + 1] && $aMenuItemList[$i]['level'] == $aMenuItemList[$i + 1]['level']) || 
...
function MENU2_target($str_target)
{
    global $MENU2_menuData;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $MENU2_menuData, $path_imag_cab)
{
}
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "MENU2_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "MENU2_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->MENU2_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        if (!isset($_SESSION['scriptcase']['MENU2']['sc_init'][$apl_menu]))
        {
            $_SESSION['scriptcase']['MENU2']['sc_init'][$apl_menu] = rand(2, 10000);
        }
        $_SESSION['sc_session'][$_SESSION['scriptcase']['MENU2']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['MENU2']['sc_init'][$apl_menu];
   }
...
$contr_MENU2 = new MENU2_class;
$contr_MENU2->MENU2_menu();
