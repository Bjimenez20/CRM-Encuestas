<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new ultima_gestion_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class ultima_gestion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["pacientes_id_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_id_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_id_paciente"] : "PAP";
   ...
   $tab_labels["pacientes_estado_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_estado_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_estado_paciente"] : "ESTADO PACIENTE";
   ...
   $tab_labels["pacientes_fecha_activacion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_fecha_activacion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_fecha_activacion_paciente"] : "FECHA ACTIVACION PACIENTE";
   ...
   $tab_labels["pacientes_fecha_retiro_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_fecha_retiro_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_fecha_retiro_paciente"] : "FECHA RETIRO PACIENTE";
   ...
   $tab_labels["pacientes_motivo_retiro_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_motivo_retiro_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_motivo_retiro_paciente"] : "MOTIVO RETIRO PACIENTE";
   $tab_ger_campos['pacientes_identificacion_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_identificacion_paciente'] = "cmp_maior_30_5";
       $tab_converte["cmp_maior_30_5"]   = "pacientes_identificacion_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_identificacion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_identificacion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_identificacion_paciente"] : "IDENTIFICACION PACIENTE";
   $tab_ger_campos['pacientes_observacion_motivo_retiro_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_observacion_motivo_retiro_paciente'] = "cmp_maior_30_6";
       $tab_converte["cmp_maior_30_6"]   = "pacientes_observacion_motivo_retiro_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_observacion_motivo_retiro_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_observacion_motivo_retiro_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_observacion_motivo_retiro_paciente"] : "OBSERVACION MOTIVO RETIRO PACIENTE";
   ...
   $tab_labels["pacientes_nombre_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_nombre_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_nombre_paciente"] : "NOMBRE PACIENTE";
   ...
   $tab_labels["pacientes_apellido_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_apellido_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_apellido_paciente"] : "APELLIDO PACIENTE";
   ...
   $tab_labels["pacientes_telefono_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_telefono_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_telefono_paciente"] : "TELEFONO PACIENTE";
   $tab_ger_campos['pacientes_id_ultima_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_id_ultima_gestion'] = "cmp_maior_30_10";
       $tab_converte["cmp_maior_30_10"]   = "pacientes_id_ultima_gestion";
   }
   else
   {
   ...
   $tab_labels["pacientes_id_ultima_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_id_ultima_gestion"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["pacientes_id_ultima_gestion"] : "ID ULTIMA GESTION";
   ...
   $tab_labels["gestiones_id_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["gestiones_id_gestion"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["gestiones_id_gestion"] : "ID GESTION";
   $tab_ger_campos['gestiones_motivo_comunicacion_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_motivo_comunicacion_gestion'] = "cmp_maior_30_11";
       $tab_converte["cmp_maior_30_11"]   = "gestiones_motivo_comunicacion_gestion";
   }
   else
   {
   ...
   $tab_labels["gestiones_motivo_comunicacion_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["gestiones_motivo_comunicacion_gestion"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["gestiones_motivo_comunicacion_gestion"] : "MOTIVO COMUNICACION GESTION";
   $tab_ger_campos['gestiones_fecha_programada_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_fecha_programada_gestion'] = "cmp_maior_30_12";
       $tab_converte["cmp_maior_30_12"]   = "gestiones_fecha_programada_gestion";
   }
   else
   {
   ...
   $tab_labels["gestiones_fecha_programada_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["gestiones_fecha_programada_gestion"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["gestiones_fecha_programada_gestion"] : "FECHA PROGRAMADA GESTION";
   $tab_ger_campos['gestiones_fecha_comunicacion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_fecha_comunicacion'] = "cmp_maior_30_13";
       $tab_converte["cmp_maior_30_13"]   = "gestiones_fecha_comunicacion";
   }
   else
   {
   ...
   $tab_labels["gestiones_fecha_comunicacion"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["gestiones_fecha_comunicacion"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["gestiones_fecha_comunicacion"] : "FECHA COMUNICACION";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['ultima_gestion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['ultima_gestion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['ultima_gestion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['ultima_gestion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['ultima_gestion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['ultima_gestion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['ultima_gestion']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "ultima_gestion_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['ultima_gestion']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
