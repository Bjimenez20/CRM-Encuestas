...
class ultima_gestion_csv
{
   ...
   function inicializa_vars()
   {
     global $nm_lang;
      ...
      $this->arquivo    .= ".csv";
      $this->tit_doc    = "ultima_gestion.csv";
      $this->delim_dados = "\"";
      $this->delim_col   = ";";
      $this->delim_line  = "\r\n";
   }
   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['csv_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['csv_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['csv_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['csv_name']);
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
...
<HEAD>
 <TITLE>Ultima Gestion :: CSV</TITLE>
