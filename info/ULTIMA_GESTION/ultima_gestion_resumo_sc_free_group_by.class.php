...
class ultima_gestion_resumo
{
   ...
   //---- 
   function ultima_gestion_resumo($tipo = "")
   {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['contr_total_geral'] == "OK")
      {
          $this->array_total_gestiones_fecha_programada_gestion = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['gestiones_fecha_programada_gestion'];
          $this->array_total_gestiones_fecha_comunicacion = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['gestiones_fecha_comunicacion'];
          $this->array_total_pacientes_estado_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['pacientes_estado_paciente'];
          $this->array_total_tratamiento_producto_tratamiento = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['tratamiento_producto_tratamiento'];
          $this->array_total_gestiones_autor_gestion = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['gestiones_autor_gestion'];
      }
      else
      {
          $this->array_total_gestiones_fecha_programada_gestion = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['gestiones_fecha_programada_gestion'] = $this->array_total_gestiones_fecha_programada_gestion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['gestiones_fecha_comunicacion'] = $this->array_total_gestiones_fecha_comunicacion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['pacientes_estado_paciente'] = $this->array_total_pacientes_estado_paciente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['tratamiento_producto_tratamiento'] = $this->array_total_tratamiento_producto_tratamiento;
      $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['gestiones_autor_gestion'] = $this->array_total_gestiones_autor_gestion;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['labels'][''] = "FECHA PROGRAMADA GESTION"; 
       $prep_field['gestiones_fecha_comunicacion'] = "FECHA COMUNICACION";
       $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['labels'][''] = "FECHA COMUNICACION"; 
       $prep_field['pacientes_estado_paciente'] = "ESTADO PACIENTE";
       $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['labels'][''] = "ESTADO PACIENTE"; 
       $prep_field['tratamiento_producto_tratamiento'] = "PRODUCTO TRATAMIENTO";
       $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['labels'][''] = "PRODUCTO TRATAMIENTO"; 
       $prep_field['gestiones_autor_gestion'] = "AUTOR GESTION";
       $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['labels'][''] = "AUTOR GESTION"; 
       $Str_gb = "";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['summarizing_fields_control'] = array(
               'NM_Count' => array(
      ...
      eval ($Str_gb);
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_tabular'];
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['comb_table_def']  = array();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_ultima_gestion_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_ultima_gestion_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function resumo_init()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->tipo)
      {
         require_once($this->Ini->path_aplicacao . "ultima_gestion_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['opcao'] = "print";
      ...
      $this->total   = new ultima_gestion_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_sc_free_group_by("res", $this->array_total_gestiones_fecha_programada_gestion, $this->array_total_gestiones_fecha_comunicacion, $this->array_total_pacientes_estado_paciente, $this->array_total_tratamiento_producto_tratamiento, $this->array_total_gestiones_autor_gestion);
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_ultima_gestion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_ultima_gestion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_ultima_gestion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "ultima_gestion/ultima_gestion_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "ultima_gestion/ultima_gestion_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&language=es&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "ultima_gestion/ultima_gestion_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "ultima_gestion/ultima_gestion_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "ultima_gestion/ultima_gestion_config_graf_flash.php?nome_apl=ultima_gestion&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "ultima_gestion/ultima_gestion_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnGroupByShow('" . $this->Ini->path_link . "ultima_gestion/ultima_gestion_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("ultima_gestion_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'ultima_gestion_config_pivot.php?nome_apl=ultima_gestion&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida(" }\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "ultima_gestion/ultima_gestion_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  {\r\n");
   $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "ultima_gestion/ultima_gestion_iframe.php?nmgp_opcao=pdf_res&scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_ultima_gestion_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "ultima_gestion/ultima_gestion_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_gestiones_fecha_programada_gestion, $quebra_gestiones_fecha_comunicacion, $quebra_pacientes_estado_paciente, $quebra_tratamiento_producto_tratamiento, $quebra_gestiones_autor_gestion, $quebra_gestiones_fecha_programada_gestion_orig, $quebra_gestiones_fecha_comunicacion_orig, $quebra_pacientes_estado_paciente_orig, $quebra_tratamiento_producto_tratamiento_orig, $quebra_gestiones_autor_gestion_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->pacientes_identificacion_paciente = $rs_res->fields[5] ;  
            $this->pacientes_observacion_motivo_retiro_paciente = $rs_res->fields[6] ;  
            ...
            $this->pacientes_id_ultima_gestion = $rs_res->fields[10] ;  
            $this->gestiones_id_gestion = $rs_res->fields[11] ;  
            $this->gestiones_motivo_comunicacion_gestion = $rs_res->fields[12] ;  
            $this->gestiones_fecha_programada_gestion = $rs_res->fields[13] ;  
            $this->gestiones_fecha_comunicacion = $rs_res->fields[14] ;  
            $this->tratamiento_producto_tratamiento = $rs_res->fields[15] ;  
            $this->gestiones_autor_gestion = $rs_res->fields[16] ;  
            $this->gestiones_fecha_comunicacion = substr($this->gestiones_fecha_comunicacion, 0, 7);
            ...
            $this->nm_data->SetaData($this->gestiones_fecha_comunicacion, "YYYY-MM");
            $this->gestiones_fecha_comunicacion = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "mmaaaa"));
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->gestiones_fecha_programada_gestion, $this->gestiones_fecha_comunicacion, $this->pacientes_estado_paciente, $this->tratamiento_producto_tratamiento, $this->gestiones_autor_gestion, $this->gestiones_fecha_programada_gestion_orig,  $this->gestiones_fecha_comunicacion_orig,  $this->pacientes_estado_paciente_orig,  $this->tratamiento_producto_tratamiento_orig,  $this->gestiones_autor_gestion_orig);
            }
   }
//
