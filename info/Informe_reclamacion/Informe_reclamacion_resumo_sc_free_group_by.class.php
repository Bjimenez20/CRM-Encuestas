...
class Informe_reclamacion_resumo
{
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_id_paciente;
   var $array_total_estado_paciente;
   ...
   function Informe_reclamacion_resumo($tipo = "")
   {
      ...
      $this->array_total_id_paciente     = array();
      $this->array_total_estado_paciente = array();
   ...
   function monta_resumo($b_export = false)
   {
      ...
      {
          $this->array_total_id_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion']['arr_total']['id_paciente'];
          $this->array_total_estado_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion']['arr_total']['estado_paciente'];
      }
      else
      {
          $this->array_total_id_paciente = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion']['arr_total']['id_paciente'] = $this->array_total_id_paciente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion']['arr_total']['estado_paciente'] = $this->array_total_estado_paciente;
   ...
   function completeMatrix()
   {
       ...
       //-----
       $prep_field = array();
       $prep_field['id_paciente'] = "ID PACIENTE";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion']['labels'][''] = "ID PACIENTE"; 
       $prep_field['estado_paciente'] = "ESTADO PACIENTE";
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['id_paciente']['alin'] = "''";
       $Arr_parms['id_paciente']['link'] = "S";
       $Arr_parms['estado_paciente']['alin'] = "''";
       $Arr_parms['estado_paciente']['link'] = "S";
       $Arr_parms['id_paciente']['fill'] = "true";
       $Arr_parms['id_paciente']['order'] = "label";
       $Arr_parms['estado_paciente']['fill'] = "true";
       $Arr_parms['estado_paciente']['order'] = "label";
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['id_paciente'] = array(0 => 'id_paciente', 1 => '');
       $prep_links_fl['estado_paciente'] = array(0 => 'estado_paciente', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function totaliza()
   {
      $this->total->resumo_sc_free_group_by("res", $this->array_total_id_paciente, $this->array_total_estado_paciente);
      ksort($this->array_total_id_paciente);
      ksort($this->array_total_estado_paciente);
      if ("out" == $this->tipo)
      {
         $this->total->quebra_geral();
      }
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_id_paciente, $quebra_estado_paciente, $quebra_id_paciente_orig, $quebra_estado_paciente_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->id_paciente = $rs_res->fields[0] ;  
            $this->logro_comunicacion_gestion = $rs_res->fields[1] ;  
            $this->fecha_comunicacion = $rs_res->fields[2] ;  
            $this->autor_gestion = $rs_res->fields[3] ;  
            $this->departamento_paciente = $rs_res->fields[4] ;  
            $this->ciudad_paciente = $rs_res->fields[5] ;  
            $this->estado_paciente = $rs_res->fields[6] ;  
            $this->status_paciente = $rs_res->fields[7] ;  
            $this->fecha_activacion_paciente = $rs_res->fields[8] ;  
            $this->fecha_retiro_paciente = $rs_res->fields[9] ;  
            $this->motivo_retiro_paciente = $rs_res->fields[10] ;  
            $this->fecha_inicio_terapia_tratamiento = $rs_res->fields[11] ;  
            $this->codigo_xofigo = $rs_res->fields[12] ;  
            $this->clasificacion_patologica_tratamiento = $rs_res->fields[13] ;  
            $this->producto_tratamiento = $rs_res->fields[14] ;  
            $this->nombre_referencia = $rs_res->fields[15] ;  
            $this->dosis_tratamiento = $rs_res->fields[16] ;  
            $this->fecha_medicamento_hasta = $rs_res->fields[17] ;  
            $this->numero_cajas = $rs_res->fields[18] ;  
            $this->asegurador_tratamiento = $rs_res->fields[19] ;  
            $this->operador_logistico_tratamiento = $rs_res->fields[20] ;  
            $this->punto_entrega = $rs_res->fields[21] ;  
            $this->ips_atiende_tratamiento = $rs_res->fields[22] ;  
            $this->regimen_tratamiento = $rs_res->fields[23] ;  
            $this->medico_tratamiento = $rs_res->fields[24] ;  
            $this->tratamiento_previo = $rs_res->fields[25] ;  
            $this->reclamo_gestion = $rs_res->fields[26] ;  
            $this->fecha_reclamacion_gestion = $rs_res->fields[27] ;  
            $this->causa_no_reclamacion_gestion = $rs_res->fields[28] ;  
            $this->descripcion_comunicacion_gestion = $rs_res->fields[29] ;  
            $this->fecha_programada_gestion = $rs_res->fields[30] ;  
            $this->id_ultima_gestion = $rs_res->fields[31] ;  
            $this->id_tratamiento = $rs_res->fields[32] ;  
            $this->id_paciente_fk = $rs_res->fields[33] ;  
            $this->paap = $rs_res->fields[34] ;  
            $this->sub_paap = $rs_res->fields[35] ;  
            $this->barrera = $rs_res->fields[36] ;  
            $this->fecha_ini_paap = $rs_res->fields[37] ;  
            $this->fecha_fin_paap = $rs_res->fields[38] ;  
            $this->id_gestion = $rs_res->fields[39] ;  
            $this->id_paciente_orig = $this->id_paciente;
            $this->estado_paciente_orig = $this->estado_paciente;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->id_paciente, $this->estado_paciente, $this->id_paciente_orig,  $this->estado_paciente_orig);
            }
   }
//
