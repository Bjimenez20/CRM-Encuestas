...
class Informe_paciente1_xls
{
   ...
   var $tit_doc;
   //---- 
   function Informe_paciente1_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".xls";
      $this->tit_doc    = "Informe_paciente1.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_paciente1']['xls_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_paciente1']['xls_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_paciente1']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_paciente1']['xls_name']);
          $this->xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_paciente1']['xls_file']);
      if (is_file($this->xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_paciente1']['xls_file'] = $this->xls_f;
      }
...
<HEAD>
 <TITLE>PACIENTE TERAPIA :: Excel</TITLE>
