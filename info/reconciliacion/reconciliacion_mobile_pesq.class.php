...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_gestiones_fecha_comunicacion"  <?php echo $str_hide_gestiones_fecha_comunicacion?>><?php
      $gestiones_fecha_comunicacion_look = substr($this->Db->qstr($gestiones_fecha_comunicacion), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_gestiones_fecha_comunicacion" name="gestiones_fecha_comunicacion_autocomp" size="10" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_gestiones_fecha_comunicacion"  <?php echo $str_display_gestiones_fecha_comunicacion; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_gestiones_fecha_comunicacion_input_2" name="gestiones_fecha_comunicacion_input_2" value="<?php echo NM_encode_input($gestiones_fecha_comunicacion_input_2) ?>"   size="10" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
