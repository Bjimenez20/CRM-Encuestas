...
class reconciliacion_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . reconciliacion_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . reconciliacion_pack_protect_string($Tipo_filter[0]) . "\">.." . reconciliacion_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_gestiones_fecha_comunicacion')
      {
          $gestiones_fecha_comunicacion = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_gestiones_fecha_comunicacion($gestiones_fecha_comunicacion);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_gestiones_fecha_comunicacion($gestiones_fecha_comunicacion)
   {
      $gestiones_fecha_comunicacion = substr($this->Db->qstr($gestiones_fecha_comunicacion), 1, -1);
            $gestiones_fecha_comunicacion_look = substr($this->Db->qstr($gestiones_fecha_comunicacion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct gestiones.FECHA_COMUNICACION from " . $this->Ini->nm_tabela . " where  gestiones.FECHA_COMUNICACION like '%" . $gestiones_fecha_comunicacion . "%'"; 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>reconciliacion/reconciliacion_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="reconciliacion_ajax_search.js"></script>
 <script type="text/javascript" src="reconciliacion_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_gestiones_fecha_comunicacion#NMF#' + search_get_text('SC_gestiones_fecha_comunicacion') + '@NMF@';
  str_out += 'id_ac_gestiones_fecha_comunicacion#NMF#' + search_get_text('id_ac_gestiones_fecha_comunicacion') + '@NMF@';
  str_out += 'SC_gestiones_fecha_comunicacion_input_2#NMF#' + search_get_text('SC_gestiones_fecha_comunicacion_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_gestiones_fecha_comunicacion").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_gestiones_fecha_comunicacion",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_gestiones_fecha_comunicacion").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_gestiones_fecha_comunicacion").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Reconciliacion</span></td>
...
<?php
   ...
   {
      global 
             $gestiones_fecha_comunicacion_cond, $gestiones_fecha_comunicacion, $gestiones_fecha_comunicacion_input_2, $gestiones_fecha_comunicacion_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $gestiones_fecha_comunicacion = $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']['gestiones_fecha_comunicacion']; 
          $gestiones_fecha_comunicacion_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']['gestiones_fecha_comunicacion_input_2']; 
          $gestiones_fecha_comunicacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']['gestiones_fecha_comunicacion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']['NM_operador']; 
      } 
...
<?php
   if (is_file("reconciliacion_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['gestiones_fecha_comunicacion'])) ? $this->New_label['gestiones_fecha_comunicacion'] : "FECHA COMUNICACION"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_gestiones_fecha_comunicacion_cond" name="gestiones_fecha_comunicacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_gestiones_fecha_comunicacion'), this, 'gestiones_fecha_comunicacion')">
       ...
       <OPTION value="qp" <?php if ("qp" == $gestiones_fecha_comunicacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
...
<?php
      $gestiones_fecha_comunicacion_look = substr($this->Db->qstr($gestiones_fecha_comunicacion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct gestiones.FECHA_COMUNICACION from " . $this->Ini->nm_tabela . " where gestiones.FECHA_COMUNICACION = '$gestiones_fecha_comunicacion_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$gestiones_fecha_comunicacion]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$gestiones_fecha_comunicacion];
      }
      else
      {
          $sAutocompValue = $gestiones_fecha_comunicacion;
      }
?>
<INPUT  type="text" id="SC_gestiones_fecha_comunicacion" name="gestiones_fecha_comunicacion" value="<?php echo NM_encode_input($gestiones_fecha_comunicacion) ?>" size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_gestiones_fecha_comunicacion" name="gestiones_fecha_comunicacion_autocomp" size="10" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_gestiones_fecha_comunicacion"  <?php echo $str_display_gestiones_fecha_comunicacion; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_gestiones_fecha_comunicacion_input_2" name="gestiones_fecha_comunicacion_input_2" value="<?php echo NM_encode_input($gestiones_fecha_comunicacion_input_2) ?>"   size="10" class="sc-js-input sc-js-input scFilterObjectOdd">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['reconciliacion']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['reconciliacion']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.gestiones_fecha_comunicacion.value = "";
   document.F1.gestiones_fecha_comunicacion_autocomp.value = "";
   document.F1.gestiones_fecha_comunicacion_input_2.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "prueba/reconciliacion";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_gestiones_fecha_comunicacion'] = 'text_aut';
      $tp_fields['id_ac_gestiones_fecha_comunicacion'] = 'text_aut';
      $tp_fields['SC_gestiones_fecha_comunicacion_input_2'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $gestiones_fecha_comunicacion_cond, $gestiones_fecha_comunicacion, $gestiones_fecha_comunicacion_input_2, $gestiones_fecha_comunicacion_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($gestiones_fecha_comunicacion_autocomp) && empty($gestiones_fecha_comunicacion))
      {
          $gestiones_fecha_comunicacion = $gestiones_fecha_comunicacion_autocomp;
      }
      $gestiones_fecha_comunicacion_cond_salva = $gestiones_fecha_comunicacion_cond; 
      if (!isset($gestiones_fecha_comunicacion_input_2) || $gestiones_fecha_comunicacion_input_2 == "")
      {
          $gestiones_fecha_comunicacion_input_2 = $gestiones_fecha_comunicacion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']['gestiones_fecha_comunicacion'] = $gestiones_fecha_comunicacion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']['gestiones_fecha_comunicacion_input_2'] = $gestiones_fecha_comunicacion_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']['gestiones_fecha_comunicacion_cond'] = $gestiones_fecha_comunicacion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']['NM_operador'] = $this->NM_operador; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['gestiones_fecha_comunicacion'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['gestiones_fecha_comunicacion'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['gestiones_fecha_comunicacion'] = $gestiones_fecha_comunicacion;
      }
      $Conteudo = $gestiones_fecha_comunicacion_input_2;
      $this->cmp_formatado['gestiones_fecha_comunicacion_input_2'] = $Conteudo;

      //----- $gestiones_fecha_comunicacion
      $this->Date_part = false;
      if (isset($gestiones_fecha_comunicacion) || $gestiones_fecha_comunicacion_cond == "nu" || $gestiones_fecha_comunicacion_cond == "nn" || $gestiones_fecha_comunicacion_cond == "ep" || $gestiones_fecha_comunicacion_cond == "ne")
      {
         $this->monta_condicao("gestiones.FECHA_COMUNICACION", $gestiones_fecha_comunicacion_cond, $gestiones_fecha_comunicacion, $gestiones_fecha_comunicacion_input_2, "gestiones_fecha_comunicacion");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['contr_array_resumo'] = "NAO";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['where_pesq_ant'] = $this->comando . $this->comando_fim;
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['fast_search']);
