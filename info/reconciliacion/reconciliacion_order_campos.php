<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new reconciliacion_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class reconciliacion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["pacientes_id_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["pacientes_id_paciente"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["pacientes_id_paciente"] : "CODIGO DE USUARIO";
   ...
   $tab_labels["gestiones_fecha_comunicacion"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["gestiones_fecha_comunicacion"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["gestiones_fecha_comunicacion"] : "FECHA COMUNICACION";
   ...
   $tab_labels["pacientes_nombre_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["pacientes_nombre_paciente"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["pacientes_nombre_paciente"] : "NOMBRE";
   ...
   $tab_labels["pacientes_apellido_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["pacientes_apellido_paciente"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["pacientes_apellido_paciente"] : "APELLIDO";
   $tab_ger_campos['tratamiento_producto_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_producto_tratamiento'] = "cmp_maior_30_4";
       $tab_converte["cmp_maior_30_4"]   = "tratamiento_producto_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_producto_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["tratamiento_producto_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["tratamiento_producto_tratamiento"] : "PRODUCTO";
   $tab_ger_campos['pacientes_ciudad_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_ciudad_paciente'] = "cmp_maior_30_5";
       $tab_converte["cmp_maior_30_5"]   = "pacientes_ciudad_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_ciudad_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["pacientes_ciudad_paciente"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["pacientes_ciudad_paciente"] : "CIUDAD";
   $tab_ger_campos['gestiones_evento_adverso_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_evento_adverso_gestion'] = "cmp_maior_30_6";
       $tab_converte["cmp_maior_30_6"]   = "gestiones_evento_adverso_gestion";
   }
   else
   {
   ...
   $tab_labels["gestiones_evento_adverso_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["gestiones_evento_adverso_gestion"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["gestiones_evento_adverso_gestion"] : "EVENTO ADVERSO";
   ...
   $tab_labels["gestiones_codigo_argus"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["gestiones_codigo_argus"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["gestiones_codigo_argus"] : "CODIGO ARGUS";
   ...
   $tab_labels["gestiones_autor_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["gestiones_autor_gestion"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["gestiones_autor_gestion"] : "AUTOR";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['reconciliacion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['reconciliacion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['reconciliacion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['reconciliacion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['reconciliacion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['reconciliacion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['reconciliacion']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "reconciliacion_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['reconciliacion']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
