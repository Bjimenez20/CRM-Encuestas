...
class Informe_reclamacion_historial_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function Informe_reclamacion_historial_resumo($tipo = "")
   {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['contr_total_geral'] == "OK")
      {
          $this->array_total_pacientes_id_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['arr_total']['pacientes_id_paciente'];
          $this->array_total_pacientes_estado_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['arr_total']['pacientes_estado_paciente'];
      }
      else
      {
          $this->array_total_pacientes_id_paciente = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['arr_total']['pacientes_id_paciente'] = $this->array_total_pacientes_id_paciente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['arr_total']['pacientes_estado_paciente'] = $this->array_total_pacientes_estado_paciente;
   ...
   function completeMatrix()
   {
       ...
       //-----
       $prep_field = array();
       $prep_field['pacientes_id_paciente'] = "ID PACIENTE";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['labels'][''] = "ID PACIENTE"; 
       $prep_field['pacientes_estado_paciente'] = "ESTADO PACIENTE";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['labels'][''] = "ESTADO PACIENTE"; 
       $Str_gb = "";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['summarizing_fields_control'] = array(
               'NM_Count' => array(
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['gestiones.RECLAMO_GESTION']['alin'] = "''";
       $Arr_parms['gestiones.RECLAMO_GESTION']['link'] = "S";
       $Arr_parms['gestiones.CAUSA_NO_RECLAMACION_GESTION']['alin'] = "''";
       $Arr_parms['gestiones.CAUSA_NO_RECLAMACION_GESTION']['link'] = "S";
       $Arr_parms['gestiones.FECHA_RECLAMACION_GESTION']['alin'] = "''";
       $Arr_parms['gestiones.FECHA_RECLAMACION_GESTION']['link'] = "S";
       $Arr_parms['gestiones.FECHA_COMUNICACION']['alin'] = "''";
       $Arr_parms['gestiones.FECHA_COMUNICACION']['link'] = "S";
       ...
       $prep_links_fl['gestiones.RECLAMO_GESTION'] = array(0 => 'gestiones.RECLAMO_GESTION', 1 => '@aspass@');
       $prep_links_fl['gestiones.CAUSA_NO_RECLAMACION_GESTION'] = array(0 => 'gestiones.CAUSA_NO_RECLAMACION_GESTION', 1 => '@aspass@');
       $prep_links_fl['gestiones.FECHA_RECLAMACION_GESTION'] = array(0 => 'gestiones.FECHA_RECLAMACION_GESTION', 1 => '@aspass@');
       $prep_links_fl['gestiones.FECHA_COMUNICACION'] = array(0 => 'gestiones.FECHA_COMUNICACION', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_order_sort'];
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("ID PACIENTE"),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['comb_table_def']  = array();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_Informe_reclamacion_historial_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_Informe_reclamacion_historial_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->tipo)
      {
         require_once($this->Ini->path_aplicacao . "Informe_reclamacion_historial_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['opcao'] = "print";
      ...
      $this->total   = new Informe_reclamacion_historial_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_sc_free_group_by("res", $this->array_total_pacientes_id_paciente, $this->array_total_pacientes_estado_paciente);
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Informe_reclamacion_historial_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_Informe_reclamacion_historial_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Informe_reclamacion_historial_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "Informe_reclamacion_historial/Informe_reclamacion_historial_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Informe_reclamacion_historial/Informe_reclamacion_historial_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&language=es&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Informe_reclamacion_historial/Informe_reclamacion_historial_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "nm_gp_move('csv_res', '1')", "nm_gp_move('csv_res', '1')", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Informe_reclamacion_historial/Informe_reclamacion_historial_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Informe_reclamacion_historial/Informe_reclamacion_historial_config_graf_flash.php?nome_apl=Informe_reclamacion_historial&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "Informe_reclamacion_historial/Informe_reclamacion_historial_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnGroupByShow('" . $this->Ini->path_link . "Informe_reclamacion_historial/Informe_reclamacion_historial_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("Informe_reclamacion_historial_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'Informe_reclamacion_historial_config_pivot.php?nome_apl=Informe_reclamacion_historial&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "Informe_reclamacion_historial/Informe_reclamacion_historial_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  {\r\n");
   $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "Informe_reclamacion_historial/Informe_reclamacion_historial_iframe.php?nmgp_opcao=pdf_res&scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Informe_reclamacion_historial_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "Informe_reclamacion_historial/Informe_reclamacion_historial_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_pacientes_id_paciente, $quebra_pacientes_estado_paciente, $quebra_pacientes_id_paciente_orig, $quebra_pacientes_estado_paciente_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->gestiones_logro_comunicacion_gestion = $rs_res->fields[1] ;  
            $this->gestiones_fecha_comunicacion = $rs_res->fields[2] ;  
            $this->gestiones_autor_gestion = $rs_res->fields[3] ;  
            $this->pacientes_departamento_paciente = $rs_res->fields[4] ;  
            $this->pacientes_ciudad_paciente = $rs_res->fields[5] ;  
            $this->pacientes_estado_paciente = $rs_res->fields[6] ;  
            $this->pacientes_status_paciente = $rs_res->fields[7] ;  
            $this->pacientes_fecha_activacion_paciente = $rs_res->fields[8] ;  
            $this->pacientes_codigo_xofigo = $rs_res->fields[9] ;  
            $this->tratamiento_producto_tratamiento = $rs_res->fields[10] ;  
            $this->tratamiento_nombre_referencia = $rs_res->fields[11] ;  
            $this->tratamiento_dosis_tratamiento = $rs_res->fields[12] ;  
            $this->gestiones_numero_cajas = $rs_res->fields[13] ;  
            $this->tratamiento_asegurador_tratamiento = $rs_res->fields[14] ;  
            $this->tratamiento_operador_logistico_tratamiento = $rs_res->fields[15] ;  
            $this->tratamiento_punto_entrega = $rs_res->fields[16] ;  
            $this->gestiones_reclamo_gestion = $rs_res->fields[17] ;  
            $this->gestiones_fecha_reclamacion_gestion = $rs_res->fields[18] ;  
            $this->gestiones_causa_no_reclamacion_gestion = $rs_res->fields[19] ;  
            $this->historial_reclamacion_id_historial_reclamacion = $rs_res->fields[20] ;  
            $this->historial_reclamacion_anio_historial_reclamacion = $rs_res->fields[21] ;  
            $this->historial_reclamacion_mes1 = $rs_res->fields[22] ;  
            $this->historial_reclamacion_reclamo1 = $rs_res->fields[23] ;  
            $this->historial_reclamacion_fecha_reclamacion1 = $rs_res->fields[24] ;  
            $this->historial_reclamacion_motivo_no_reclamacion1 = $rs_res->fields[25] ;  
            $this->historial_reclamacion_mes2 = $rs_res->fields[26] ;  
            $this->historial_reclamacion_reclamo2 = $rs_res->fields[27] ;  
            $this->historial_reclamacion_fecha_reclamacion2 = $rs_res->fields[28] ;  
            $this->historial_reclamacion_motivo_no_reclamacion2 = $rs_res->fields[29] ;  
            $this->historial_reclamacion_mes3 = $rs_res->fields[30] ;  
            $this->historial_reclamacion_reclamo3 = $rs_res->fields[31] ;  
            $this->historial_reclamacion_fecha_reclamacion3 = $rs_res->fields[32] ;  
            $this->historial_reclamacion_motivo_no_reclamacion3 = $rs_res->fields[33] ;  
            $this->historial_reclamacion_mes4 = $rs_res->fields[34] ;  
            $this->historial_reclamacion_reclamo4 = $rs_res->fields[35] ;  
            $this->historial_reclamacion_fecha_reclamacion4 = $rs_res->fields[36] ;  
            $this->historial_reclamacion_motivo_no_reclamacion4 = $rs_res->fields[37] ;  
            $this->historial_reclamacion_mes5 = $rs_res->fields[38] ;  
            $this->historial_reclamacion_reclamo5 = $rs_res->fields[39] ;  
            $this->historial_reclamacion_fecha_reclamacion5 = $rs_res->fields[40] ;  
            $this->historial_reclamacion_motivo_no_reclamacion5 = $rs_res->fields[41] ;  
            $this->historial_reclamacion_mes6 = $rs_res->fields[42] ;  
            $this->historial_reclamacion_reclamo6 = $rs_res->fields[43] ;  
            $this->historial_reclamacion_fecha_reclamacion6 = $rs_res->fields[44] ;  
            $this->historial_reclamacion_motivo_no_reclamacion6 = $rs_res->fields[45] ;  
            $this->historial_reclamacion_mes7 = $rs_res->fields[46] ;  
            $this->historial_reclamacion_reclamo7 = $rs_res->fields[47] ;  
            $this->historial_reclamacion_fecha_reclamacion7 = $rs_res->fields[48] ;  
            $this->historial_reclamacion_motivo_no_reclamacion7 = $rs_res->fields[49] ;  
            $this->historial_reclamacion_mes8 = $rs_res->fields[50] ;  
            $this->historial_reclamacion_reclamo8 = $rs_res->fields[51] ;  
            $this->historial_reclamacion_fecha_reclamacion8 = $rs_res->fields[52] ;  
            $this->historial_reclamacion_motivo_no_reclamacion8 = $rs_res->fields[53] ;  
            $this->historial_reclamacion_mes9 = $rs_res->fields[54] ;  
            $this->historial_reclamacion_reclamo9 = $rs_res->fields[55] ;  
            $this->historial_reclamacion_fecha_reclamacion9 = $rs_res->fields[56] ;  
            $this->historial_reclamacion_motivo_no_reclamacion9 = $rs_res->fields[57] ;  
            $this->historial_reclamacion_mes10 = $rs_res->fields[58] ;  
            $this->historial_reclamacion_reclamo10 = $rs_res->fields[59] ;  
            $this->historial_reclamacion_fecha_reclamacion10 = $rs_res->fields[60] ;  
            $this->historial_reclamacion_motivo_no_reclamacion10 = $rs_res->fields[61] ;  
            $this->historial_reclamacion_mes11 = $rs_res->fields[62] ;  
            $this->historial_reclamacion_reclamo11 = $rs_res->fields[63] ;  
            $this->historial_reclamacion_fecha_reclamacion11 = $rs_res->fields[64] ;  
            $this->historial_reclamacion_motivo_no_reclamacion11 = $rs_res->fields[65] ;  
            $this->historial_reclamacion_mes12 = $rs_res->fields[66] ;  
            $this->historial_reclamacion_reclamo12 = $rs_res->fields[67] ;  
            $this->historial_reclamacion_fecha_reclamacion12 = $rs_res->fields[68] ;  
            $this->historial_reclamacion_motivo_no_reclamacion12 = $rs_res->fields[69] ;  
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->pacientes_id_paciente, $this->pacientes_estado_paciente, $this->pacientes_id_paciente_orig,  $this->pacientes_estado_paciente_orig);
            }
   }
//
