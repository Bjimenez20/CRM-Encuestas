...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "pacientes_edad_paciente";$Nm_numeric[] = "pacientes_codigo_xofigo";$Nm_numeric[] = "pacientes_id_ultima_gestion";$Nm_numeric[] = "tratamiento_id_tratamiento";$Nm_numeric[] = "tratamiento_id_paciente_fk";$Nm_numeric[] = "pacientes_edad_paciente";$Nm_numeric[] = "pacientes_codigo_xofigo";$Nm_numeric[] = "pacientes_id_ultima_gestion";$Nm_numeric[] = "tratamiento_id_tratamiento";$Nm_numeric[] = "tratamiento_id_paciente_fk";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_pacientes_status_paciente"  <?php echo $str_hide_pacientes_status_paciente?>><?php
      $pacientes_status_paciente_look = substr($this->Db->qstr($pacientes_status_paciente), 1, -1); 
      $nmgp_def_dados = array(); 
