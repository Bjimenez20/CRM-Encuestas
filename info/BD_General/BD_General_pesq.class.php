...
class BD_General_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . BD_General_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . BD_General_pack_protect_string($Tipo_filter[0]) . "\">.." . BD_General_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_pacientes_status_paciente')
      {
          $pacientes_status_paciente = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_pacientes_status_paciente($pacientes_status_paciente);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_pacientes_status_paciente($pacientes_status_paciente)
   {
      $pacientes_status_paciente = substr($this->Db->qstr($pacientes_status_paciente), 1, -1);
            $pacientes_status_paciente_look = substr($this->Db->qstr($pacientes_status_paciente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pacientes.STATUS_PACIENTE from " . $this->Ini->nm_tabela . " where tratamiento.NOMBRE_REFERENCIA NOT LIKE 'XARELTO%' AND tratamiento.NOMBRE_REFERENCIA NOT LIKE 'EYLIA%' and  pacientes.STATUS_PACIENTE like '%" . $pacientes_status_paciente . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>BD_General/BD_General_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="BD_General_ajax_search.js"></script>
 <script type="text/javascript" src="BD_General_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_pacientes_status_paciente_cond#NMF#' + search_get_sel_txt('SC_pacientes_status_paciente_cond') + '@NMF@';
  str_out += 'SC_pacientes_status_paciente#NMF#' + search_get_text('SC_pacientes_status_paciente') + '@NMF@';
  str_out += 'id_ac_pacientes_status_paciente#NMF#' + search_get_text('id_ac_pacientes_status_paciente') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_pacientes_status_paciente").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_pacientes_status_paciente",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_pacientes_status_paciente").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_pacientes_status_paciente").val( $(this).val() );
       }
     }
   });
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $pacientes_status_paciente_cond, $pacientes_status_paciente, $pacientes_status_paciente_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $pacientes_fecha_activacion_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['pacientes_fecha_activacion_paciente']; 
          $pacientes_fecha_activacion_paciente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['pacientes_fecha_activacion_paciente_cond']; 
          $pacientes_estado_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['pacientes_estado_paciente']; 
          $pacientes_estado_paciente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['pacientes_estado_paciente_cond']; 
          $pacientes_status_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['pacientes_status_paciente']; 
          $pacientes_status_paciente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['pacientes_status_paciente_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($pacientes_status_paciente_cond) || empty($pacientes_status_paciente_cond))
      {
         $pacientes_status_paciente_cond = "qp";
      }
      ...
      $str_hide_pacientes_status_paciente = (in_array($pacientes_status_paciente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($pacientes_status_paciente) || $pacientes_status_paciente == "")
      {
          $pacientes_status_paciente = "";
      }
      if (isset($pacientes_status_paciente) && !empty($pacientes_status_paciente))
      {
         $tmp_pos = strpos($pacientes_status_paciente, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $pacientes_status_paciente = substr($pacientes_status_paciente, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("BD_General_help.txt"))
   {
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_pacientes_estado_paciente" name="pacientes_estado_paciente_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['pacientes_status_paciente'])) ? $this->New_label['pacientes_status_paciente'] : "STATUS PACIENTE"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_pacientes_status_paciente_cond" name="pacientes_status_paciente_cond" onChange="nm_campos_between(document.getElementById('id_vis_pacientes_status_paciente'), this, 'pacientes_status_paciente')">
       <OPTION value="qp" <?php if ("qp" == $pacientes_status_paciente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $pacientes_status_paciente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $pacientes_status_paciente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $pacientes_status_paciente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pacientes_status_paciente" <?php echo $str_hide_pacientes_status_paciente?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['pacientes_status_paciente'])) ? $this->New_label['pacientes_status_paciente'] : "STATUS PACIENTE";
 $nmgp_tab_label .= "pacientes_status_paciente?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $pacientes_status_paciente_look = substr($this->Db->qstr($pacientes_status_paciente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pacientes.STATUS_PACIENTE from " . $this->Ini->nm_tabela . " where tratamiento.NOMBRE_REFERENCIA NOT LIKE 'XARELTO%' AND tratamiento.NOMBRE_REFERENCIA NOT LIKE 'EYLIA%' and pacientes.STATUS_PACIENTE = '$pacientes_status_paciente_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$pacientes_status_paciente]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$pacientes_status_paciente];
      }
      else
      {
          $sAutocompValue = $pacientes_status_paciente;
      }
?>
<INPUT  type="text" id="SC_pacientes_status_paciente" name="pacientes_status_paciente" value="<?php echo NM_encode_input($pacientes_status_paciente) ?>" size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_pacientes_status_paciente" name="pacientes_status_paciente_autocomp" size="30" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['BD_General']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['BD_General']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_pacientes_status_paciente'), document.F1.pacientes_status_paciente_cond, 'pacientes_status_paciente');
   document.F1.pacientes_status_paciente.value = "";
   document.F1.pacientes_status_paciente_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_pacientes_status_paciente_cond'] = 'cond';
      $tp_fields['SC_pacientes_status_paciente'] = 'text_aut';
      $tp_fields['id_ac_pacientes_status_paciente'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      global $pacientes_fecha_activacion_paciente_cond, $pacientes_fecha_activacion_paciente, $pacientes_fecha_activacion_paciente_autocomp,
             $pacientes_estado_paciente_cond, $pacientes_estado_paciente, $pacientes_estado_paciente_autocomp,
             $pacientes_status_paciente_cond, $pacientes_status_paciente, $pacientes_status_paciente_autocomp, $nmgp_tab_label;
      ...
      if (!empty($pacientes_status_paciente_autocomp) && empty($pacientes_status_paciente))
      {
          $pacientes_status_paciente = $pacientes_status_paciente_autocomp;
      }
      ...
      $pacientes_status_paciente_cond_salva = $pacientes_status_paciente_cond; 
      if (!isset($pacientes_status_paciente_input_2) || $pacientes_status_paciente_input_2 == "")
      {
          $pacientes_status_paciente_input_2 = $pacientes_status_paciente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['pacientes_fecha_activacion_paciente'] = $pacientes_fecha_activacion_paciente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['pacientes_fecha_activacion_paciente_cond'] = $pacientes_fecha_activacion_paciente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['pacientes_estado_paciente'] = $pacientes_estado_paciente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['pacientes_estado_paciente_cond'] = $pacientes_estado_paciente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['pacientes_status_paciente'] = $pacientes_status_paciente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['pacientes_status_paciente_cond'] = $pacientes_status_paciente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['NM_operador'] = $this->NM_operador; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['pacientes_status_paciente'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['pacientes_status_paciente'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['pacientes_status_paciente'] = $pacientes_status_paciente;
      }
      ...
      //----- $pacientes_status_paciente
      $this->Date_part = false;
      if (isset($pacientes_status_paciente) || $pacientes_status_paciente_cond == "nu" || $pacientes_status_paciente_cond == "nn" || $pacientes_status_paciente_cond == "ep" || $pacientes_status_paciente_cond == "ne")
      {
         $this->monta_condicao("pacientes.STATUS_PACIENTE", $pacientes_status_paciente_cond, $pacientes_status_paciente, "", "pacientes_status_paciente");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['where_pesq_ant'] = $this->comando . $this->comando_fim;
