...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["fundem_____BD_General"]))
   {
      unset($_SESSION['session_sec_aplicacao']["fundem_____BD_General"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['BD_General']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['BD_General']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['BD_General']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['BD_General']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['BD_General']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['BD_General']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['BD_General']['embutida_filho'] as $ind => $sc_init)
          {
