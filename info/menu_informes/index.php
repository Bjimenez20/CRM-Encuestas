<?php
include_once('menu_informes_session.php');
session_start();
...
else
{
    ...
    $_SESSION['scriptcase']['menu_informes']['glo_nm_path_prod'] = "";
    $_SESSION['scriptcase']['menu_informes']['glo_nm_perfil']    = "";
    $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] = "";

ob_start();

class menu_informes_class
{
  var $Db;
 ...
 function menu_informes_menu()
 {
    global $menu_informes_menuData;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['menu_informes']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
      ...
      //check prod
      if(empty($_SESSION['scriptcase']['menu_informes']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['menu_informes']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_informes']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_informes']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_informes']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_informes/img";
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('menu_informes');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_informes_erro.php");
}
include_once(dirname(__FILE__) . "/menu_informes_erro.class.php"); 
$this->Erro = new menu_informes_erro();
$str_path = substr($_SESSION['scriptcase']['menu_informes']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_informes']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_informes']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$menu_informes_menuData         = array();
$menu_informes_menuData['path'] = array();
$menu_informes_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_informes_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_informes_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_informes_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_informes_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_informes_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_informes_menuData['url']['web']   = str_replace("\\", '/', $menu_informes_menuData['url']['web']);
$menu_informes_menuData['path']['root'] = substr($menu_informes_menuData['path']['sys'],  0, -1 * strlen($menu_informes_menuData['url']['web']));
$menu_informes_menuData['path']['app']  = substr($menu_informes_menuData['path']['sys'],  0, strrpos($menu_informes_menuData['path']['sys'],  '/'));
$menu_informes_menuData['path']['link'] = substr($menu_informes_menuData['path']['app'],  0, strrpos($menu_informes_menuData['path']['app'],  '/'));
$menu_informes_menuData['path']['link'] = substr($menu_informes_menuData['path']['link'], 0, strrpos($menu_informes_menuData['path']['link'], '/')) . '/';
$menu_informes_menuData['path']['app'] .= '/';
$menu_informes_menuData['url']['app']   = substr($menu_informes_menuData['url']['web'],  0, strrpos($menu_informes_menuData['url']['web'],  '/'));
$menu_informes_menuData['url']['link']  = substr($menu_informes_menuData['url']['app'],  0, strrpos($menu_informes_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] == "S")
{
    $menu_informes_menuData['url']['link']  = substr($menu_informes_menuData['url']['link'], 0, strrpos($menu_informes_menuData['url']['link'], '/'));
}
$menu_informes_menuData['url']['link']  .= '/';
$menu_informes_menuData['url']['app']   .= '/';
...
include_once("menu_informes_toolbar.php");

$this->tab_grupo[0] = "prueba/";
if ($_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
}

     $_SESSION['scriptcase']['menu_atual'] = "menu_informes";
     $_SESSION['scriptcase']['menu_apls']['menu_informes'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_informes']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_informes']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_informes']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_informes']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_informes']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_informes']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_informes']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_informes']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
{
    $_SESSION['sc_session'][1]['menu_informes']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_informes']['init']))
{
    $_SESSION['sc_session'][1]['menu_informes']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_informes']['init'];
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_informes'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_informes'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_informes'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_informes']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_informes']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_informes'))
{
    $_SESSION['sc_session'][1]['menu_informes']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_informes'] = "javascript:window.close()";
}
/* Menú de configuración de las variables */
$menu_informes_menuData['iframe'] = TRUE;

if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("lis_pacientes") . "/lis_pacientes_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['lis_pacientes']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['lis_pacientes'] = "on";
    }
}
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Informe_paciente1") . "/Informe_paciente1_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Informe_paciente1']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['Informe_paciente1'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Informe_reclamacion") . "/Informe_reclamacion_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Informe_reclamacion']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['Informe_reclamacion'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Informe_reclamacion_historial") . "/Informe_reclamacion_historial_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Informe_reclamacion_historial']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['Informe_reclamacion_historial'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("generador_de_informes") . "/generador_de_informes_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['generador_de_informes']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['generador_de_informes'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("ultima_gestion") . "/ultima_gestion_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ultima_gestion']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['ultima_gestion'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("conciliacion_out") . "/conciliacion_out_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['conciliacion_out']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['conciliacion_out'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Conciliacion_in") . "/Conciliacion_in_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Conciliacion_in']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['Conciliacion_in'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("reconciliacion") . "/reconciliacion_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['reconciliacion']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['reconciliacion'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("apoyo_adempas") . "/apoyo_adempas_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['apoyo_adempas']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['apoyo_adempas'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_envio_muestra") . "/grid_envio_muestra_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_envio_muestra']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_envio_muestra'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
ob_end_clean();
 ...
 $nm_var_lab[0] = "Listado Pacientes";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[1]))
{
 ...
 $nm_var_lab[2] = "Informe Reclamacion";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[2]))
{
 ...
 $nm_var_lab[3] = "Informe Reclamacion Historial";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[3]))
{
 ...
 $nm_var_lab[4] = "Generador de Informes";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[9]))
{
 ...
 $nm_var_lab[10] = "Aplicaciones Eylia";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[10]))
{
 ...
 $nm_var_lab[11] = "Envio Muestras Medicas";
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_informes'];
if (isset($_SESSION['scriptcase']['sc_apl_seg']['lis_pacientes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['lis_pacientes']) == "on")
{
    $menu_informes_menuData['data'] .= "item_6|.|" . $nm_var_lab[0] . "|menu_informes_form_php.php?sc_item_menu=item_6&sc_apl_menu=lis_pacientes&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->menu_informes_target('_self') . "|" . "\n";
}
else
{
    $menu_informes_menuData['data'] .= "item_6|.|" . $nm_var_lab[0] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['Informe_paciente1']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Informe_paciente1']) == "on")
{
    $menu_informes_menuData['data'] .= "item_8|.|" . $nm_var_lab[1] . "|menu_informes_form_php.php?sc_item_menu=item_8&sc_apl_menu=Informe_paciente1&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->menu_informes_target('_self') . "|" . "\n";
}
else
{
    $menu_informes_menuData['data'] .= "item_8|.|" . $nm_var_lab[1] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['Informe_reclamacion']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Informe_reclamacion']) == "on")
{
    $menu_informes_menuData['data'] .= "item_7|.|" . $nm_var_lab[2] . "|menu_informes_form_php.php?sc_item_menu=item_7&sc_apl_menu=Informe_reclamacion&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_informes_target('_self') . "|" . "\n";
}
else
{
    $menu_informes_menuData['data'] .= "item_7|.|" . $nm_var_lab[2] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['Informe_reclamacion_historial']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Informe_reclamacion_historial']) == "on")
{
    $menu_informes_menuData['data'] .= "item_9|.|" . $nm_var_lab[3] . "|menu_informes_form_php.php?sc_item_menu=item_9&sc_apl_menu=Informe_reclamacion_historial&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->menu_informes_target('_self') . "|" . "\n";
}
else
{
    $menu_informes_menuData['data'] .= "item_9|.|" . $nm_var_lab[3] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['generador_de_informes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['generador_de_informes']) == "on")
{
    $menu_informes_menuData['data'] .= "item_3|.|" . $nm_var_lab[4] . "|menu_informes_form_php.php?sc_item_menu=item_3&sc_apl_menu=generador_de_informes&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->menu_informes_target('_self') . "|" . "\n";
}
else
{
    $menu_informes_menuData['data'] .= "item_3|.|" . $nm_var_lab[4] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['ultima_gestion']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['ultima_gestion']) == "on")
{
    $menu_informes_menuData['data'] .= "item_1|.|" . $nm_var_lab[5] . "|menu_informes_form_php.php?sc_item_menu=item_1&sc_apl_menu=ultima_gestion&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_informes_target('_self') . "|" . "\n";
}
else
{
    $menu_informes_menuData['data'] .= "item_1|.|" . $nm_var_lab[5] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['conciliacion_out']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['conciliacion_out']) == "on")
{
    $menu_informes_menuData['data'] .= "item_2|.|" . $nm_var_lab[6] . "|menu_informes_form_php.php?sc_item_menu=item_2&sc_apl_menu=conciliacion_out&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->menu_informes_target('_self') . "|" . "\n";
}
else
{
    $menu_informes_menuData['data'] .= "item_2|.|" . $nm_var_lab[6] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['Conciliacion_in']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Conciliacion_in']) == "on")
{
    $menu_informes_menuData['data'] .= "item_4|.|" . $nm_var_lab[7] . "|menu_informes_form_php.php?sc_item_menu=item_4&sc_apl_menu=Conciliacion_in&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "||" . $this->menu_informes_target('_self') . "|" . "\n";
}
else
{
    $menu_informes_menuData['data'] .= "item_4|.|" . $nm_var_lab[7] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['reconciliacion']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['reconciliacion']) == "on")
{
    $menu_informes_menuData['data'] .= "item_5|.|" . $nm_var_lab[8] . "|menu_informes_form_php.php?sc_item_menu=item_5&sc_apl_menu=reconciliacion&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "||" . $this->menu_informes_target('_self') . "|" . "\n";
}
else
{
    $menu_informes_menuData['data'] .= "item_5|.|" . $nm_var_lab[8] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['apoyo_adempas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['apoyo_adempas']) == "on")
{
    $menu_informes_menuData['data'] .= "item_10|.|" . $nm_var_lab[9] . "|menu_informes_form_php.php?sc_item_menu=item_10&sc_apl_menu=apoyo_adempas&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "||" . $this->menu_informes_target('_self') . "|" . "\n";
}
else
{
    $menu_informes_menuData['data'] .= "item_10|.|" . $nm_var_lab[9] . "||||_self|disabled\n";
}
$menu_informes_menuData['data'] .= "item_11|.|" . $nm_var_lab[10] . "|menu_informes_form_php.php?sc_item_menu=item_11&sc_apl_menu=../../presentacion/form_exportar_consulta_aplicaciones.php&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[10] . "||" . $this->menu_informes_target('_self') . "|" . "\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_envio_muestra']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_envio_muestra']) == "on")
{
    $menu_informes_menuData['data'] .= "item_12|.|" . $nm_var_lab[11] . "|menu_informes_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_envio_muestra&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "||" . $this->menu_informes_target('_self') . "|" . "\n";
}
else
{
    $menu_informes_menuData['data'] .= "item_12|.|" . $nm_var_lab[11] . "||||_self|disabled\n";
}

$menu_informes_menuData['data'] = array();
$str_disabled = "N";
$str_link = "menu_informes_form_php.php?sc_item_menu=item_6&sc_apl_menu=lis_pacientes&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['lis_pacientes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['lis_pacientes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_informes_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->menu_informes_target('_self') . "\"",
        'sc_id'    => "item_6",
        'disabled' => $str_disabled,
    );
$str_disabled = "N";
$str_link = "menu_informes_form_php.php?sc_item_menu=item_8&sc_apl_menu=Informe_paciente1&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Informe_paciente1']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Informe_paciente1']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_informes_form_php.php?sc_item_menu=item_7&sc_apl_menu=Informe_reclamacion&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Informe_reclamacion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Informe_reclamacion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_informes_form_php.php?sc_item_menu=item_9&sc_apl_menu=Informe_reclamacion_historial&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Informe_reclamacion_historial']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Informe_reclamacion_historial']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_informes_form_php.php?sc_item_menu=item_3&sc_apl_menu=generador_de_informes&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['generador_de_informes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['generador_de_informes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_informes_form_php.php?sc_item_menu=item_1&sc_apl_menu=ultima_gestion&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ultima_gestion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ultima_gestion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_informes_form_php.php?sc_item_menu=item_2&sc_apl_menu=conciliacion_out&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['conciliacion_out']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['conciliacion_out']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_informes_form_php.php?sc_item_menu=item_4&sc_apl_menu=Conciliacion_in&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Conciliacion_in']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Conciliacion_in']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_informes_form_php.php?sc_item_menu=item_5&sc_apl_menu=reconciliacion&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['reconciliacion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['reconciliacion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_informes_form_php.php?sc_item_menu=item_10&sc_apl_menu=apoyo_adempas&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['apoyo_adempas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['apoyo_adempas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_informes_form_php.php?sc_item_menu=item_11&sc_apl_menu=../../presentacion/form_exportar_consulta_aplicaciones.php&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "";
$str_icon = "";
$icon_aba = "";
$icon_aba_inactive = "";
...
$str_disabled = "N";
$str_link = "menu_informes_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_envio_muestra&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_envio_muestra']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_envio_muestra']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_informes']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_informes']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_informes');
    $menu_informes_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_informes_help.txt"))
{
    $Arq_WebHelp = file("menu_informes_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_informes_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_informes_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                );
            }
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_informes']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_informes']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_informes_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_informes']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_informes_menuData['data'][$i_menu]);
       }
    ...
    $menu_informes_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_informes']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_informes']))
{
    $disable_menu = false;
    foreach ($menu_informes_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_informes']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_informes_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabecera HTML */
if ($menu_informes_menuData['iframe'])
{
    $menu_informes_menuData['height'] = '100%';
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">

<html<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?> style="height: 100%">
<head>
 <title>menu_informes</title>
...
<link rel="stylesheet" type="text/css" href="../_lib/css/_menuTheme/sys_Mac_Green_hor_<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir']; ?>.css<?php if (@is_file($this->path_css . '_menuTheme/' . "sys_Mac_Green" . '_' . hor . '.css')) { echo '?scp=' . md5($this->path_css . '_menuTheme/' . "sys_Mac_Green" . '_' . hor . '.css'); } ?>" />
<style>
   .scTabText {
   }</style>
<script>
...
{
    $menu_informes_menuData['height'] = '30px';
}

/* Archivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_informes']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_informes']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menu_informes']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
Iframe_atual = "menu_informes_iframe";
...
<?php
 $seq = 0;
 foreach ($menu_informes_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'menu_informes_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    tmp += "</div>";
    var home_style="";
    if(str_id === 'menu_informes'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_menu_informes').css('display','none');
    if (str_id == "")
    {
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            Iframe_atual = "menu_informes_" + Tab_iframes[i] + '_iframe';
        } else {
...
{
    str_target_sv = "";
    if (str_id != "iframe_menu_informes")
    {
        str_target_sv = str_id + "_iframe";
        str_id        = str_id.replace("menu_informes_","");
    }
    str_link   = $('#' + str_id).attr('item-href');
    str_target = $('#' + str_id).attr('item-target');
    if (str_target == "menu_informes_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        str_target = (str_target_sv != "") ? str_target_sv : str_target;
        mudaIframe(str_id);
        if (str_id != "menu_informes")
        {
            $('#links_abas').css('display','');
        }
        if (str_id != "menu_informes" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
...
<div id="idDivMenu">
<?php
echo $this->menu_informes_escreveMenu($menu_informes_menuData['data']);
?>
</div>
<?php
/* Control de iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $menu_informes_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
    ...
    <td id="Iframe_control" style="border-width: 1px; height: 100%; padding: 0px;vertical-align:top;text-align:center;">
      <iframe id="iframe_menu_informes" name="menu_informes_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "menu_informes_pag_ini.php"); ?>"></iframe>
<?php
 foreach ($menu_informes_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
         echo "      <iframe id=\"iframe_" . $dados_menu['id'] . "\" name= \"menu_informes_" . $dados_menu['id'] . "_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;width: 100%; height: 100%;\" src=\"\"></iframe>
";
     }
 }
}
...
/* Control de Target */
function menu_informes_escreveMenu($arr_menu)
{
    $last      = '';
    $itemClass = ' topfirst';
    $subSize   = 2;
...
function menu_informes_target($str_target)
{
    global $menu_informes_menuData;
    ...
    elseif ($menu_informes_menuData['iframe'])
    {
        return 'menu_informes_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_informes_menuData, $path_imag_cab)
{
}
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_informes_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_informes_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_informes_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        if (!isset($_SESSION['scriptcase']['menu_informes']['sc_init'][$apl_menu]))
        {
            $_SESSION['scriptcase']['menu_informes']['sc_init'][$apl_menu] = rand(2, 10000);
        }
        $_SESSION['sc_session'][$_SESSION['scriptcase']['menu_informes']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['menu_informes']['sc_init'][$apl_menu];
   }
...
$contr_menu_informes = new menu_informes_class;
$contr_menu_informes->menu_informes_menu();
