...
class lis_pacientes_resumo
{
   ...
   //---- 
   function lis_pacientes_resumo($tipo = "")
   {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['contr_total_geral'] == "OK")
      {
          $this->array_total_pacientes_id_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['pacientes_id_paciente'];
          $this->array_total_pacientes_estado_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['pacientes_estado_paciente'];
          $this->array_total_pacientes_motivo_retiro_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['pacientes_motivo_retiro_paciente'];
          $this->array_total_pacientes_genero_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['pacientes_genero_paciente'];
          $this->array_total_tratamiento_producto_tratamiento = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['tratamiento_producto_tratamiento'];
          $this->array_total_tratamiento_medico_tratamiento = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['tratamiento_medico_tratamiento'];
      }
      else
      {
          $this->array_total_pacientes_id_paciente = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['pacientes_id_paciente'] = $this->array_total_pacientes_id_paciente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['pacientes_estado_paciente'] = $this->array_total_pacientes_estado_paciente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['pacientes_motivo_retiro_paciente'] = $this->array_total_pacientes_motivo_retiro_paciente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['pacientes_genero_paciente'] = $this->array_total_pacientes_genero_paciente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['tratamiento_producto_tratamiento'] = $this->array_total_tratamiento_producto_tratamiento;
      $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['tratamiento_medico_tratamiento'] = $this->array_total_tratamiento_medico_tratamiento;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels'][''] = "ID PACIENTE"; 
       $prep_field['pacientes_estado_paciente'] = "ESTADO PACIENTE";
       $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels'][''] = "ESTADO PACIENTE"; 
       $prep_field['pacientes_motivo_retiro_paciente'] = "MOTIVO RETIRO PACIENTE";
       $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels'][''] = "MOTIVO RETIRO PACIENTE"; 
       $prep_field['pacientes_genero_paciente'] = "GENERO PACIENTE";
       $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels'][''] = "GENERO PACIENTE"; 
       $prep_field['tratamiento_producto_tratamiento'] = "PRODUCTO TRATAMIENTO";
       $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels'][''] = "PRODUCTO TRATAMIENTO"; 
       $prep_field['tratamiento_medico_tratamiento'] = "MEDICO TRATAMIENTO";
       $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels'][''] = "MEDICO TRATAMIENTO"; 
       $Str_gb = "";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['summarizing_fields_control'] = array(
               'NM_Count' => array(
      ...
      eval ($Str_gb);
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_tabular'];
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['comb_table_def']  = array();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_lis_pacientes_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_lis_pacientes_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function resumo_init()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->tipo)
      {
         require_once($this->Ini->path_aplicacao . "lis_pacientes_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] = "print";
      ...
      $this->total   = new lis_pacientes_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_sc_free_group_by("res", $this->array_total_pacientes_id_paciente, $this->array_total_pacientes_estado_paciente, $this->array_total_pacientes_motivo_retiro_paciente, $this->array_total_pacientes_genero_paciente, $this->array_total_tratamiento_producto_tratamiento, $this->array_total_tratamiento_medico_tratamiento);
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_lis_pacientes_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_lis_pacientes_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_lis_pacientes_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "lis_pacientes/lis_pacientes_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "lis_pacientes/lis_pacientes_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&language=es&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "lis_pacientes/lis_pacientes_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "lis_pacientes/lis_pacientes_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "lis_pacientes/lis_pacientes_config_graf_flash.php?nome_apl=lis_pacientes&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "lis_pacientes/lis_pacientes_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnGroupByShow('" . $this->Ini->path_link . "lis_pacientes/lis_pacientes_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("lis_pacientes_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'lis_pacientes_config_pivot.php?nome_apl=lis_pacientes&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida(" }\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "lis_pacientes/lis_pacientes_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  {\r\n");
   $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "lis_pacientes/lis_pacientes_iframe.php?nmgp_opcao=pdf_res&scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_lis_pacientes_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "lis_pacientes/lis_pacientes_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $pacientes_id_paciente = $Busca_temp['pacientes_id_paciente']; 
          ...
          $pacientes_estado_paciente = $Busca_temp['pacientes_estado_paciente']; 
          ...
          $pacientes_fecha_retiro_paciente = $Busca_temp['pacientes_fecha_retiro_paciente']; 
   ...
   //---- 
   function adiciona_registro($quebra_pacientes_id_paciente, $quebra_pacientes_estado_paciente, $quebra_pacientes_motivo_retiro_paciente, $quebra_pacientes_genero_paciente, $quebra_tratamiento_producto_tratamiento, $quebra_tratamiento_medico_tratamiento, $quebra_pacientes_id_paciente_orig, $quebra_pacientes_estado_paciente_orig, $quebra_pacientes_motivo_retiro_paciente_orig, $quebra_pacientes_genero_paciente_orig, $quebra_tratamiento_producto_tratamiento_orig, $quebra_tratamiento_medico_tratamiento_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->pacientes_id_paciente, $this->pacientes_estado_paciente, $this->pacientes_motivo_retiro_paciente, $this->pacientes_genero_paciente, $this->tratamiento_producto_tratamiento, $this->tratamiento_medico_tratamiento, $this->pacientes_id_paciente_orig,  $this->pacientes_estado_paciente_orig,  $this->pacientes_motivo_retiro_paciente_orig,  $this->pacientes_genero_paciente_orig,  $this->tratamiento_producto_tratamiento_orig,  $this->tratamiento_medico_tratamiento_orig);
            }
   }
//
