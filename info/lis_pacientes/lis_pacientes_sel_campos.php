<?php
   ...
   session_start();
    ...
    $Sel_Cmp = new lis_pacientes_sel_cmp(); 
    $Sel_Cmp->Sel_cmp_init();
   
class lis_pacientes_sel_cmp
{
function Sel_cmp_init()
{
   ...
   $tab_blk_campos[] = "pacientes_identificacion_paciente";
   $tab_ger_campos['pacientes_nombre_paciente'] = "on";
   $tab_blk_campos[] = "pacientes_nombre_paciente";
   $tab_ger_campos['pacientes_apellido_paciente'] = "on";
   $tab_blk_campos[] = "pacientes_apellido_paciente";
   $tab_ger_campos['pacientes_telefono_paciente'] = "on";
   $tab_blk_campos[] = "pacientes_telefono_paciente";
   $tab_ger_campos['pacientes_telefono2_paciente'] = "on";
   $tab_blk_campos[] = "pacientes_telefono2_paciente";
   $tab_ger_campos['pacientes_telefono3_paciente'] = "on";
   $tab_blk_campos[] = "pacientes_telefono3_paciente";
   $tab_ger_campos['pacientes_correo_paciente'] = "on";
   $tab_blk_campos[] = "pacientes_correo_paciente";
   $tab_ger_campos['pacientes_direccion_paciente'] = "on";
   $tab_blk_campos[] = "pacientes_direccion_paciente";
   $tab_ger_campos['pacientes_barrio_paciente'] = "on";
   $tab_blk_campos[] = "pacientes_barrio_paciente";
   ...
   $tab_blk_campos[] = "pacientes_genero_paciente";
   $tab_ger_campos['pacientes_fecha_nacimineto_paciente'] = "on";
   $tab_blk_campos[] = "pacientes_fecha_nacimineto_paciente";
   $tab_ger_campos['pacientes_edad_paciente'] = "on";
   $tab_blk_campos[] = "pacientes_edad_paciente";
   $tab_ger_campos['pacientes_acudiente_paciente'] = "on";
   $tab_blk_campos[] = "pacientes_acudiente_paciente";
   $tab_ger_campos['pacientes_telefono_acudiente_paciente'] = "on";
   $tab_blk_campos[] = "pacientes_telefono_acudiente_paciente";
   ...
   $tab_blk_campos[] = "pacientes_id_ultima_gestion";
   $tab_ger_campos['pacientes_usuario_creacion'] = "on";
   $tab_blk_campos[] = "pacientes_usuario_creacion";
   $tab_ger_campos['tratamiento_id_tratamiento'] = "on";
   $tab_blk_campos[] = "tratamiento_id_tratamiento";
   ...
   $tab_blk_campos[] = "tratamiento_clasificacion_patologica_tratamiento";
   $tab_ger_campos['tratamiento_tratamiento_previo'] = "on";
   $tab_blk_campos[] = "tratamiento_tratamiento_previo";
   $tab_ger_campos['tratamiento_consentimiento_tratamiento'] = "on";
   $tab_blk_campos[] = "tratamiento_consentimiento_tratamiento";
   $tab_ger_campos['tratamiento_fecha_inicio_terapia_tratamiento'] = "on";
   $tab_blk_campos[] = "tratamiento_fecha_inicio_terapia_tratamiento";
   $tab_ger_campos['tratamiento_regimen_tratamiento'] = "on";
   $tab_blk_campos[] = "tratamiento_regimen_tratamiento";
   ...
   $tab_blk_campos[] = "tratamiento_fecha_ultima_reclamacion_tratamiento";
   $tab_ger_campos['tratamiento_otros_operadores_tratamiento'] = "on";
   $tab_blk_campos[] = "tratamiento_otros_operadores_tratamiento";
   $tab_ger_campos['tratamiento_medios_adquisicion_tratamiento'] = "on";
   $tab_blk_campos[] = "tratamiento_medios_adquisicion_tratamiento";
   $tab_ger_campos['tratamiento_ips_atiende_tratamiento'] = "on";
   $tab_blk_campos[] = "tratamiento_ips_atiende_tratamiento";
   $tab_ger_campos['tratamiento_medico_tratamiento'] = "on";
   $tab_blk_campos[] = "tratamiento_medico_tratamiento";
   $tab_ger_campos['tratamiento_especialidad_tratamiento'] = "on";
   $tab_blk_campos[] = "tratamiento_especialidad_tratamiento";
   $tab_ger_campos['tratamiento_paramedico_tratamiento'] = "on";
   $tab_blk_campos[] = "tratamiento_paramedico_tratamiento";
   $tab_ger_campos['tratamiento_zona_atencion_paramedico_tratamiento'] = "on";
   $tab_blk_campos[] = "tratamiento_zona_atencion_paramedico_tratamiento";
   $tab_ger_campos['tratamiento_ciudad_base_paramedico_tratamiento'] = "on";
   $tab_blk_campos[] = "tratamiento_ciudad_base_paramedico_tratamiento";
   $tab_ger_campos['tratamiento_notas_adjuntos_tratamiento'] = "on";
   $tab_blk_campos[] = "tratamiento_notas_adjuntos_tratamiento";
   ...
   if (isset($_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (isset($_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
...
function Sel_processa_out()
{
   ...
   $arr_temp = array();
   if (!isset($_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['usr_cmp_sel']))
   {
       $_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['usr_cmp_sel'] = array();
   }
   $arr_order = $_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['field_order'];
   $_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['field_order'] = array();
   $campos_sel = explode("@?@", $this->campos_sel);
   foreach ($campos_sel as $campo_order)
   {
       if (isset($tab_ger_campos[$campo_order]))
       {
           $_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['field_order'][] = $campo_order;
       }
   }
   foreach ($arr_order as $campo_order)
   {
       if (!in_array($campo_order, $_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['field_order']))
       {
           $_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['field_order'][] = $campo_order;
       }
   }
   ...
   $_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['usr_cmp_sel'] = $arr_temp;
?>
...
?>
  function scSubmitSelCampos(sPos) {
   ...
   $.ajax({
    type: "POST",
    url: "lis_pacientes_sel_campos.php",
    data: {
...
<?php
   ...
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if ($NM_cada_opc != "on")
           {
               $prep_combo[strtolower($NM_cada_field)] = $_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['labels'][$NM_cada_field];
           }
       }
   }
...
<?php
   if (isset($_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['field_order']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['field_order'] as $NM_cada_field)
       {
           if ($tab_ger_campos[$NM_cada_field] == "on")
           {
               ...
               {
?>
     <li class="sc_ui_litem scAppDivSelectFieldsEnabled" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['labels'][$NM_cada_field]; ?></li>
<?php
               }
               else
               {
?>
     <li class="sc_ui_litem scAppDivSelectFieldsDisabled" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['lis_pacientes']['labels'][$NM_cada_field]; ?></li>
<?php
               }
           }
       }
