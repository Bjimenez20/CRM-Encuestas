<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_envio_muestra_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_envio_muestra_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["pacientes_id_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["pacientes_id_paciente"])) ? $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["pacientes_id_paciente"] : "ID PACIENTE";
   $tab_ger_campos['pacientes_nombre_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_nombre_paciente'] = "cmp_maior_30_1";
       $tab_converte["cmp_maior_30_1"]   = "pacientes_nombre_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_nombre_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["pacientes_nombre_paciente"])) ? $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["pacientes_nombre_paciente"] : "NOMBRE PACIENTE";
   $tab_ger_campos['pacientes_apellido_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_apellido_paciente'] = "cmp_maior_30_2";
       $tab_converte["cmp_maior_30_2"]   = "pacientes_apellido_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_apellido_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["pacientes_apellido_paciente"])) ? $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["pacientes_apellido_paciente"] : "APELLIDO PACIENTE";
   $tab_ger_campos['pacientes_ciudad_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_ciudad_paciente'] = "cmp_maior_30_3";
       $tab_converte["cmp_maior_30_3"]   = "pacientes_ciudad_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_ciudad_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["pacientes_ciudad_paciente"])) ? $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["pacientes_ciudad_paciente"] : "CIUDAD PACIENTE";
   $tab_ger_campos['tratamiento_asegurador_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_asegurador_tratamiento'] = "cmp_maior_30_4";
       $tab_converte["cmp_maior_30_4"]   = "tratamiento_asegurador_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_asegurador_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["tratamiento_asegurador_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["tratamiento_asegurador_tratamiento"] : "ASEGURADOR TRATAMIENTO";
   $tab_ger_campos['tratamiento_operador_logistico_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_operador_logistico_tratamiento'] = "cmp_maior_30_5";
       $tab_converte["cmp_maior_30_5"]   = "tratamiento_operador_logistico_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_operador_logistico_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["tratamiento_operador_logistico_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["tratamiento_operador_logistico_tratamiento"] : "OPERADOR LOGISTICO TRATAMIENTO";
   $tab_ger_campos['tratamiento_medico_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_medico_tratamiento'] = "cmp_maior_30_6";
       $tab_converte["cmp_maior_30_6"]   = "tratamiento_medico_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_medico_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["tratamiento_medico_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["tratamiento_medico_tratamiento"] : "MEDICO TRATAMIENTO";
   $tab_ger_campos['envio_muestra_estatus_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['envio_muestra_estatus_paciente'] = "cmp_maior_30_7";
       $tab_converte["cmp_maior_30_7"]   = "envio_muestra_estatus_paciente";
   }
   else
   {
       $tab_def_campos['envio_muestra_estatus_paciente'] = "envio_muestra.ESTATUS_PACIENTE";
       $tab_converte["envio_muestra.ESTATUS_PACIENTE"]   = "envio_muestra_estatus_paciente";
   }
   $tab_labels["envio_muestra_estatus_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["envio_muestra_estatus_paciente"])) ? $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["envio_muestra_estatus_paciente"] : "ESTATUS PACIENTE";
   $tab_ger_campos['envio_muestra_dosis'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['envio_muestra_dosis'] = "envio_muestra_dosis";
       $tab_converte["envio_muestra_dosis"]   = "envio_muestra_dosis";
   }
   else
   {
       $tab_def_campos['envio_muestra_dosis'] = "envio_muestra.DOSIS";
       $tab_converte["envio_muestra.DOSIS"]   = "envio_muestra_dosis";
   }
   $tab_labels["envio_muestra_dosis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["envio_muestra_dosis"])) ? $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["envio_muestra_dosis"] : "DOSIS";
   $tab_ger_campos['envio_muestra_fecha_salida'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['envio_muestra_fecha_salida'] = "cmp_maior_30_8";
       $tab_converte["cmp_maior_30_8"]   = "envio_muestra_fecha_salida";
   }
   else
   {
       $tab_def_campos['envio_muestra_fecha_salida'] = "envio_muestra.FECHA_SALIDA";
       $tab_converte["envio_muestra.FECHA_SALIDA"]   = "envio_muestra_fecha_salida";
   }
   $tab_labels["envio_muestra_fecha_salida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["envio_muestra_fecha_salida"])) ? $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["envio_muestra_fecha_salida"] : "FECHA SALIDA";
   $tab_ger_campos['envio_muestra_fecha_entrega'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['envio_muestra_fecha_entrega'] = "cmp_maior_30_9";
       $tab_converte["cmp_maior_30_9"]   = "envio_muestra_fecha_entrega";
   }
   else
   {
       $tab_def_campos['envio_muestra_fecha_entrega'] = "envio_muestra.FECHA_ENTREGA";
       $tab_converte["envio_muestra.FECHA_ENTREGA"]   = "envio_muestra_fecha_entrega";
   }
   $tab_labels["envio_muestra_fecha_entrega"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["envio_muestra_fecha_entrega"])) ? $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["envio_muestra_fecha_entrega"] : "FECHA ENTREGA";
   $tab_ger_campos['envio_muestra_no_lote'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['envio_muestra_no_lote'] = "envio_muestra_no_lote";
       $tab_converte["envio_muestra_no_lote"]   = "envio_muestra_no_lote";
   }
   else
   {
       $tab_def_campos['envio_muestra_no_lote'] = "envio_muestra.NO_LOTE";
       $tab_converte["envio_muestra.NO_LOTE"]   = "envio_muestra_no_lote";
   }
   $tab_labels["envio_muestra_no_lote"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["envio_muestra_no_lote"])) ? $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["envio_muestra_no_lote"] : "NO LOTE";
   $tab_ger_campos['envio_muestra_estado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['envio_muestra_estado'] = "envio_muestra_estado";
       $tab_converte["envio_muestra_estado"]   = "envio_muestra_estado";
   }
   else
   {
       $tab_def_campos['envio_muestra_estado'] = "envio_muestra.ESTADO";
       $tab_converte["envio_muestra.ESTADO"]   = "envio_muestra_estado";
   }
   $tab_labels["envio_muestra_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["envio_muestra_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["envio_muestra_estado"] : "ESTADO";
   $tab_ger_campos['envio_muestra_usuario'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['envio_muestra_usuario'] = "envio_muestra_usuario";
       $tab_converte["envio_muestra_usuario"]   = "envio_muestra_usuario";
   }
   else
   {
       $tab_def_campos['envio_muestra_usuario'] = "envio_muestra.USUARIO";
       $tab_converte["envio_muestra.USUARIO"]   = "envio_muestra_usuario";
   }
   $tab_labels["envio_muestra_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["envio_muestra_usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["envio_muestra_usuario"] : "USUARIO";
   $tab_ger_campos['envio_muestra_fecha_creacion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['envio_muestra_fecha_creacion'] = "cmp_maior_30_10";
       $tab_converte["cmp_maior_30_10"]   = "envio_muestra_fecha_creacion";
   }
   else
   {
       $tab_def_campos['envio_muestra_fecha_creacion'] = "envio_muestra.FECHA_CREACION";
       $tab_converte["envio_muestra.FECHA_CREACION"]   = "envio_muestra_fecha_creacion";
   }
   $tab_labels["envio_muestra_fecha_creacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["envio_muestra_fecha_creacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['labels']["envio_muestra_fecha_creacion"] : "FECHA CREACION";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - envio_muestra</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_envio_muestra_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_envio_muestra']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
