...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["prueba_____grid_envio_muestra"]))
   {
      unset($_SESSION['session_sec_aplicacao']["prueba_____grid_envio_muestra"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_envio_muestra']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_envio_muestra']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_envio_muestra']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_envio_muestra']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_envio_muestra']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_envio_muestra</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_envio_muestra']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_envio_muestra']['embutida_filho'] as $ind => $sc_init)
          {
