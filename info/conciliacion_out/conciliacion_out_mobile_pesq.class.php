...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "pacientes_id_paciente";$Nm_numeric[] = "pacientes_id_ultima_gestion";$Nm_numeric[] = "tratamiento_id_paciente_fk";$Nm_numeric[] = "gestiones_id_gestion";$Nm_numeric[] = "gestiones_id_paciente_fk2";$Nm_numeric[] = "pacientes_id_paciente";$Nm_numeric[] = "pacientes_id_ultima_gestion";$Nm_numeric[] = "tratamiento_id_paciente_fk";$Nm_numeric[] = "gestiones_id_gestion";$Nm_numeric[] = "gestiones_id_paciente_fk2";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_pacientes_identificacion_paciente"  <?php echo $str_hide_pacientes_identificacion_paciente?>><?php
      $pacientes_identificacion_paciente_look = substr($this->Db->qstr($pacientes_identificacion_paciente), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_pacientes_nombre_paciente"  <?php echo $str_hide_pacientes_nombre_paciente?>><?php
      $pacientes_nombre_paciente_look = substr($this->Db->qstr($pacientes_nombre_paciente), 1, -1); 
      $nmgp_def_dados = array(); 
