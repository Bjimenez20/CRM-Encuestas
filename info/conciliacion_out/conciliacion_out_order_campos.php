...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_fecha_comunicacion'] = "cmp_maior_30_1";
       $tab_converte["cmp_maior_30_1"]   = "gestiones_fecha_comunicacion";
   }
   else
   {
   ...
   $tab_labels["gestiones_fecha_comunicacion"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["gestiones_fecha_comunicacion"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["gestiones_fecha_comunicacion"] : "FECHA COMUNICACION";
   $tab_ger_campos['pacientes_nombre_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_nombre_paciente'] = "cmp_maior_30_2";
       $tab_converte["cmp_maior_30_2"]   = "pacientes_nombre_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_nombre_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["pacientes_nombre_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["pacientes_nombre_paciente"] : "NOMBRE PACIENTE";
   $tab_ger_campos['pacientes_apellido_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_apellido_paciente'] = "cmp_maior_30_3";
       $tab_converte["cmp_maior_30_3"]   = "pacientes_apellido_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_apellido_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["pacientes_apellido_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["pacientes_apellido_paciente"] : "APELLIDO PACIENTE";
   $tab_ger_campos['pacientes_identificacion_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_identificacion_paciente'] = "cmp_maior_30_4";
       $tab_converte["cmp_maior_30_4"]   = "pacientes_identificacion_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_identificacion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["pacientes_identificacion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["pacientes_identificacion_paciente"] : "IDENTIFICACION PACIENTE";
   $tab_ger_campos['tratamiento_producto_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_producto_tratamiento'] = "cmp_maior_30_5";
       $tab_converte["cmp_maior_30_5"]   = "tratamiento_producto_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_producto_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["tratamiento_producto_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["tratamiento_producto_tratamiento"] : "PRODUCTO TRATAMIENTO";
   $tab_ger_campos['pacientes_telefono_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_telefono_paciente'] = "cmp_maior_30_6";
       $tab_converte["cmp_maior_30_6"]   = "pacientes_telefono_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_telefono_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["pacientes_telefono_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["pacientes_telefono_paciente"] : "TELEFONO PACIENTE";
   $tab_ger_campos['pacientes_telefono2_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_telefono2_paciente'] = "cmp_maior_30_7";
       $tab_converte["cmp_maior_30_7"]   = "pacientes_telefono2_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_telefono2_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["pacientes_telefono2_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["pacientes_telefono2_paciente"] : "TELEFONO2 PACIENTE";
   $tab_ger_campos['pacientes_telefono3_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_telefono3_paciente'] = "cmp_maior_30_8";
       $tab_converte["cmp_maior_30_8"]   = "pacientes_telefono3_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_telefono3_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["pacientes_telefono3_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["pacientes_telefono3_paciente"] : "TELEFONO3 PACIENTE";
   $tab_ger_campos['gestiones_fecha_programada_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_fecha_programada_gestion'] = "cmp_maior_30_9";
       $tab_converte["cmp_maior_30_9"]   = "gestiones_fecha_programada_gestion";
   }
   else
   {
   ...
   $tab_labels["gestiones_fecha_programada_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["gestiones_fecha_programada_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["gestiones_fecha_programada_gestion"] : "FECHA PROGRAMADA GESTION";
   $tab_ger_campos['gestiones_descripcion_comunicacion_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_descripcion_comunicacion_gestion'] = "cmp_maior_30_10";
       $tab_converte["cmp_maior_30_10"]   = "gestiones_descripcion_comunicacion_gestion";
   }
   else
   {
   ...
   $tab_labels["gestiones_descripcion_comunicacion_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["gestiones_descripcion_comunicacion_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["gestiones_descripcion_comunicacion_gestion"] : "DESCRIPCION COMUNICACION GESTION";
   $tab_ger_campos['gestiones_evento_adverso_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_evento_adverso_gestion'] = "cmp_maior_30_11";
       $tab_converte["cmp_maior_30_11"]   = "gestiones_evento_adverso_gestion";
   }
   else
   {
   ...
   $tab_labels["gestiones_evento_adverso_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["gestiones_evento_adverso_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["gestiones_evento_adverso_gestion"] : "EVENTO ADVERSO GESTION";
   $tab_ger_campos['gestiones_tipo_evento_adverso'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_tipo_evento_adverso'] = "cmp_maior_30_12";
       $tab_converte["cmp_maior_30_12"]   = "gestiones_tipo_evento_adverso";
   }
   else
   {
   ...
   $tab_labels["gestiones_tipo_evento_adverso"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["gestiones_tipo_evento_adverso"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["gestiones_tipo_evento_adverso"] : "TIPO EVENTO ADVERSO";
   ...
   $tab_labels["gestiones_autor_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["gestiones_autor_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["gestiones_autor_gestion"] : "AUTOR GESTION";
   $tab_ger_campos['gestiones_numero_intentos_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_numero_intentos_gestion'] = "cmp_maior_30_13";
       $tab_converte["cmp_maior_30_13"]   = "gestiones_numero_intentos_gestion";
   }
   else
   {
   ...
   $tab_labels["gestiones_numero_intentos_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["gestiones_numero_intentos_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["gestiones_numero_intentos_gestion"] : "NUMERO INTENTOS GESTION";
   $tab_ger_campos['pacientes_estado_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_estado_paciente'] = "cmp_maior_30_14";
       $tab_converte["cmp_maior_30_14"]   = "pacientes_estado_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_estado_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["pacientes_estado_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["pacientes_estado_paciente"] : "ESTADO PACIENTE";
   $tab_ger_campos['gestiones_tipo_llamada_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_tipo_llamada_gestion'] = "cmp_maior_30_15";
       $tab_converte["cmp_maior_30_15"]   = "gestiones_tipo_llamada_gestion";
   }
   else
   {
   ...
   $tab_labels["gestiones_tipo_llamada_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["gestiones_tipo_llamada_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["gestiones_tipo_llamada_gestion"] : "TIPO LLAMADA GESTION";
   ...
   $tab_labels["pacientes_id_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["pacientes_id_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_out']['labels']["pacientes_id_paciente"] : "ID PACIENTE";
