...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["fundem_____Conciliacion_out"]))
   {
      unset($_SESSION['session_sec_aplicacao']["fundem_____Conciliacion_out"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Conciliacion_out']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Conciliacion_out']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Conciliacion_out']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Conciliacion_out']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Conciliacion_out']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Conciliacion_out']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Conciliacion_out']['embutida_filho'] as $ind => $sc_init)
          {
