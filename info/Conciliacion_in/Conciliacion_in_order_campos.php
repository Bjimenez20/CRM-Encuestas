<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new Conciliacion_in_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class Conciliacion_in_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_fecha_activacion_paciente'] = "cmp_maior_30_1";
       $tab_converte["cmp_maior_30_1"]   = "pacientes_fecha_activacion_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_fecha_activacion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["pacientes_fecha_activacion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["pacientes_fecha_activacion_paciente"] : "FECHA ACTIVACION PACIENTE";
   ...
   $tab_labels["pacientes_nombre_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["pacientes_nombre_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["pacientes_nombre_paciente"] : "NOMBRE PACIENTE";
   ...
   $tab_labels["pacientes_apellido_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["pacientes_apellido_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["pacientes_apellido_paciente"] : "APELLIDO PACIENTE";
   $tab_ger_campos['pacientes_telefono_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_telefono_paciente'] = "cmp_maior_30_4";
       $tab_converte["cmp_maior_30_4"]   = "pacientes_telefono_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_telefono_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["pacientes_telefono_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["pacientes_telefono_paciente"] : "TELEFONO PACIENTE";
   $tab_ger_campos['pacientes_telefono2_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_telefono2_paciente'] = "cmp_maior_30_5";
       $tab_converte["cmp_maior_30_5"]   = "pacientes_telefono2_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_telefono2_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["pacientes_telefono2_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["pacientes_telefono2_paciente"] : "TELEFONO2 PACIENTE";
   $tab_ger_campos['pacientes_telefono3_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_telefono3_paciente'] = "cmp_maior_30_6";
       $tab_converte["cmp_maior_30_6"]   = "pacientes_telefono3_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_telefono3_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["pacientes_telefono3_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["pacientes_telefono3_paciente"] : "TELEFONO3 PACIENTE";
   $tab_ger_campos['tratamiento_producto_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_producto_tratamiento'] = "cmp_maior_30_7";
       $tab_converte["cmp_maior_30_7"]   = "tratamiento_producto_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_producto_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["tratamiento_producto_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["tratamiento_producto_tratamiento"] : "PRODUCTO TRATAMIENTO";
   $tab_ger_campos['gestiones_descripcion_comunicacion_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_descripcion_comunicacion_gestion'] = "cmp_maior_30_8";
       $tab_converte["cmp_maior_30_8"]   = "gestiones_descripcion_comunicacion_gestion";
   }
   else
   {
   ...
   $tab_labels["gestiones_descripcion_comunicacion_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["gestiones_descripcion_comunicacion_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["gestiones_descripcion_comunicacion_gestion"] : "DESCRIPCION COMUNICACION GESTION";
   ...
   $tab_labels["gestiones_autor_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["gestiones_autor_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["gestiones_autor_gestion"] : "AUTOR GESTION";
   ...
   $tab_labels["pacientes_id_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["pacientes_id_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["pacientes_id_paciente"] : "ID PACIENTE";
   $tab_ger_campos['gestiones_evento_adverso_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_evento_adverso_gestion'] = "cmp_maior_30_9";
       $tab_converte["cmp_maior_30_9"]   = "gestiones_evento_adverso_gestion";
   }
   else
   {
   ...
   $tab_labels["gestiones_evento_adverso_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["gestiones_evento_adverso_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["gestiones_evento_adverso_gestion"] : "EVENTO ADVERSO GESTION";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "Conciliacion_in_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
