...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["pacientes_id_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_id_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_id_paciente"] : "ID PACIENTE";
   ...
   $tab_labels["gestiones_logro_comunicacion_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_logro_comunicacion_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_logro_comunicacion_gestion"] : "LOGRO COMUNICACION GESTION";
   ...
   $tab_labels["gestiones_fecha_comunicacion"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_fecha_comunicacion"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_fecha_comunicacion"] : "FECHA COMUNICACION";
   ...
   $tab_labels["gestiones_autor_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_autor_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_autor_gestion"] : "AUTOR GESTION";
   ...
   $tab_labels["pacientes_departamento_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_departamento_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_departamento_paciente"] : "DEPARTAMENTO PACIENTE";
   ...
   $tab_labels["pacientes_ciudad_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_ciudad_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_ciudad_paciente"] : "CIUDAD PACIENTE";
   ...
   $tab_labels["pacientes_estado_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_estado_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_estado_paciente"] : "ESTADO PACIENTE";
   ...
   $tab_labels["pacientes_status_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_status_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_status_paciente"] : "STATUS PACIENTE";
   ...
   $tab_labels["pacientes_fecha_activacion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_fecha_activacion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_fecha_activacion_paciente"] : "FECHA ACTIVACION PACIENTE";
   $tab_ger_campos['pacientes_fecha_retiro_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_fecha_retiro_paciente'] = "cmp_maior_30_8";
       $tab_converte["cmp_maior_30_8"]   = "pacientes_fecha_retiro_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_fecha_retiro_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_fecha_retiro_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_fecha_retiro_paciente"] : "FECHA RETIRO PACIENTE";
   $tab_ger_campos['pacientes_motivo_retiro_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_motivo_retiro_paciente'] = "cmp_maior_30_9";
       $tab_converte["cmp_maior_30_9"]   = "pacientes_motivo_retiro_paciente";
   }
   else
   {
   ...
   $tab_labels["pacientes_motivo_retiro_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_motivo_retiro_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_motivo_retiro_paciente"] : "MOTIVO RETIRO PACIENTE";
   $tab_ger_campos['tratamiento_fecha_inicio_terapia_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_fecha_inicio_terapia_tratamiento'] = "cmp_maior_30_10";
       $tab_converte["cmp_maior_30_10"]   = "tratamiento_fecha_inicio_terapia_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_fecha_inicio_terapia_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_fecha_inicio_terapia_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_fecha_inicio_terapia_tratamiento"] : "FECHA INICIO TERAPIA TRATAMIENTO";
   ...
   $tab_labels["pacientes_codigo_xofigo"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_codigo_xofigo"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_codigo_xofigo"] : "CODIGO XOFIGO";
   $tab_ger_campos['tratamiento_clasificacion_patologica_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_clasificacion_patologica_tratamiento'] = "cmp_maior_30_11";
       $tab_converte["cmp_maior_30_11"]   = "tratamiento_clasificacion_patologica_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_clasificacion_patologica_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_clasificacion_patologica_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_clasificacion_patologica_tratamiento"] : "CLASIFICACION PATOLOGICA TRATAMIENTO";
   $tab_ger_campos['tratamiento_producto_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_producto_tratamiento'] = "cmp_maior_30_12";
       $tab_converte["cmp_maior_30_12"]   = "tratamiento_producto_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_producto_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_producto_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_producto_tratamiento"] : "PRODUCTO TRATAMIENTO";
   $tab_ger_campos['tratamiento_nombre_referencia'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_nombre_referencia'] = "cmp_maior_30_13";
       $tab_converte["cmp_maior_30_13"]   = "tratamiento_nombre_referencia";
   }
   else
   {
   ...
   $tab_labels["tratamiento_nombre_referencia"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_nombre_referencia"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_nombre_referencia"] : "NOMBRE REFERENCIA";
   $tab_ger_campos['tratamiento_dosis_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_dosis_tratamiento'] = "cmp_maior_30_14";
       $tab_converte["cmp_maior_30_14"]   = "tratamiento_dosis_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_dosis_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_dosis_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_dosis_tratamiento"] : "DOSIS TRATAMIENTO";
   $tab_ger_campos['gestiones_fecha_medicamento_hasta'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_fecha_medicamento_hasta'] = "cmp_maior_30_15";
       $tab_converte["cmp_maior_30_15"]   = "gestiones_fecha_medicamento_hasta";
   }
   else
   {
       $tab_def_campos['gestiones_fecha_medicamento_hasta'] = "gestiones.FECHA_MEDICAMENTO_HASTA";
       $tab_converte["gestiones.FECHA_MEDICAMENTO_HASTA"]   = "gestiones_fecha_medicamento_hasta";
   }
   $tab_labels["gestiones_fecha_medicamento_hasta"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_fecha_medicamento_hasta"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_fecha_medicamento_hasta"] : "MEDICAMENTO HASTA";
   ...
   $tab_labels["gestiones_numero_cajas"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_numero_cajas"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_numero_cajas"] : "NUMERO CAJAS";
   $tab_ger_campos['tratamiento_asegurador_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_asegurador_tratamiento'] = "cmp_maior_30_16";
       $tab_converte["cmp_maior_30_16"]   = "tratamiento_asegurador_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_asegurador_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_asegurador_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_asegurador_tratamiento"] : "ASEGURADOR TRATAMIENTO";
   $tab_ger_campos['tratamiento_operador_logistico_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_operador_logistico_tratamiento'] = "cmp_maior_30_17";
       $tab_converte["cmp_maior_30_17"]   = "tratamiento_operador_logistico_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_operador_logistico_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_operador_logistico_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_operador_logistico_tratamiento"] : "OPERADOR LOGISTICO TRATAMIENTO";
   $tab_ger_campos['tratamiento_punto_entrega'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_punto_entrega'] = "cmp_maior_30_18";
       $tab_converte["cmp_maior_30_18"]   = "tratamiento_punto_entrega";
   }
   else
   {
   ...
   $tab_labels["tratamiento_punto_entrega"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_punto_entrega"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_punto_entrega"] : "PUNTO ENTREGA";
   $tab_ger_campos['tratamiento_ips_atiende_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_ips_atiende_tratamiento'] = "cmp_maior_30_19";
       $tab_converte["cmp_maior_30_19"]   = "tratamiento_ips_atiende_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_ips_atiende_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_ips_atiende_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_ips_atiende_tratamiento"] : "IPS";
   $tab_ger_campos['tratamiento_regimen_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_regimen_tratamiento'] = "cmp_maior_30_20";
       $tab_converte["cmp_maior_30_20"]   = "tratamiento_regimen_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_regimen_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_regimen_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_regimen_tratamiento"] : "REGIMEN TRATAMIENTO";
   $tab_ger_campos['tratamiento_medico_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_medico_tratamiento'] = "cmp_maior_30_21";
       $tab_converte["cmp_maior_30_21"]   = "tratamiento_medico_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_medico_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_medico_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_medico_tratamiento"] : "MEDICO TRATAMIENTO";
   $tab_ger_campos['tratamiento_tratamiento_previo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_tratamiento_previo'] = "cmp_maior_30_22";
       $tab_converte["cmp_maior_30_22"]   = "tratamiento_tratamiento_previo";
   }
   else
   {
   ...
   $tab_labels["tratamiento_tratamiento_previo"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_tratamiento_previo"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_tratamiento_previo"] : "TRATAMIENTO PREVIO";
   $tab_ger_campos['gestiones_reclamo_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_reclamo_gestion'] = "cmp_maior_30_23";
       $tab_converte["cmp_maior_30_23"]   = "gestiones_reclamo_gestion";
   }
   else
   {
   ...
   $tab_labels["gestiones_reclamo_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_reclamo_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_reclamo_gestion"] : "RECLAMO GESTION";
   $tab_ger_campos['gestiones_fecha_reclamacion_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_fecha_reclamacion_gestion'] = "cmp_maior_30_24";
       $tab_converte["cmp_maior_30_24"]   = "gestiones_fecha_reclamacion_gestion";
   }
   else
   {
   ...
   $tab_labels["gestiones_fecha_reclamacion_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_fecha_reclamacion_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_fecha_reclamacion_gestion"] : "FECHA RECLAMACION GESTION";
   $tab_ger_campos['gestiones_causa_no_reclamacion_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_causa_no_reclamacion_gestion'] = "cmp_maior_30_25";
       $tab_converte["cmp_maior_30_25"]   = "gestiones_causa_no_reclamacion_gestion";
   }
   else
   {
   ...
   $tab_labels["gestiones_causa_no_reclamacion_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_causa_no_reclamacion_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_causa_no_reclamacion_gestion"] : "CAUSA NO RECLAMACION GESTION";
   $tab_ger_campos['gestiones_descripcion_comunicacion_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_descripcion_comunicacion_gestion'] = "cmp_maior_30_26";
       $tab_converte["cmp_maior_30_26"]   = "gestiones_descripcion_comunicacion_gestion";
   }
   else
   {
   ...
   $tab_labels["gestiones_descripcion_comunicacion_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_descripcion_comunicacion_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_descripcion_comunicacion_gestion"] : "DESCRIPCION COMUNICACION GESTION";
   $tab_ger_campos['gestiones_fecha_programada_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestiones_fecha_programada_gestion'] = "cmp_maior_30_27";
       $tab_converte["cmp_maior_30_27"]   = "gestiones_fecha_programada_gestion";
   }
   else
   {
   ...
   $tab_labels["gestiones_fecha_programada_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_fecha_programada_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_fecha_programada_gestion"] : "FECHA PROGRAMADA GESTION";
   $tab_ger_campos['pacientes_id_ultima_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pacientes_id_ultima_gestion'] = "cmp_maior_30_28";
       $tab_converte["cmp_maior_30_28"]   = "pacientes_id_ultima_gestion";
   }
   else
   {
   ...
   $tab_labels["pacientes_id_ultima_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_id_ultima_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["pacientes_id_ultima_gestion"] : "ID ULTIMA GESTION";
   $tab_ger_campos['tratamiento_id_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_id_tratamiento'] = "cmp_maior_30_29";
       $tab_converte["cmp_maior_30_29"]   = "tratamiento_id_tratamiento";
   }
   else
   {
   ...
   $tab_labels["tratamiento_id_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_id_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_id_tratamiento"] : "ID TRATAMIENTO";
   $tab_ger_campos['tratamiento_id_paciente_fk'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tratamiento_id_paciente_fk'] = "cmp_maior_30_30";
       $tab_converte["cmp_maior_30_30"]   = "tratamiento_id_paciente_fk";
   }
   else
   {
   ...
   $tab_labels["tratamiento_id_paciente_fk"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_id_paciente_fk"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["tratamiento_id_paciente_fk"] : "ID PACIENTE FK";
   ...
   $tab_labels["gestiones_paap"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_paap"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_paap"] : "PAAP";
   ...
   $tab_labels["gestiones_sub_paap"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_sub_paap"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_sub_paap"] : "SUB PAAP";
   ...
   $tab_labels["gestiones_barrera"]   = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_barrera"])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']["gestiones_barrera"] : "BARRERA";
