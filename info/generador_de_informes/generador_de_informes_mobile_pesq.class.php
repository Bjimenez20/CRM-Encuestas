...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_gestiones_fecha_comunicacion"  <?php echo $str_hide_gestiones_fecha_comunicacion?>>
<?php
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <BR>
        <SPAN id="id_vis_gestiones_fecha_comunicacion"  <?php echo $str_display_gestiones_fecha_comunicacion; ?> class="scFilterFieldFontEven">
