...
class generador_de_informes_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function generador_de_informes_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "generador_de_informes.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['rtf_name']);
      }
   ...
   function NM_export_tratamiento_id_paciente_fk()
   {
         ...
         $this->tratamiento_id_paciente_fk = str_replace('<', '&lt;', $this->tratamiento_id_paciente_fk);
         $this->tratamiento_id_paciente_fk = str_replace('>', '&gt;', $this->tratamiento_id_paciente_fk);
         $this->texto_tag .= "<td>" . $this->tratamiento_id_paciente_fk . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
...
<HEAD>
 <TITLE>Generador de Informes :: RTF</TITLE>
