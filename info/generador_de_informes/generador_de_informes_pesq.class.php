...
class generador_de_informes_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function generador_de_informes_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . generador_de_informes_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . generador_de_informes_pack_protect_string($Tipo_filter[0]) . "\">.." . generador_de_informes_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>generador_de_informes/generador_de_informes_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="generador_de_informes_ajax_search.js"></script>
 <script type="text/javascript" src="generador_de_informes_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_gestiones_fecha_comunicacion_cond#NMF#' + search_get_sel_txt('SC_gestiones_fecha_comunicacion_cond') + '@NMF@';
  str_out += 'SC_gestiones_fecha_comunicacion_dia#NMF#' + search_get_sel_txt('SC_gestiones_fecha_comunicacion_dia') + '@NMF@';
  str_out += 'SC_gestiones_fecha_comunicacion_mes#NMF#' + search_get_sel_txt('SC_gestiones_fecha_comunicacion_mes') + '@NMF@';
  str_out += 'SC_gestiones_fecha_comunicacion_ano#NMF#' + search_get_sel_txt('SC_gestiones_fecha_comunicacion_ano') + '@NMF@';
  str_out += 'SC_gestiones_fecha_comunicacion_input_2_dia#NMF#' + search_get_sel_txt('SC_gestiones_fecha_comunicacion_input_2_dia') + '@NMF@';
  str_out += 'SC_gestiones_fecha_comunicacion_input_2_mes#NMF#' + search_get_sel_txt('SC_gestiones_fecha_comunicacion_input_2_mes') + '@NMF@';
  str_out += 'SC_gestiones_fecha_comunicacion_input_2_ano#NMF#' + search_get_sel_txt('SC_gestiones_fecha_comunicacion_input_2_ano') + '@NMF@';
  str_out += 'SC_gestiones_fecha_comunicacion_hor#NMF#' + search_get_sel_txt('SC_gestiones_fecha_comunicacion_hor') + '@NMF@';
  str_out += 'SC_gestiones_fecha_comunicacion_min#NMF#' + search_get_sel_txt('SC_gestiones_fecha_comunicacion_min') + '@NMF@';
  str_out += 'SC_gestiones_fecha_comunicacion_seg#NMF#' + search_get_sel_txt('SC_gestiones_fecha_comunicacion_seg') + '@NMF@';
  str_out += 'SC_gestiones_fecha_comunicacion_input_2_hor#NMF#' + search_get_sel_txt('SC_gestiones_fecha_comunicacion_input_2_hor') + '@NMF@';
  str_out += 'SC_gestiones_fecha_comunicacion_input_2_min#NMF#' + search_get_sel_txt('SC_gestiones_fecha_comunicacion_input_2_min') + '@NMF@';
  str_out += 'SC_gestiones_fecha_comunicacion_input_2_seg#NMF#' + search_get_sel_txt('SC_gestiones_fecha_comunicacion_input_2_seg') + '@NMF@';
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Generador de Informes</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $gestiones_fecha_comunicacion_cond, $gestiones_fecha_comunicacion, $gestiones_fecha_comunicacion_dia, $gestiones_fecha_comunicacion_mes, $gestiones_fecha_comunicacion_ano, $gestiones_fecha_comunicacion_hor, $gestiones_fecha_comunicacion_min, $gestiones_fecha_comunicacion_seg, $gestiones_fecha_comunicacion_input_2_dia, $gestiones_fecha_comunicacion_input_2_mes, $gestiones_fecha_comunicacion_input_2_ano, $gestiones_fecha_comunicacion_input_2_min, $gestiones_fecha_comunicacion_input_2_hor, $gestiones_fecha_comunicacion_input_2_seg,
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $pacientes_fecha_activacion_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['pacientes_fecha_activacion_paciente']; 
          $pacientes_fecha_activacion_paciente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['pacientes_fecha_activacion_paciente_cond']; 
          $gestiones_fecha_comunicacion_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_dia']; 
          $gestiones_fecha_comunicacion_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_mes']; 
          $gestiones_fecha_comunicacion_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_ano']; 
          $gestiones_fecha_comunicacion_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_input_2_dia']; 
          $gestiones_fecha_comunicacion_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_input_2_mes']; 
          $gestiones_fecha_comunicacion_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_input_2_ano']; 
          $gestiones_fecha_comunicacion_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_hor']; 
          $gestiones_fecha_comunicacion_min = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_min']; 
          $gestiones_fecha_comunicacion_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_seg']; 
          $gestiones_fecha_comunicacion_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_input_2_hor']; 
          $gestiones_fecha_comunicacion_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_input_2_min']; 
          $gestiones_fecha_comunicacion_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_input_2_seg']; 
          $gestiones_fecha_comunicacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($gestiones_fecha_comunicacion_cond) || empty($gestiones_fecha_comunicacion_cond))
      {
         $gestiones_fecha_comunicacion_cond = "eq";
      }
      ...
      $str_hide_gestiones_fecha_comunicacion = (in_array($gestiones_fecha_comunicacion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_gestiones_fecha_comunicacion = ('bw' == $gestiones_fecha_comunicacion_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($gestiones_fecha_comunicacion) || $gestiones_fecha_comunicacion == "")
      {
          $gestiones_fecha_comunicacion = "";
      }
      if (isset($gestiones_fecha_comunicacion) && !empty($gestiones_fecha_comunicacion))
      {
...
<?php
   if (is_file("generador_de_informes_help.txt"))
   {
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_pacientes_fecha_activacion_paciente" name="pacientes_fecha_activacion_paciente_autocomp" size="10" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['gestiones_fecha_comunicacion'])) ? $this->New_label['gestiones_fecha_comunicacion'] : "FECHA COMUNICACION"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_gestiones_fecha_comunicacion_cond" name="gestiones_fecha_comunicacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_gestiones_fecha_comunicacion'), this, 'gestiones_fecha_comunicacion')">
       <OPTION value="eq" <?php if ("eq" == $gestiones_fecha_comunicacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $gestiones_fecha_comunicacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $gestiones_fecha_comunicacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $gestiones_fecha_comunicacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_gestiones_fecha_comunicacion" <?php echo $str_hide_gestiones_fecha_comunicacion?> valign="top">
 ...
 $nmgp_tab_label .= "gestiones_fecha_comunicacion?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_gestiones_fecha_comunicacion_dia" name="gestiones_fecha_comunicacion_dia" value="<?php echo NM_encode_input($gestiones_fecha_comunicacion_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.gestiones_fecha_comunicacion_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_gestiones_fecha_comunicacion_mes" name="gestiones_fecha_comunicacion_mes" value="<?php echo NM_encode_input($gestiones_fecha_comunicacion_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.gestiones_fecha_comunicacion_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_gestiones_fecha_comunicacion_ano" name="gestiones_fecha_comunicacion_ano" value="<?php echo NM_encode_input($gestiones_fecha_comunicacion_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_gestiones_fecha_comunicacion_hor" name="gestiones_fecha_comunicacion_hor" value="<?php echo NM_encode_input($gestiones_fecha_comunicacion_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.gestiones_fecha_comunicacion_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_gestiones_fecha_comunicacion_min" name="gestiones_fecha_comunicacion_min" value="<?php echo NM_encode_input($gestiones_fecha_comunicacion_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.gestiones_fecha_comunicacion_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_gestiones_fecha_comunicacion_seg" name="gestiones_fecha_comunicacion_seg" value="<?php echo NM_encode_input($gestiones_fecha_comunicacion_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.gestiones_fecha_comunicacion_cond.value)">
...
?>
        <SPAN id="id_css_gestiones_fecha_comunicacion"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_gestiones_fecha_comunicacion"  <?php echo $str_display_gestiones_fecha_comunicacion; ?> class="scFilterFieldFontEven">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_gestiones_fecha_comunicacion_input_2_dia" name="gestiones_fecha_comunicacion_input_2_dia" value="<?php echo NM_encode_input($gestiones_fecha_comunicacion_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.gestiones_fecha_comunicacion_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_gestiones_fecha_comunicacion_input_2_mes" name="gestiones_fecha_comunicacion_input_2_mes" value="<?php echo NM_encode_input($gestiones_fecha_comunicacion_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.gestiones_fecha_comunicacion_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_gestiones_fecha_comunicacion_input_2_ano" name="gestiones_fecha_comunicacion_input_2_ano" value="<?php echo NM_encode_input($gestiones_fecha_comunicacion_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_gestiones_fecha_comunicacion_input_2_hor" name="gestiones_fecha_comunicacion_input_2_hor" value="<?php echo NM_encode_input($gestiones_fecha_comunicacion_input_2_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.gestiones_fecha_comunicacion_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_gestiones_fecha_comunicacion_input_2_min" name="gestiones_fecha_comunicacion_input_2_min" value="<?php echo NM_encode_input($gestiones_fecha_comunicacion_input_2_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.gestiones_fecha_comunicacion_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_gestiones_fecha_comunicacion_input_2_seg" name="gestiones_fecha_comunicacion_input_2_seg" value="<?php echo NM_encode_input($gestiones_fecha_comunicacion_input_2_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.gestiones_fecha_comunicacion_cond.value)">
...
<INPUT type="hidden" id="SC_NM_operador" name="NM_operador" value="or">  </TD>
 </TR>
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['generador_de_informes']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['generador_de_informes']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_gestiones_fecha_comunicacion'), document.F1.gestiones_fecha_comunicacion_cond, 'gestiones_fecha_comunicacion');
   document.F1.gestiones_fecha_comunicacion_dia.value = "";
   document.F1.gestiones_fecha_comunicacion_mes.value = "";
   document.F1.gestiones_fecha_comunicacion_ano.value = "";
   document.F1.gestiones_fecha_comunicacion_input_2_dia.value = "";
   document.F1.gestiones_fecha_comunicacion_input_2_mes.value = "";
   document.F1.gestiones_fecha_comunicacion_input_2_ano.value = "";
   document.F1.gestiones_fecha_comunicacion_hor.value = "";
   document.F1.gestiones_fecha_comunicacion_min.value = "";
   document.F1.gestiones_fecha_comunicacion_seg.value = "";
   document.F1.gestiones_fecha_comunicacion_input_2_hor.value = "";
   document.F1.gestiones_fecha_comunicacion_input_2_min.value = "";
   document.F1.gestiones_fecha_comunicacion_input_2_seg.value = "";
 }
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_gestiones_fecha_comunicacion_dia').bind('change', function() {sc_generador_de_informes_valida_dia(this)});
    $('#SC_gestiones_fecha_comunicacion_hor').bind('change', function() {sc_generador_de_informes_valida_hora(this)});
    $('#SC_gestiones_fecha_comunicacion_input_2_dia').bind('change', function() {sc_generador_de_informes_valida_dia(this)});
    $('#SC_gestiones_fecha_comunicacion_input_2_hor').bind('change', function() {sc_generador_de_informes_valida_hora(this)});
    $('#SC_gestiones_fecha_comunicacion_input_2_mes').bind('change', function() {sc_generador_de_informes_valida_mes(this)});
    $('#SC_gestiones_fecha_comunicacion_input_2_min').bind('change', function() {sc_generador_de_informes_valida_min(this)});
    $('#SC_gestiones_fecha_comunicacion_input_2_seg').bind('change', function() {sc_generador_de_informes_valida_seg(this)});
    $('#SC_gestiones_fecha_comunicacion_mes').bind('change', function() {sc_generador_de_informes_valida_mes(this)});
    $('#SC_gestiones_fecha_comunicacion_min').bind('change', function() {sc_generador_de_informes_valida_min(this)});
    $('#SC_gestiones_fecha_comunicacion_seg').bind('change', function() {sc_generador_de_informes_valida_seg(this)});
 }
 function sc_generador_de_informes_valida_dia(obj)
 {
 ...
 function sc_generador_de_informes_valida_mes(obj)
 {
 ...
 function sc_generador_de_informes_valida_hora(obj)
 {
 ...
 function sc_generador_de_informes_valida_min(obj)
 {
 ...
 function sc_generador_de_informes_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "prueba/generador_de_informes";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
      $this->comando_ini    = "ini";
      $this->comando_fim    = "";
      $this->NM_operador    = (isset($NM_operador) && ("and" == strtolower($NM_operador) || "or" == strtolower($NM_operador))) ? $NM_operador : "or";
   }
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "generador_de_informes/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_gestiones_fecha_comunicacion_cond'] = 'cond';
      $tp_fields['SC_gestiones_fecha_comunicacion_dia'] = 'text';
      $tp_fields['SC_gestiones_fecha_comunicacion_mes'] = 'text';
      $tp_fields['SC_gestiones_fecha_comunicacion_ano'] = 'text';
      $tp_fields['SC_gestiones_fecha_comunicacion_input_2_dia'] = 'text';
      $tp_fields['SC_gestiones_fecha_comunicacion_input_2_mes'] = 'text';
      $tp_fields['SC_gestiones_fecha_comunicacion_input_2_ano'] = 'text';
      $tp_fields['SC_gestiones_fecha_comunicacion_hor'] = 'text';
      $tp_fields['SC_gestiones_fecha_comunicacion_min'] = 'text';
      $tp_fields['SC_gestiones_fecha_comunicacion_seg'] = 'text';
      $tp_fields['SC_gestiones_fecha_comunicacion_input_2_hor'] = 'text';
      $tp_fields['SC_gestiones_fecha_comunicacion_input_2_min'] = 'text';
      $tp_fields['SC_gestiones_fecha_comunicacion_input_2_seg'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $pacientes_fecha_activacion_paciente_cond, $pacientes_fecha_activacion_paciente, $pacientes_fecha_activacion_paciente_autocomp,
             $gestiones_fecha_comunicacion_cond, $gestiones_fecha_comunicacion, $gestiones_fecha_comunicacion_dia, $gestiones_fecha_comunicacion_mes, $gestiones_fecha_comunicacion_ano, $gestiones_fecha_comunicacion_hor, $gestiones_fecha_comunicacion_min, $gestiones_fecha_comunicacion_seg, $gestiones_fecha_comunicacion_input_2_dia, $gestiones_fecha_comunicacion_input_2_mes, $gestiones_fecha_comunicacion_input_2_ano, $gestiones_fecha_comunicacion_input_2_min, $gestiones_fecha_comunicacion_input_2_hor, $gestiones_fecha_comunicacion_input_2_seg, $nmgp_tab_label;
      ...
      $gestiones_fecha_comunicacion_cond_salva = $gestiones_fecha_comunicacion_cond; 
      if (!isset($gestiones_fecha_comunicacion_input_2_dia) || $gestiones_fecha_comunicacion_input_2_dia == "")
      {
          $gestiones_fecha_comunicacion_input_2_dia = $gestiones_fecha_comunicacion_dia;
      }
      if (!isset($gestiones_fecha_comunicacion_input_2_mes) || $gestiones_fecha_comunicacion_input_2_mes == "")
      {
          $gestiones_fecha_comunicacion_input_2_mes = $gestiones_fecha_comunicacion_mes;
      }
      if (!isset($gestiones_fecha_comunicacion_input_2_ano) || $gestiones_fecha_comunicacion_input_2_ano == "")
      {
          $gestiones_fecha_comunicacion_input_2_ano = $gestiones_fecha_comunicacion_ano;
      }
      if (!isset($gestiones_fecha_comunicacion_input_2_hor) || $gestiones_fecha_comunicacion_input_2_hor == "")
      {
          $gestiones_fecha_comunicacion_input_2_hor = $gestiones_fecha_comunicacion_hor;
      }
      if (!isset($gestiones_fecha_comunicacion_input_2_min) || $gestiones_fecha_comunicacion_input_2_min == "")
      {
          $gestiones_fecha_comunicacion_input_2_min = $gestiones_fecha_comunicacion_min;
      }
      if (!isset($gestiones_fecha_comunicacion_input_2_seg) || $gestiones_fecha_comunicacion_input_2_seg == "")
      {
          $gestiones_fecha_comunicacion_input_2_seg = $gestiones_fecha_comunicacion_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['pacientes_fecha_activacion_paciente'] = $pacientes_fecha_activacion_paciente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['pacientes_fecha_activacion_paciente_cond'] = $pacientes_fecha_activacion_paciente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_dia'] = $gestiones_fecha_comunicacion_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_mes'] = $gestiones_fecha_comunicacion_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_ano'] = $gestiones_fecha_comunicacion_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_input_2_dia'] = $gestiones_fecha_comunicacion_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_input_2_mes'] = $gestiones_fecha_comunicacion_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_input_2_ano'] = $gestiones_fecha_comunicacion_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_hor'] = $gestiones_fecha_comunicacion_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_min'] = $gestiones_fecha_comunicacion_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_seg'] = $gestiones_fecha_comunicacion_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_input_2_hor'] = $gestiones_fecha_comunicacion_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_input_2_min'] = $gestiones_fecha_comunicacion_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_input_2_seg'] = $gestiones_fecha_comunicacion_input_2_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_cond'] = $gestiones_fecha_comunicacion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      //----- $gestiones_fecha_comunicacion
      $this->Date_part = false;
      if ($gestiones_fecha_comunicacion_cond != "TP")
      {
          $gestiones_fecha_comunicacion_cond = strtoupper($gestiones_fecha_comunicacion_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $gestiones_fecha_comunicacion_ano;
          $Dtxt .= $gestiones_fecha_comunicacion_mes;
          $Dtxt .= $gestiones_fecha_comunicacion_dia;
          $Dtxt .= $gestiones_fecha_comunicacion_hor;
          $Dtxt .= $gestiones_fecha_comunicacion_min;
          $Dtxt .= $gestiones_fecha_comunicacion_seg;
          $val[0]['ano'] = $gestiones_fecha_comunicacion_ano;
          $val[0]['mes'] = $gestiones_fecha_comunicacion_mes;
          $val[0]['dia'] = $gestiones_fecha_comunicacion_dia;
          $val[0]['hor'] = $gestiones_fecha_comunicacion_hor;
          $val[0]['min'] = $gestiones_fecha_comunicacion_min;
          $val[0]['seg'] = $gestiones_fecha_comunicacion_seg;
          if ($gestiones_fecha_comunicacion_cond == "BW")
          {
              $val[1]['ano'] = $gestiones_fecha_comunicacion_input_2_ano;
              $val[1]['mes'] = $gestiones_fecha_comunicacion_input_2_mes;
              $val[1]['dia'] = $gestiones_fecha_comunicacion_input_2_dia;
              $val[1]['hor'] = $gestiones_fecha_comunicacion_input_2_hor;
              $val[1]['min'] = $gestiones_fecha_comunicacion_input_2_min;
              $val[1]['seg'] = $gestiones_fecha_comunicacion_input_2_seg;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DH", "TIMESTAMP", $gestiones_fecha_comunicacion_cond , "");
          $gestiones_fecha_comunicacion = $val[0];
          $this->cmp_formatado['gestiones_fecha_comunicacion'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['gestiones_fecha_comunicacion'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['gestiones_fecha_comunicacion'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          if ($gestiones_fecha_comunicacion_cond == "BW")
          {
              $gestiones_fecha_comunicacion_input_2     = $val[1];
              $this->cmp_formatado['gestiones_fecha_comunicacion_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']['gestiones_fecha_comunicacion_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['gestiones_fecha_comunicacion_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['gestiones_fecha_comunicacion_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          }
          if (!empty($Dtxt) || $gestiones_fecha_comunicacion_cond == "NU" || $gestiones_fecha_comunicacion_cond == "NN"|| $gestiones_fecha_comunicacion_cond == "EP"|| $gestiones_fecha_comunicacion_cond == "NE")
          {
              $this->monta_condicao("gestiones.FECHA_COMUNICACION", $gestiones_fecha_comunicacion_cond, $gestiones_fecha_comunicacion, $gestiones_fecha_comunicacion_input_2, 'gestiones_fecha_comunicacion', 'TIMESTAMP');
          }
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['interativ_search'] = array();
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['where_pesq_ant'] = $this->comando . $this->comando_fim;
