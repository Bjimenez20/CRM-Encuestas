...
class HISTORICO_RECLAMACIONES_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $tit_doc;
   //---- 
   function HISTORICO_RECLAMACIONES_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".xls";
      $this->tit_doc    = "HISTORICO_RECLAMACIONES.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['xls_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['xls_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['xls_name']);
          $this->xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
   ...
   function NM_export_historial_reclamacion_id_historial_reclamacion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->historial_reclamacion_id_historial_reclamacion))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_id_historial_reclamacion);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_anio_historial_reclamacion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->historial_reclamacion_anio_historial_reclamacion))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_anio_historial_reclamacion);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_mes1()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_mes1, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_reclamo1()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_reclamo1, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_fecha_reclamacion1()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_fecha_reclamacion1, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_motivo_no_reclamacion1()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_motivo_no_reclamacion1, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_mes2()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_mes2, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_reclamo2()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_reclamo2, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_fecha_reclamacion2()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_fecha_reclamacion2, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_motivo_no_reclamacion2()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_motivo_no_reclamacion2, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_mes3()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_mes3, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_reclamo3()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_reclamo3, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_fecha_reclamacion3()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_fecha_reclamacion3, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_motivo_no_reclamacion3()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_motivo_no_reclamacion3, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_mes4()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_mes4, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_reclamo4()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_reclamo4, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_fecha_reclamacion4()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_fecha_reclamacion4, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_motivo_no_reclamacion4()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_motivo_no_reclamacion4, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_mes5()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_mes5, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_reclamo5()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_reclamo5, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_fecha_reclamacion5()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_fecha_reclamacion5, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_motivo_no_reclamacion5()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_motivo_no_reclamacion5, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_mes6()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_mes6, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_reclamo6()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_reclamo6, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_fecha_reclamacion6()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_fecha_reclamacion6, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_motivo_no_reclamacion6()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_motivo_no_reclamacion6, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_mes7()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_mes7, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_reclamo7()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_reclamo7, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_fecha_reclamacion7()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_fecha_reclamacion7, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_motivo_no_reclamacion7()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_motivo_no_reclamacion7, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_mes8()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_mes8, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_reclamo8()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_reclamo8, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_fecha_reclamacion8()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_fecha_reclamacion8, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_motivo_no_reclamacion8()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_motivo_no_reclamacion8, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_mes9()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_mes9, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_reclamo9()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_reclamo9, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_fecha_reclamacion9()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_fecha_reclamacion9, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_motivo_no_reclamacion9()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_motivo_no_reclamacion9, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_mes10()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_mes10, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_reclamo10()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_reclamo10, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_fecha_reclamacion10()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_fecha_reclamacion10, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_motivo_no_reclamacion10()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_motivo_no_reclamacion10, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_mes11()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_mes11, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_reclamo11()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_reclamo11, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_fecha_reclamacion11()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_fecha_reclamacion11, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_motivo_no_reclamacion11()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_motivo_no_reclamacion11, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_mes12()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_mes12, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_reclamo12()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_reclamo12, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_fecha_reclamacion12()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_fecha_reclamacion12, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_historial_reclamacion_motivo_no_reclamacion12()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->historial_reclamacion_motivo_no_reclamacion12, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['xls_file']);
      if (is_file($this->xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['xls_file'] = $this->xls_f;
      }
