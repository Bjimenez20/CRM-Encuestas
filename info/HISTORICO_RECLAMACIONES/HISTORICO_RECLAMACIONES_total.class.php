...
class HISTORICO_RECLAMACIONES_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //----- 
   function HISTORICO_RECLAMACIONES_total($sc_page)
   {
      $this->sc_page = $sc_page;
      $this->nm_data = new nm_data("es");
      if (isset($_SESSION['sc_session'][$this->sc_page]['HISTORICO_RECLAMACIONES']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['HISTORICO_RECLAMACIONES']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['contr_total_geral'] = "OK";
   } 
