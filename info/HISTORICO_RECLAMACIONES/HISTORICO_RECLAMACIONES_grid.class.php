<?php
class HISTORICO_RECLAMACIONES_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['charts_html'] = '';
   ...
   { 
       ...
       $nmgrp_apl_opcao= $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'];
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] == "pdf")
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'];
 }
...
//
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "HISTORICO_RECLAMACIONES/HISTORICO_RECLAMACIONES_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['mostra_edit'] = "N";
       }
   }
   ...
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("HISTORICO_RECLAMACIONES", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $this->Cmps_ord_def["pacientes.DEPARTAMENTO_PACIENTE"] = "";
   $this->Cmps_ord_def['cmp_maior_30_4'] = " asc";
   $this->Cmps_ord_def["pacientes.CIUDAD_PACIENTE"] = "";
   ...
   $this->Cmps_ord_def['cmp_maior_30_7'] = " asc";
   $this->Cmps_ord_def["pacientes.FECHA_ACTIVACION_PACIENTE"] = "";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['SC_Gb_Free_cmp']))
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] = "muda_qt_linhas";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'])
   {
       $nmgp_ordem = ""; 
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "HISTORICO_RECLAMACIONES/HISTORICO_RECLAMACIONES_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "HISTORICO_RECLAMACIONES_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new HISTORICO_RECLAMACIONES_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_lin_grid']; 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_select'] = array(); 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_select']['pacientes.ID_PACIENTE'] = 'ASC'; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_select']; 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_quebra'][$nmgp_ordem])) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] = "inicio" ;  
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_grid'] = ""; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_quebra'][$nmgp_ordem] == "asc") 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_quebra'][$nmgp_ordem] = "desc"; 
           }   
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_quebra'][$nmgp_ordem] = "asc"; 
           }   
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_cmp'] = $nmgp_ordem;  
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_quebra'][$nmgp_ordem]);  
       }   
       else   
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_grid'] = $nmgp_ordem  ; 
       }   
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao']       = "igual" ; 
   } 
// 
   $this->count_ger = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_reg_grid'] == "all") 
   { 
       $this->Tot->quebra_geral() ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] == "pdf" || isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_liga']['paginacao']))
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'])
   { 
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['pivot_charts']) : 0;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ajax_nav'])
       { 
           ...
           $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . session_id() . "\">\r\n");
           $nm_saida->saida("   </form>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"HISTORICO_RECLAMACIONES_jquery.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"HISTORICO_RECLAMACIONES_ajax.js\"></script>\r\n");
           ...
           $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_reg_grid']) . ";\r\n");
           $nm_saida->saida("  function scSetFixedHeaders() {\r\n");
           $nm_saida->saida("   var divScroll, gridHeaders, headerPlaceholder;\r\n");
           $nm_saida->saida("   gridHeaders = $(\".sc-ui-grid-header-row-HISTORICO_RECLAMACIONES-1\");\r\n");
           ...
           $nm_saida->saida("   tableOriginal = $(\"#sc-ui-grid-body-70fdeb45\");\r\n");
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_HISTORICO_RECLAMACIONES_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'])
       {
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_HISTORICO_RECLAMACIONES_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_HISTORICO_RECLAMACIONES_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "HISTORICO_RECLAMACIONES/HISTORICO_RECLAMACIONES_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".HISTORICO_RECLAMACIONES_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "pdf" && !$this->Print_All)
       { 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['HISTORICO_RECLAMACIONES']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['HISTORICO_RECLAMACIONES']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['HISTORICO_RECLAMACIONES']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['HISTORICO_RECLAMACIONES']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida']) ? "HISTORICO_RECLAMACIONES_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho()
 {
   global
          $nm_saida;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['cond_pesq'], 0, $trab_pos);
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['sv_dt_head'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['sv_dt_head']['fix'] != $nm_data_fixa)
   {
       $nm_refresch_cab_rod = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_HISTORICO_RECLAMACIONES__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-HISTORICO_RECLAMACIONES-" . $tmp_header_row . "\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_psq']) { 
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['field_order'] as $Cada_label)
   { 
       $NM_func_lab = "NM_label_" . $Cada_label;
       $this->$NM_func_lab();
   } 
   $nm_saida->saida("</TR>\r\n");
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida_label'])
     { 
         if (isset($_SESSION['scriptcase']['saida_var']) && $_SESSION['scriptcase']['saida_var'])
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".HISTORICO_RECLAMACIONES_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_pacientes_id_paciente()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "pdf")
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_cmp'] == $NM_cmp_class)
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ordem_label'] == "desc")
          {
 ...
 function NM_label_pacientes_departamento_paciente()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_pacientes_departamento_paciente_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_pacientes_departamento_paciente_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "pdf")
   {
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
          $NM_cmp_class =  "pacientes.DEPARTAMENTO_PACIENTE";
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      {
          $NM_cmp_class =  "pacientes.DEPARTAMENTO_PACIENTE";
 ...
 function NM_label_pacientes_ciudad_paciente()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_pacientes_ciudad_paciente_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_pacientes_ciudad_paciente_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "pdf")
   {
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
          $NM_cmp_class =  "pacientes.CIUDAD_PACIENTE";
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      {
          $NM_cmp_class =  "pacientes.CIUDAD_PACIENTE";
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['pacientes_id_paciente'])) ? $this->New_label['pacientes_id_paciente'] : "ID PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['pacientes_id_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['gestiones_logro_comunicacion_gestion'])) ? $this->New_label['gestiones_logro_comunicacion_gestion'] : "LOGRO COMUNICACION GESTION"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['gestiones_logro_comunicacion_gestion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['gestiones_fecha_comunicacion'])) ? $this->New_label['gestiones_fecha_comunicacion'] : "FECHA COMUNICACION"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['gestiones_fecha_comunicacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['gestiones_autor_gestion'])) ? $this->New_label['gestiones_autor_gestion'] : "AUTOR GESTION"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['gestiones_autor_gestion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pacientes_departamento_paciente'])) ? $this->New_label['pacientes_departamento_paciente'] : "DEPARTAMENTO PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['pacientes_departamento_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pacientes_ciudad_paciente'])) ? $this->New_label['pacientes_ciudad_paciente'] : "CIUDAD PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['pacientes_ciudad_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pacientes_estado_paciente'])) ? $this->New_label['pacientes_estado_paciente'] : "ESTADO PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['pacientes_estado_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pacientes_status_paciente'])) ? $this->New_label['pacientes_status_paciente'] : "STATUS PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['pacientes_status_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pacientes_fecha_activacion_paciente'])) ? $this->New_label['pacientes_fecha_activacion_paciente'] : "FECHA ACTIVACION PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['pacientes_fecha_activacion_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pacientes_codigo_xofigo'])) ? $this->New_label['pacientes_codigo_xofigo'] : "CODIGO XOFIGO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['pacientes_codigo_xofigo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tratamiento_producto_tratamiento'])) ? $this->New_label['tratamiento_producto_tratamiento'] : "PRODUCTO TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['tratamiento_producto_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tratamiento_nombre_referencia'])) ? $this->New_label['tratamiento_nombre_referencia'] : "NOMBRE REFERENCIA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['tratamiento_nombre_referencia'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tratamiento_dosis_tratamiento'])) ? $this->New_label['tratamiento_dosis_tratamiento'] : "DOSIS TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['tratamiento_dosis_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['gestiones_numero_cajas'])) ? $this->New_label['gestiones_numero_cajas'] : "NUMERO CAJAS"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['gestiones_numero_cajas'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tratamiento_asegurador_tratamiento'])) ? $this->New_label['tratamiento_asegurador_tratamiento'] : "ASEGURADOR TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['tratamiento_asegurador_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tratamiento_operador_logistico_tratamiento'])) ? $this->New_label['tratamiento_operador_logistico_tratamiento'] : "OPERADOR LOGISTICO TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['tratamiento_operador_logistico_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tratamiento_punto_entrega'])) ? $this->New_label['tratamiento_punto_entrega'] : "PUNTO ENTREGA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['tratamiento_punto_entrega'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['gestiones_reclamo_gestion'])) ? $this->New_label['gestiones_reclamo_gestion'] : "RECLAMO GESTION"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['gestiones_reclamo_gestion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['gestiones_fecha_reclamacion_gestion'])) ? $this->New_label['gestiones_fecha_reclamacion_gestion'] : "FECHA RECLAMACION GESTION"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['gestiones_fecha_reclamacion_gestion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['gestiones_causa_no_reclamacion_gestion'])) ? $this->New_label['gestiones_causa_no_reclamacion_gestion'] : "CAUSA NO RECLAMACION GESTION"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['gestiones_causa_no_reclamacion_gestion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_id_historial_reclamacion'])) ? $this->New_label['historial_reclamacion_id_historial_reclamacion'] : "ID HISTORIAL RECLAMACION"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_id_historial_reclamacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_anio_historial_reclamacion'])) ? $this->New_label['historial_reclamacion_anio_historial_reclamacion'] : "ANIO HISTORIAL RECLAMACION"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_anio_historial_reclamacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_mes1'])) ? $this->New_label['historial_reclamacion_mes1'] : "MES1"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_mes1'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_reclamo1'])) ? $this->New_label['historial_reclamacion_reclamo1'] : "RECLAMO1"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_reclamo1'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_fecha_reclamacion1'])) ? $this->New_label['historial_reclamacion_fecha_reclamacion1'] : "FECHA RECLAMACION1"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_fecha_reclamacion1'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_motivo_no_reclamacion1'])) ? $this->New_label['historial_reclamacion_motivo_no_reclamacion1'] : "MOTIVO NO RECLAMACION1"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_motivo_no_reclamacion1'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_mes2'])) ? $this->New_label['historial_reclamacion_mes2'] : "MES2"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_mes2'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_reclamo2'])) ? $this->New_label['historial_reclamacion_reclamo2'] : "RECLAMO2"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_reclamo2'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_fecha_reclamacion2'])) ? $this->New_label['historial_reclamacion_fecha_reclamacion2'] : "FECHA RECLAMACION2"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_fecha_reclamacion2'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_motivo_no_reclamacion2'])) ? $this->New_label['historial_reclamacion_motivo_no_reclamacion2'] : "MOTIVO NO RECLAMACION2"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_motivo_no_reclamacion2'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_mes3'])) ? $this->New_label['historial_reclamacion_mes3'] : "MES3"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_mes3'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_reclamo3'])) ? $this->New_label['historial_reclamacion_reclamo3'] : "RECLAMO3"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_reclamo3'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_fecha_reclamacion3'])) ? $this->New_label['historial_reclamacion_fecha_reclamacion3'] : "FECHA RECLAMACION3"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_fecha_reclamacion3'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_motivo_no_reclamacion3'])) ? $this->New_label['historial_reclamacion_motivo_no_reclamacion3'] : "MOTIVO NO RECLAMACION3"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_motivo_no_reclamacion3'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_mes4'])) ? $this->New_label['historial_reclamacion_mes4'] : "MES4"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_mes4'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_reclamo4'])) ? $this->New_label['historial_reclamacion_reclamo4'] : "RECLAMO4"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_reclamo4'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_fecha_reclamacion4'])) ? $this->New_label['historial_reclamacion_fecha_reclamacion4'] : "FECHA RECLAMACION4"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_fecha_reclamacion4'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_motivo_no_reclamacion4'])) ? $this->New_label['historial_reclamacion_motivo_no_reclamacion4'] : "MOTIVO NO RECLAMACION4"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_motivo_no_reclamacion4'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_mes5'])) ? $this->New_label['historial_reclamacion_mes5'] : "MES5"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_mes5'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_reclamo5'])) ? $this->New_label['historial_reclamacion_reclamo5'] : "RECLAMO5"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_reclamo5'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_fecha_reclamacion5'])) ? $this->New_label['historial_reclamacion_fecha_reclamacion5'] : "FECHA RECLAMACION5"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_fecha_reclamacion5'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_motivo_no_reclamacion5'])) ? $this->New_label['historial_reclamacion_motivo_no_reclamacion5'] : "MOTIVO NO RECLAMACION5"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_motivo_no_reclamacion5'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_mes6'])) ? $this->New_label['historial_reclamacion_mes6'] : "MES6"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_mes6'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_reclamo6'])) ? $this->New_label['historial_reclamacion_reclamo6'] : "RECLAMO6"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_reclamo6'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_fecha_reclamacion6'])) ? $this->New_label['historial_reclamacion_fecha_reclamacion6'] : "FECHA RECLAMACION6"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_fecha_reclamacion6'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_motivo_no_reclamacion6'])) ? $this->New_label['historial_reclamacion_motivo_no_reclamacion6'] : "MOTIVO NO RECLAMACION6"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_motivo_no_reclamacion6'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_mes7'])) ? $this->New_label['historial_reclamacion_mes7'] : "MES7"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_mes7'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_reclamo7'])) ? $this->New_label['historial_reclamacion_reclamo7'] : "RECLAMO7"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_reclamo7'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_fecha_reclamacion7'])) ? $this->New_label['historial_reclamacion_fecha_reclamacion7'] : "FECHA RECLAMACION7"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_fecha_reclamacion7'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_motivo_no_reclamacion7'])) ? $this->New_label['historial_reclamacion_motivo_no_reclamacion7'] : "MOTIVO NO RECLAMACION7"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_motivo_no_reclamacion7'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_mes8'])) ? $this->New_label['historial_reclamacion_mes8'] : "MES8"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_mes8'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_reclamo8'])) ? $this->New_label['historial_reclamacion_reclamo8'] : "RECLAMO8"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_reclamo8'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_fecha_reclamacion8'])) ? $this->New_label['historial_reclamacion_fecha_reclamacion8'] : "FECHA RECLAMACION8"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_fecha_reclamacion8'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_motivo_no_reclamacion8'])) ? $this->New_label['historial_reclamacion_motivo_no_reclamacion8'] : "MOTIVO NO RECLAMACION8"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_motivo_no_reclamacion8'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_mes9'])) ? $this->New_label['historial_reclamacion_mes9'] : "MES9"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_mes9'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_reclamo9'])) ? $this->New_label['historial_reclamacion_reclamo9'] : "RECLAMO9"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_reclamo9'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_fecha_reclamacion9'])) ? $this->New_label['historial_reclamacion_fecha_reclamacion9'] : "FECHA RECLAMACION9"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_fecha_reclamacion9'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_motivo_no_reclamacion9'])) ? $this->New_label['historial_reclamacion_motivo_no_reclamacion9'] : "MOTIVO NO RECLAMACION9"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_motivo_no_reclamacion9'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_mes10'])) ? $this->New_label['historial_reclamacion_mes10'] : "MES10"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_mes10'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_reclamo10'])) ? $this->New_label['historial_reclamacion_reclamo10'] : "RECLAMO10"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_reclamo10'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_fecha_reclamacion10'])) ? $this->New_label['historial_reclamacion_fecha_reclamacion10'] : "FECHA RECLAMACION10"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_fecha_reclamacion10'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_motivo_no_reclamacion10'])) ? $this->New_label['historial_reclamacion_motivo_no_reclamacion10'] : "MOTIVO NO RECLAMACION10"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_motivo_no_reclamacion10'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_mes11'])) ? $this->New_label['historial_reclamacion_mes11'] : "MES11"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_mes11'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_reclamo11'])) ? $this->New_label['historial_reclamacion_reclamo11'] : "RECLAMO11"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_reclamo11'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_fecha_reclamacion11'])) ? $this->New_label['historial_reclamacion_fecha_reclamacion11'] : "FECHA RECLAMACION11"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_fecha_reclamacion11'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_motivo_no_reclamacion11'])) ? $this->New_label['historial_reclamacion_motivo_no_reclamacion11'] : "MOTIVO NO RECLAMACION11"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_motivo_no_reclamacion11'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_mes12'])) ? $this->New_label['historial_reclamacion_mes12'] : "MES12"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_mes12'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_reclamo12'])) ? $this->New_label['historial_reclamacion_reclamo12'] : "RECLAMO12"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_reclamo12'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_fecha_reclamacion12'])) ? $this->New_label['historial_reclamacion_fecha_reclamacion12'] : "FECHA RECLAMACION12"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_fecha_reclamacion12'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['historial_reclamacion_motivo_no_reclamacion12'])) ? $this->New_label['historial_reclamacion_motivo_no_reclamacion12'] : "MOTIVO NO RECLAMACION12"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['labels']['historial_reclamacion_motivo_no_reclamacion12'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['HISTORICO_RECLAMACIONES']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_HISTORICO_RECLAMACIONES#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridTabelaTd . " " . "\" style=\"font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\">\r\n");
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['force_toolbar']))
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['force_toolbar'] = true;
           } 
   ...
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['force_toolbar']);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'])
   { 
       $nm_saida->saida("<table id=\"apl_HISTORICO_RECLAMACIONES#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
   ...
   { 
       $nm_saida->saida(" <TR> \r\n");
       $nm_id_aplicacao = " id=\"apl_HISTORICO_RECLAMACIONES#?#1\"";
   } 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-70fdeb45\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'])
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['cab_embutida'] != "S" )
      { 
...
// 
   ...
   $ini_grid = true;
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          $this->NM_field_style = array();
          //---------- Gauge ----------
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
          ...
          $this->historial_reclamacion_motivo_no_reclamacion12 = $this->rs_grid->fields[69] ;  
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['final'] + 1; 
          if (!$ini_grid) {
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['dado_psq_ret'];
 ...
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
          ...
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['exibe_total'] == "S")
       { 
 ...
 function NM_grid_historial_reclamacion_anio_historial_reclamacion()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['historial_reclamacion_anio_historial_reclamacion']) || $this->NM_cmp_hidden['historial_reclamacion_anio_historial_reclamacion'] != "off") { 
          $conteudo = NM_encode_input($this->historial_reclamacion_anio_historial_reclamacion); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
 ...
 function quebra_geral_top() 
 {
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao_print'] != "print") 
      {
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "HISTORICO_RECLAMACIONES/HISTORICO_RECLAMACIONES_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnSelCamposShow('" . $this->Ini->path_link . "HISTORICO_RECLAMACIONES/HISTORICO_RECLAMACIONES_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
              $UseAlias =  "N";
          ...
          else
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "HISTORICO_RECLAMACIONES/HISTORICO_RECLAMACIONES_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnOrderCamposShow('" . $this->Ini->path_link . "HISTORICO_RECLAMACIONES/HISTORICO_RECLAMACIONES_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      ...
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "HISTORICO_RECLAMACIONES/HISTORICO_RECLAMACIONES_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&lpapel=0&apapel=0&orientacao=1&bookmarks=XX&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&language=es&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr><tr><td class=\"scBtnGrpBackground\">\r\n");
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "HISTORICO_RECLAMACIONES/HISTORICO_RECLAMACIONES_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
          ...
          $nm_saida->saida("            </div>\r\n");
              ...
              $nm_saida->saida("           </td></tr><tr><td class=\"scBtnGrpBackground\">\r\n");
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
          ...
          $nm_saida->saida("            </div>\r\n");
              ...
              $nm_saida->saida("           </td></tr><tr><td class=\"scBtnGrpBackground\">\r\n");
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "HISTORICO_RECLAMACIONES/HISTORICO_RECLAMACIONES_config_print.php?nm_opc=AM&nm_cor=AM&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if (is_file("HISTORICO_RECLAMACIONES_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("HISTORICO_RECLAMACIONES_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full)
      {
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['sc_modal'])
        {
      ...
      $nm_saida->saida("        </tr> \r\n");
      $nm_saida->saida("       </table> \r\n");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ajax_nav'] && $this->force_toolbar)
      { 
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao_print'] != "print") 
      {
          if (empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_liga']['paginacao']))
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_liga']['paginacao']))
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_lin_grid'] == 50) ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if (empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_liga']['nav']) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_liga']['paginacao']))
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_liga']['nav']))
          {
   ...
   function nmgp_barra_top_mobile()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['fast_search'][2] : "";
      ...
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           if ($this->arr_buttons['bcons_avanca']['type'] != 'image')
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
   ...
   {
       $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('HISTORICO_RECLAMACIONES', $(document).innerHeight());\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
 }
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"HISTORICO_RECLAMACIONES\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"HISTORICO_RECLAMACIONES_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . NM_encode_input(session_id()) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['HISTORICO_RECLAMACIONES_iframe_params'] = array(
   ...
   $nm_saida->saida("       {\r\n");
   $nm_saida->saida("           window.location = \"" . $this->Ini->path_link . "HISTORICO_RECLAMACIONES/HISTORICO_RECLAMACIONES_iframe.php?scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['campo_psq_ret']) && empty($this->nm_grid_sem_reg))
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['sc_modal'])
      {
          $nm_saida->saida("          var Obj_Form = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Doc = parent;\r\n");
          $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
      else
      {
          $nm_saida->saida("          var Obj_Form = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Doc = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"HISTORICO_RECLAMACIONES_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['HISTORICO_RECLAMACIONES']['reg_start']))
   {
       $nm_saida->saida("      parent.scAjaxDetailStatus('HISTORICO_RECLAMACIONES');\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('HISTORICO_RECLAMACIONES', $(document).innerHeight());\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
 }
