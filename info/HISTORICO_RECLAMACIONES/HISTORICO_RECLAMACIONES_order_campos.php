<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new HISTORICO_RECLAMACIONES_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class HISTORICO_RECLAMACIONES_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["pacientes_id_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["pacientes_id_paciente"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["pacientes_id_paciente"] : "ID PACIENTE";
   ...
   $tab_labels["gestiones_logro_comunicacion_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["gestiones_logro_comunicacion_gestion"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["gestiones_logro_comunicacion_gestion"] : "LOGRO COMUNICACION GESTION";
   ...
   $tab_labels["gestiones_fecha_comunicacion"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["gestiones_fecha_comunicacion"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["gestiones_fecha_comunicacion"] : "FECHA COMUNICACION";
   ...
   $tab_labels["gestiones_autor_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["gestiones_autor_gestion"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["gestiones_autor_gestion"] : "AUTOR GESTION";
   ...
   $tab_labels["pacientes_departamento_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["pacientes_departamento_paciente"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["pacientes_departamento_paciente"] : "DEPARTAMENTO PACIENTE";
   ...
   $tab_labels["pacientes_ciudad_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["pacientes_ciudad_paciente"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["pacientes_ciudad_paciente"] : "CIUDAD PACIENTE";
   ...
   $tab_labels["pacientes_estado_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["pacientes_estado_paciente"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["pacientes_estado_paciente"] : "ESTADO PACIENTE";
   ...
   $tab_labels["pacientes_status_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["pacientes_status_paciente"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["pacientes_status_paciente"] : "STATUS PACIENTE";
   ...
   $tab_labels["pacientes_fecha_activacion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["pacientes_fecha_activacion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["pacientes_fecha_activacion_paciente"] : "FECHA ACTIVACION PACIENTE";
   ...
   $tab_labels["pacientes_codigo_xofigo"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["pacientes_codigo_xofigo"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["pacientes_codigo_xofigo"] : "CODIGO XOFIGO";
   ...
   $tab_labels["tratamiento_producto_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["tratamiento_producto_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["tratamiento_producto_tratamiento"] : "PRODUCTO TRATAMIENTO";
   ...
   $tab_labels["tratamiento_nombre_referencia"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["tratamiento_nombre_referencia"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["tratamiento_nombre_referencia"] : "NOMBRE REFERENCIA";
   ...
   $tab_labels["tratamiento_dosis_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["tratamiento_dosis_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["tratamiento_dosis_tratamiento"] : "DOSIS TRATAMIENTO";
   ...
   $tab_labels["gestiones_numero_cajas"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["gestiones_numero_cajas"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["gestiones_numero_cajas"] : "NUMERO CAJAS";
   ...
   $tab_labels["tratamiento_asegurador_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["tratamiento_asegurador_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["tratamiento_asegurador_tratamiento"] : "ASEGURADOR TRATAMIENTO";
   ...
   $tab_labels["tratamiento_operador_logistico_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["tratamiento_operador_logistico_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["tratamiento_operador_logistico_tratamiento"] : "OPERADOR LOGISTICO TRATAMIENTO";
   ...
   $tab_labels["tratamiento_punto_entrega"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["tratamiento_punto_entrega"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["tratamiento_punto_entrega"] : "PUNTO ENTREGA";
   ...
   $tab_labels["gestiones_reclamo_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["gestiones_reclamo_gestion"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["gestiones_reclamo_gestion"] : "RECLAMO GESTION";
   ...
   $tab_labels["gestiones_fecha_reclamacion_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["gestiones_fecha_reclamacion_gestion"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["gestiones_fecha_reclamacion_gestion"] : "FECHA RECLAMACION GESTION";
   ...
   $tab_labels["gestiones_causa_no_reclamacion_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["gestiones_causa_no_reclamacion_gestion"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["gestiones_causa_no_reclamacion_gestion"] : "CAUSA NO RECLAMACION GESTION";
   ...
   $tab_labels["historial_reclamacion_id_historial_reclamacion"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_id_historial_reclamacion"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_id_historial_reclamacion"] : "ID HISTORIAL RECLAMACION";
   ...
   $tab_labels["historial_reclamacion_anio_historial_reclamacion"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_anio_historial_reclamacion"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_anio_historial_reclamacion"] : "ANIO HISTORIAL RECLAMACION";
   ...
   $tab_labels["historial_reclamacion_mes1"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes1"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes1"] : "MES1";
   ...
   $tab_labels["historial_reclamacion_reclamo1"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo1"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo1"] : "RECLAMO1";
   ...
   $tab_labels["historial_reclamacion_fecha_reclamacion1"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion1"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion1"] : "FECHA RECLAMACION1";
   ...
   $tab_labels["historial_reclamacion_motivo_no_reclamacion1"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion1"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion1"] : "MOTIVO NO RECLAMACION1";
   ...
   $tab_labels["historial_reclamacion_mes2"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes2"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes2"] : "MES2";
   ...
   $tab_labels["historial_reclamacion_reclamo2"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo2"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo2"] : "RECLAMO2";
   ...
   $tab_labels["historial_reclamacion_fecha_reclamacion2"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion2"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion2"] : "FECHA RECLAMACION2";
   ...
   $tab_labels["historial_reclamacion_motivo_no_reclamacion2"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion2"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion2"] : "MOTIVO NO RECLAMACION2";
   ...
   $tab_labels["historial_reclamacion_mes3"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes3"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes3"] : "MES3";
   ...
   $tab_labels["historial_reclamacion_reclamo3"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo3"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo3"] : "RECLAMO3";
   ...
   $tab_labels["historial_reclamacion_fecha_reclamacion3"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion3"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion3"] : "FECHA RECLAMACION3";
   ...
   $tab_labels["historial_reclamacion_motivo_no_reclamacion3"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion3"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion3"] : "MOTIVO NO RECLAMACION3";
   ...
   $tab_labels["historial_reclamacion_mes4"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes4"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes4"] : "MES4";
   ...
   $tab_labels["historial_reclamacion_reclamo4"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo4"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo4"] : "RECLAMO4";
   ...
   $tab_labels["historial_reclamacion_fecha_reclamacion4"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion4"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion4"] : "FECHA RECLAMACION4";
   ...
   $tab_labels["historial_reclamacion_motivo_no_reclamacion4"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion4"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion4"] : "MOTIVO NO RECLAMACION4";
   ...
   $tab_labels["historial_reclamacion_mes5"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes5"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes5"] : "MES5";
   ...
   $tab_labels["historial_reclamacion_reclamo5"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo5"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo5"] : "RECLAMO5";
   ...
   $tab_labels["historial_reclamacion_fecha_reclamacion5"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion5"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion5"] : "FECHA RECLAMACION5";
   ...
   $tab_labels["historial_reclamacion_motivo_no_reclamacion5"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion5"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion5"] : "MOTIVO NO RECLAMACION5";
   ...
   $tab_labels["historial_reclamacion_mes6"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes6"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes6"] : "MES6";
   ...
   $tab_labels["historial_reclamacion_reclamo6"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo6"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo6"] : "RECLAMO6";
   ...
   $tab_labels["historial_reclamacion_fecha_reclamacion6"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion6"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion6"] : "FECHA RECLAMACION6";
   ...
   $tab_labels["historial_reclamacion_motivo_no_reclamacion6"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion6"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion6"] : "MOTIVO NO RECLAMACION6";
   ...
   $tab_labels["historial_reclamacion_mes7"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes7"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes7"] : "MES7";
   ...
   $tab_labels["historial_reclamacion_reclamo7"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo7"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo7"] : "RECLAMO7";
   ...
   $tab_labels["historial_reclamacion_fecha_reclamacion7"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion7"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion7"] : "FECHA RECLAMACION7";
   ...
   $tab_labels["historial_reclamacion_motivo_no_reclamacion7"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion7"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion7"] : "MOTIVO NO RECLAMACION7";
   ...
   $tab_labels["historial_reclamacion_mes8"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes8"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes8"] : "MES8";
   ...
   $tab_labels["historial_reclamacion_reclamo8"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo8"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo8"] : "RECLAMO8";
   ...
   $tab_labels["historial_reclamacion_fecha_reclamacion8"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion8"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion8"] : "FECHA RECLAMACION8";
   ...
   $tab_labels["historial_reclamacion_motivo_no_reclamacion8"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion8"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion8"] : "MOTIVO NO RECLAMACION8";
   ...
   $tab_labels["historial_reclamacion_mes9"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes9"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes9"] : "MES9";
   ...
   $tab_labels["historial_reclamacion_reclamo9"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo9"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo9"] : "RECLAMO9";
   ...
   $tab_labels["historial_reclamacion_fecha_reclamacion9"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion9"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion9"] : "FECHA RECLAMACION9";
   ...
   $tab_labels["historial_reclamacion_motivo_no_reclamacion9"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion9"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion9"] : "MOTIVO NO RECLAMACION9";
   ...
   $tab_labels["historial_reclamacion_mes10"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes10"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes10"] : "MES10";
   ...
   $tab_labels["historial_reclamacion_reclamo10"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo10"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo10"] : "RECLAMO10";
   ...
   $tab_labels["historial_reclamacion_fecha_reclamacion10"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion10"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion10"] : "FECHA RECLAMACION10";
   ...
   $tab_labels["historial_reclamacion_motivo_no_reclamacion10"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion10"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion10"] : "MOTIVO NO RECLAMACION10";
   ...
   $tab_labels["historial_reclamacion_mes11"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes11"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes11"] : "MES11";
   ...
   $tab_labels["historial_reclamacion_reclamo11"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo11"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo11"] : "RECLAMO11";
   ...
   $tab_labels["historial_reclamacion_fecha_reclamacion11"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion11"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion11"] : "FECHA RECLAMACION11";
   ...
   $tab_labels["historial_reclamacion_motivo_no_reclamacion11"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion11"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion11"] : "MOTIVO NO RECLAMACION11";
   ...
   $tab_labels["historial_reclamacion_mes12"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes12"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_mes12"] : "MES12";
   ...
   $tab_labels["historial_reclamacion_reclamo12"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo12"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_reclamo12"] : "RECLAMO12";
   ...
   $tab_labels["historial_reclamacion_fecha_reclamacion12"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion12"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_fecha_reclamacion12"] : "FECHA RECLAMACION12";
   ...
   $tab_labels["historial_reclamacion_motivo_no_reclamacion12"]   = (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion12"])) ? $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['labels']["historial_reclamacion_motivo_no_reclamacion12"] : "MOTIVO NO RECLAMACION12";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "HISTORICO_RECLAMACIONES_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['HISTORICO_RECLAMACIONES']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
