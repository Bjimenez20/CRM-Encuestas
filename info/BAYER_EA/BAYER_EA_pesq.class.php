...
class EA_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . EA_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . EA_pack_protect_string($Tipo_filter[0]) . "\">.." . EA_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_evento_adverso_fecha_staff')
      {
          $evento_adverso_fecha_staff = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_evento_adverso_fecha_staff($evento_adverso_fecha_staff);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_evento_adverso_id_evento_adverso')
      {
          $evento_adverso_id_evento_adverso = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_evento_adverso_id_evento_adverso($evento_adverso_id_evento_adverso);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_evento_adverso_pais')
      {
          $evento_adverso_pais = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_evento_adverso_pais($evento_adverso_pais);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_evento_adverso_tipo_reporte')
      {
          $evento_adverso_tipo_reporte = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_evento_adverso_tipo_reporte($evento_adverso_tipo_reporte);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_evento_adverso_fecha_staff($evento_adverso_fecha_staff)
   {
      $evento_adverso_fecha_staff = substr($this->Db->qstr($evento_adverso_fecha_staff), 1, -1);
            $evento_adverso_fecha_staff_look = substr($this->Db->qstr($evento_adverso_fecha_staff), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct evento_adverso.FECHA_STAFF from " . $this->Ini->nm_tabela . " where  evento_adverso.FECHA_STAFF like '%" . $evento_adverso_fecha_staff . "%'"; 
   ...
   function lookup_ajax_evento_adverso_id_evento_adverso($evento_adverso_id_evento_adverso)
   {
      $evento_adverso_id_evento_adverso = substr($this->Db->qstr($evento_adverso_id_evento_adverso), 1, -1);
            $evento_adverso_id_evento_adverso_look = substr($this->Db->qstr($evento_adverso_id_evento_adverso), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct evento_adverso.ID_EVENTO_ADVERSO from " . $this->Ini->nm_tabela . " where  evento_adverso.ID_EVENTO_ADVERSO like '%" . $evento_adverso_id_evento_adverso . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_evento_adverso_pais($evento_adverso_pais)
   {
      $evento_adverso_pais = substr($this->Db->qstr($evento_adverso_pais), 1, -1);
            $evento_adverso_pais_look = substr($this->Db->qstr($evento_adverso_pais), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct evento_adverso.PAIS from " . $this->Ini->nm_tabela . " where  evento_adverso.PAIS like '%" . $evento_adverso_pais . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_evento_adverso_tipo_reporte($evento_adverso_tipo_reporte)
   {
      $evento_adverso_tipo_reporte = substr($this->Db->qstr($evento_adverso_tipo_reporte), 1, -1);
            $evento_adverso_tipo_reporte_look = substr($this->Db->qstr($evento_adverso_tipo_reporte), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct evento_adverso.TIPO_REPORTE from " . $this->Ini->nm_tabela . " where  evento_adverso.TIPO_REPORTE like '%" . $evento_adverso_tipo_reporte . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>EA/EA_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="EA_ajax_search.js"></script>
 <script type="text/javascript" src="EA_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_evento_adverso_fecha_staff_cond#NMF#' + search_get_sel_txt('SC_evento_adverso_fecha_staff_cond') + '@NMF@';
  str_out += 'SC_evento_adverso_fecha_staff#NMF#' + search_get_text('SC_evento_adverso_fecha_staff') + '@NMF@';
  str_out += 'id_ac_evento_adverso_fecha_staff#NMF#' + search_get_text('id_ac_evento_adverso_fecha_staff') + '@NMF@';
  str_out += 'SC_evento_adverso_id_evento_adverso_cond#NMF#' + search_get_sel_txt('SC_evento_adverso_id_evento_adverso_cond') + '@NMF@';
  str_out += 'SC_evento_adverso_id_evento_adverso#NMF#' + search_get_text('SC_evento_adverso_id_evento_adverso') + '@NMF@';
  str_out += 'id_ac_evento_adverso_id_evento_adverso#NMF#' + search_get_text('id_ac_evento_adverso_id_evento_adverso') + '@NMF@';
  str_out += 'SC_evento_adverso_id_evento_adverso_input_2#NMF#' + search_get_text('SC_evento_adverso_id_evento_adverso_input_2') + '@NMF@';
  str_out += 'SC_evento_adverso_pais_cond#NMF#' + search_get_sel_txt('SC_evento_adverso_pais_cond') + '@NMF@';
  str_out += 'SC_evento_adverso_pais#NMF#' + search_get_text('SC_evento_adverso_pais') + '@NMF@';
  str_out += 'id_ac_evento_adverso_pais#NMF#' + search_get_text('id_ac_evento_adverso_pais') + '@NMF@';
  str_out += 'SC_evento_adverso_tipo_reporte_cond#NMF#' + search_get_sel_txt('SC_evento_adverso_tipo_reporte_cond') + '@NMF@';
  str_out += 'SC_evento_adverso_tipo_reporte#NMF#' + search_get_text('SC_evento_adverso_tipo_reporte') + '@NMF@';
  str_out += 'id_ac_evento_adverso_tipo_reporte#NMF#' + search_get_text('id_ac_evento_adverso_tipo_reporte') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_evento_adverso_id_evento_adverso").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_evento_adverso_id_evento_adverso",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_evento_adverso_id_evento_adverso").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_evento_adverso_id_evento_adverso").val( $(this).val() );
       }
     }
   });
   $("#id_ac_evento_adverso_pais").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_evento_adverso_pais",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_evento_adverso_pais").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_evento_adverso_pais").val( $(this).val() );
       }
     }
   });
   $("#id_ac_evento_adverso_tipo_reporte").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_evento_adverso_tipo_reporte",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_evento_adverso_tipo_reporte").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_evento_adverso_tipo_reporte").val( $(this).val() );
       }
     }
   });
   $("#id_ac_evento_adverso_fecha_staff").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_evento_adverso_fecha_staff",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_evento_adverso_fecha_staff").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_evento_adverso_fecha_staff").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      global 
             $evento_adverso_fecha_staff_cond, $evento_adverso_fecha_staff, $evento_adverso_fecha_staff_autocomp,
             $evento_adverso_id_evento_adverso_cond, $evento_adverso_id_evento_adverso, $evento_adverso_id_evento_adverso_input_2, $evento_adverso_id_evento_adverso_autocomp,
             $evento_adverso_pais_cond, $evento_adverso_pais, $evento_adverso_pais_autocomp,
             $evento_adverso_tipo_reporte_cond, $evento_adverso_tipo_reporte, $evento_adverso_tipo_reporte_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $evento_adverso_fecha_staff = $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_fecha_staff']; 
          $evento_adverso_fecha_staff_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_fecha_staff_cond']; 
          $evento_adverso_id_evento_adverso = $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_id_evento_adverso']; 
          $evento_adverso_id_evento_adverso_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_id_evento_adverso_input_2']; 
          $evento_adverso_id_evento_adverso_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_id_evento_adverso_cond']; 
          $evento_adverso_pais = $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_pais']; 
          $evento_adverso_pais_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_pais_cond']; 
          $evento_adverso_tipo_reporte = $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_tipo_reporte']; 
          $evento_adverso_tipo_reporte_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_tipo_reporte_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['NM_operador']; 
      } 
      if (!isset($evento_adverso_fecha_staff_cond) || empty($evento_adverso_fecha_staff_cond))
      {
         $evento_adverso_fecha_staff_cond = "qp";
      }
      if (!isset($evento_adverso_id_evento_adverso_cond) || empty($evento_adverso_id_evento_adverso_cond))
      {
         $evento_adverso_id_evento_adverso_cond = "gt";
      }
      if (!isset($evento_adverso_pais_cond) || empty($evento_adverso_pais_cond))
      {
         $evento_adverso_pais_cond = "qp";
      }
      if (!isset($evento_adverso_tipo_reporte_cond) || empty($evento_adverso_tipo_reporte_cond))
      {
         $evento_adverso_tipo_reporte_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_evento_adverso_fecha_staff = (in_array($evento_adverso_fecha_staff_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_evento_adverso_id_evento_adverso = (in_array($evento_adverso_id_evento_adverso_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_evento_adverso_pais = (in_array($evento_adverso_pais_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_evento_adverso_tipo_reporte = (in_array($evento_adverso_tipo_reporte_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_evento_adverso_id_evento_adverso = ('bw' == $evento_adverso_id_evento_adverso_cond) ? $display_aberto : $display_fechado;

      if (!isset($evento_adverso_fecha_staff) || $evento_adverso_fecha_staff == "")
      {
          $evento_adverso_fecha_staff = "";
      }
      if (isset($evento_adverso_fecha_staff) && !empty($evento_adverso_fecha_staff))
      {
         $tmp_pos = strpos($evento_adverso_fecha_staff, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $evento_adverso_fecha_staff = substr($evento_adverso_fecha_staff, 0, $tmp_pos);
         }
      }
      if (!isset($evento_adverso_id_evento_adverso) || $evento_adverso_id_evento_adverso == "")
      {
          $evento_adverso_id_evento_adverso = "";
      }
      if (isset($evento_adverso_id_evento_adverso) && !empty($evento_adverso_id_evento_adverso))
      {
         $tmp_pos = strpos($evento_adverso_id_evento_adverso, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $evento_adverso_id_evento_adverso = substr($evento_adverso_id_evento_adverso, 0, $tmp_pos);
         }
      }
      if (!isset($evento_adverso_pais) || $evento_adverso_pais == "")
      {
          $evento_adverso_pais = "";
      }
      if (isset($evento_adverso_pais) && !empty($evento_adverso_pais))
      {
         $tmp_pos = strpos($evento_adverso_pais, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $evento_adverso_pais = substr($evento_adverso_pais, 0, $tmp_pos);
         }
      }
      if (!isset($evento_adverso_tipo_reporte) || $evento_adverso_tipo_reporte == "")
      {
          $evento_adverso_tipo_reporte = "";
      }
      if (isset($evento_adverso_tipo_reporte) && !empty($evento_adverso_tipo_reporte))
      {
         $tmp_pos = strpos($evento_adverso_tipo_reporte, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $evento_adverso_tipo_reporte = substr($evento_adverso_tipo_reporte, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['evento_adverso_fecha_staff'])) ? $this->New_label['evento_adverso_fecha_staff'] : "FECHA STAFF"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_evento_adverso_fecha_staff_cond" name="evento_adverso_fecha_staff_cond" onChange="nm_campos_between(document.getElementById('id_vis_evento_adverso_fecha_staff'), this, 'evento_adverso_fecha_staff')">
       <OPTION value="qp" <?php if ("qp" == $evento_adverso_fecha_staff_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $evento_adverso_fecha_staff_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $evento_adverso_fecha_staff_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $evento_adverso_fecha_staff_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_evento_adverso_fecha_staff" <?php echo $str_hide_evento_adverso_fecha_staff?> valign="top">
 ...
 $nmgp_tab_label .= "evento_adverso_fecha_staff?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $evento_adverso_fecha_staff_look = substr($this->Db->qstr($evento_adverso_fecha_staff), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct evento_adverso.FECHA_STAFF from " . $this->Ini->nm_tabela . " where evento_adverso.FECHA_STAFF = '$evento_adverso_fecha_staff_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$evento_adverso_fecha_staff]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$evento_adverso_fecha_staff];
      }
      else
      {
          $sAutocompValue = $evento_adverso_fecha_staff;
      }
?>
<INPUT  type="text" id="SC_evento_adverso_fecha_staff" name="evento_adverso_fecha_staff" value="<?php echo NM_encode_input($evento_adverso_fecha_staff) ?>" size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_evento_adverso_fecha_staff" name="evento_adverso_fecha_staff_autocomp" size="10" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['evento_adverso_id_evento_adverso'])) ? $this->New_label['evento_adverso_id_evento_adverso'] : "ID EVENTO ADVERSO"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_evento_adverso_id_evento_adverso_cond" name="evento_adverso_id_evento_adverso_cond" onChange="nm_campos_between(document.getElementById('id_vis_evento_adverso_id_evento_adverso'), this, 'evento_adverso_id_evento_adverso')">
       <OPTION value="gt" <?php if ("gt" == $evento_adverso_id_evento_adverso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $evento_adverso_id_evento_adverso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $evento_adverso_id_evento_adverso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $evento_adverso_id_evento_adverso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_evento_adverso_id_evento_adverso" <?php echo $str_hide_evento_adverso_id_evento_adverso?> valign="top">
 ...
 $nmgp_tab_label .= "evento_adverso_id_evento_adverso?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $evento_adverso_id_evento_adverso_look = substr($this->Db->qstr($evento_adverso_id_evento_adverso), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($evento_adverso_id_evento_adverso))
   { 
      $nm_comando = "select distinct evento_adverso.ID_EVENTO_ADVERSO from " . $this->Ini->nm_tabela . " where evento_adverso.ID_EVENTO_ADVERSO = $evento_adverso_id_evento_adverso_look"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$evento_adverso_id_evento_adverso]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$evento_adverso_id_evento_adverso];
      }
      else
      {
          $sAutocompValue = $evento_adverso_id_evento_adverso;
      }
?>
<INPUT  type="text" id="SC_evento_adverso_id_evento_adverso" name="evento_adverso_id_evento_adverso" value="<?php echo NM_encode_input($evento_adverso_id_evento_adverso) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_evento_adverso_id_evento_adverso" name="evento_adverso_id_evento_adverso_autocomp" size="19" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_evento_adverso_id_evento_adverso"  <?php echo $str_display_evento_adverso_id_evento_adverso; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_evento_adverso_id_evento_adverso_input_2" name="evento_adverso_id_evento_adverso_input_2" value="<?php echo NM_encode_input($evento_adverso_id_evento_adverso_input_2) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['evento_adverso_pais'])) ? $this->New_label['evento_adverso_pais'] : "PAIS"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_evento_adverso_pais_cond" name="evento_adverso_pais_cond" onChange="nm_campos_between(document.getElementById('id_vis_evento_adverso_pais'), this, 'evento_adverso_pais')">
       <OPTION value="qp" <?php if ("qp" == $evento_adverso_pais_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $evento_adverso_pais_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $evento_adverso_pais_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $evento_adverso_pais_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_evento_adverso_pais" <?php echo $str_hide_evento_adverso_pais?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['evento_adverso_pais'])) ? $this->New_label['evento_adverso_pais'] : "PAIS";
 $nmgp_tab_label .= "evento_adverso_pais?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $evento_adverso_pais_look = substr($this->Db->qstr($evento_adverso_pais), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct evento_adverso.PAIS from " . $this->Ini->nm_tabela . " where evento_adverso.PAIS = '$evento_adverso_pais_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$evento_adverso_pais]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$evento_adverso_pais];
      }
      else
      {
          $sAutocompValue = $evento_adverso_pais;
      }
?>
<INPUT  type="text" id="SC_evento_adverso_pais" name="evento_adverso_pais" value="<?php echo NM_encode_input($evento_adverso_pais) ?>" size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_evento_adverso_pais" name="evento_adverso_pais_autocomp" size="15" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['evento_adverso_tipo_reporte'])) ? $this->New_label['evento_adverso_tipo_reporte'] : "TIPO REPORTE"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_evento_adverso_tipo_reporte_cond" name="evento_adverso_tipo_reporte_cond" onChange="nm_campos_between(document.getElementById('id_vis_evento_adverso_tipo_reporte'), this, 'evento_adverso_tipo_reporte')">
       <OPTION value="qp" <?php if ("qp" == $evento_adverso_tipo_reporte_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $evento_adverso_tipo_reporte_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $evento_adverso_tipo_reporte_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $evento_adverso_tipo_reporte_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_evento_adverso_tipo_reporte" <?php echo $str_hide_evento_adverso_tipo_reporte?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['evento_adverso_tipo_reporte'])) ? $this->New_label['evento_adverso_tipo_reporte'] : "TIPO REPORTE";
 $nmgp_tab_label .= "evento_adverso_tipo_reporte?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $evento_adverso_tipo_reporte_look = substr($this->Db->qstr($evento_adverso_tipo_reporte), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct evento_adverso.TIPO_REPORTE from " . $this->Ini->nm_tabela . " where evento_adverso.TIPO_REPORTE = '$evento_adverso_tipo_reporte_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$evento_adverso_tipo_reporte]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$evento_adverso_tipo_reporte];
      }
      else
      {
          $sAutocompValue = $evento_adverso_tipo_reporte;
      }
?>
<INPUT  type="text" id="SC_evento_adverso_tipo_reporte" name="evento_adverso_tipo_reporte" value="<?php echo NM_encode_input($evento_adverso_tipo_reporte) ?>" size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_evento_adverso_tipo_reporte" name="evento_adverso_tipo_reporte_autocomp" size="15" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['EA']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['EA']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['EA']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_evento_adverso_fecha_staff'), document.F1.evento_adverso_fecha_staff_cond, 'evento_adverso_fecha_staff');
   document.F1.evento_adverso_fecha_staff.value = "";
   document.F1.evento_adverso_fecha_staff_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_evento_adverso_id_evento_adverso'), document.F1.evento_adverso_id_evento_adverso_cond, 'evento_adverso_id_evento_adverso');
   document.F1.evento_adverso_id_evento_adverso.value = "";
   document.F1.evento_adverso_id_evento_adverso_autocomp.value = "";
   document.F1.evento_adverso_id_evento_adverso_input_2.value = "";
   nm_campos_between(document.getElementById('id_vis_evento_adverso_pais'), document.F1.evento_adverso_pais_cond, 'evento_adverso_pais');
   document.F1.evento_adverso_pais.value = "";
   document.F1.evento_adverso_pais_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_evento_adverso_tipo_reporte'), document.F1.evento_adverso_tipo_reporte_cond, 'evento_adverso_tipo_reporte');
   document.F1.evento_adverso_tipo_reporte.value = "";
   document.F1.evento_adverso_tipo_reporte_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['EA']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_evento_adverso_fecha_staff_cond'] = 'cond';
      $tp_fields['SC_evento_adverso_fecha_staff'] = 'text_aut';
      $tp_fields['id_ac_evento_adverso_fecha_staff'] = 'text_aut';
      $tp_fields['SC_evento_adverso_id_evento_adverso_cond'] = 'cond';
      $tp_fields['SC_evento_adverso_id_evento_adverso'] = 'text_aut';
      $tp_fields['id_ac_evento_adverso_id_evento_adverso'] = 'text_aut';
      $tp_fields['SC_evento_adverso_id_evento_adverso_input_2'] = 'text';
      $tp_fields['SC_evento_adverso_pais_cond'] = 'cond';
      $tp_fields['SC_evento_adverso_pais'] = 'text_aut';
      $tp_fields['id_ac_evento_adverso_pais'] = 'text_aut';
      $tp_fields['SC_evento_adverso_tipo_reporte_cond'] = 'cond';
      $tp_fields['SC_evento_adverso_tipo_reporte'] = 'text_aut';
      $tp_fields['id_ac_evento_adverso_tipo_reporte'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $evento_adverso_fecha_staff_cond, $evento_adverso_fecha_staff, $evento_adverso_fecha_staff_autocomp,
             $evento_adverso_id_evento_adverso_cond, $evento_adverso_id_evento_adverso, $evento_adverso_id_evento_adverso_input_2, $evento_adverso_id_evento_adverso_autocomp,
             $evento_adverso_pais_cond, $evento_adverso_pais, $evento_adverso_pais_autocomp,
             $evento_adverso_tipo_reporte_cond, $evento_adverso_tipo_reporte, $evento_adverso_tipo_reporte_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($evento_adverso_fecha_staff_autocomp) && empty($evento_adverso_fecha_staff))
      {
          $evento_adverso_fecha_staff = $evento_adverso_fecha_staff_autocomp;
      }
      if (!empty($evento_adverso_id_evento_adverso_autocomp) && empty($evento_adverso_id_evento_adverso))
      {
          $evento_adverso_id_evento_adverso = $evento_adverso_id_evento_adverso_autocomp;
      }
      if (!empty($evento_adverso_pais_autocomp) && empty($evento_adverso_pais))
      {
          $evento_adverso_pais = $evento_adverso_pais_autocomp;
      }
      if (!empty($evento_adverso_tipo_reporte_autocomp) && empty($evento_adverso_tipo_reporte))
      {
          $evento_adverso_tipo_reporte = $evento_adverso_tipo_reporte_autocomp;
      }
      $evento_adverso_fecha_staff_cond_salva = $evento_adverso_fecha_staff_cond; 
      if (!isset($evento_adverso_fecha_staff_input_2) || $evento_adverso_fecha_staff_input_2 == "")
      {
          $evento_adverso_fecha_staff_input_2 = $evento_adverso_fecha_staff;
      }
      $evento_adverso_id_evento_adverso_cond_salva = $evento_adverso_id_evento_adverso_cond; 
      if (!isset($evento_adverso_id_evento_adverso_input_2) || $evento_adverso_id_evento_adverso_input_2 == "")
      {
          $evento_adverso_id_evento_adverso_input_2 = $evento_adverso_id_evento_adverso;
      }
      $evento_adverso_pais_cond_salva = $evento_adverso_pais_cond; 
      if (!isset($evento_adverso_pais_input_2) || $evento_adverso_pais_input_2 == "")
      {
          $evento_adverso_pais_input_2 = $evento_adverso_pais;
      }
      $evento_adverso_tipo_reporte_cond_salva = $evento_adverso_tipo_reporte_cond; 
      if (!isset($evento_adverso_tipo_reporte_input_2) || $evento_adverso_tipo_reporte_input_2 == "")
      {
          $evento_adverso_tipo_reporte_input_2 = $evento_adverso_tipo_reporte;
      }
      if ($evento_adverso_id_evento_adverso_cond != "in")
      {
          nm_limpa_numero($evento_adverso_id_evento_adverso, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $evento_adverso_id_evento_adverso);
          ...
          $evento_adverso_id_evento_adverso = implode(",", $Nm_sc_valores);
      }
      if ($evento_adverso_id_evento_adverso_cond != "in")
      {
          nm_limpa_numero($evento_adverso_id_evento_adverso_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_fecha_staff'] = $evento_adverso_fecha_staff; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_fecha_staff_cond'] = $evento_adverso_fecha_staff_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_id_evento_adverso'] = $evento_adverso_id_evento_adverso; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_id_evento_adverso_input_2'] = $evento_adverso_id_evento_adverso_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_id_evento_adverso_cond'] = $evento_adverso_id_evento_adverso_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_pais'] = $evento_adverso_pais; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_pais_cond'] = $evento_adverso_pais_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_tipo_reporte'] = $evento_adverso_tipo_reporte; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['evento_adverso_tipo_reporte_cond'] = $evento_adverso_tipo_reporte_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']['NM_operador'] = $this->NM_operador; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['evento_adverso_fecha_staff'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['evento_adverso_fecha_staff'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['evento_adverso_fecha_staff'] = $evento_adverso_fecha_staff;
      }
      $evento_adverso_id_evento_adverso_look = substr($this->Db->qstr($evento_adverso_id_evento_adverso), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($evento_adverso_id_evento_adverso))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['evento_adverso_id_evento_adverso'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['evento_adverso_id_evento_adverso'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['evento_adverso_id_evento_adverso'] = $evento_adverso_id_evento_adverso;
      }
      $Conteudo = $evento_adverso_id_evento_adverso_input_2;
      if (strtoupper($evento_adverso_id_evento_adverso_cond) != "II" && strtoupper($evento_adverso_id_evento_adverso_cond) != "QP" && strtoupper($evento_adverso_id_evento_adverso_cond) != "NP" && strtoupper($evento_adverso_id_evento_adverso_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['evento_adverso_id_evento_adverso_input_2'] = $Conteudo;
      $evento_adverso_pais_look = substr($this->Db->qstr($evento_adverso_pais), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct evento_adverso.PAIS from " . $this->Ini->nm_tabela . " where evento_adverso.PAIS = '$evento_adverso_pais_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['evento_adverso_pais'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['evento_adverso_pais'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['evento_adverso_pais'] = $evento_adverso_pais;
      }
      $evento_adverso_tipo_reporte_look = substr($this->Db->qstr($evento_adverso_tipo_reporte), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct evento_adverso.TIPO_REPORTE from " . $this->Ini->nm_tabela . " where evento_adverso.TIPO_REPORTE = '$evento_adverso_tipo_reporte_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['evento_adverso_tipo_reporte'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['evento_adverso_tipo_reporte'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['evento_adverso_tipo_reporte'] = $evento_adverso_tipo_reporte;
      }

      //----- $evento_adverso_fecha_staff
      $this->Date_part = false;
      if (isset($evento_adverso_fecha_staff) || $evento_adverso_fecha_staff_cond == "nu" || $evento_adverso_fecha_staff_cond == "nn" || $evento_adverso_fecha_staff_cond == "ep" || $evento_adverso_fecha_staff_cond == "ne")
      {
         $this->monta_condicao("evento_adverso.FECHA_STAFF", $evento_adverso_fecha_staff_cond, $evento_adverso_fecha_staff, "", "evento_adverso_fecha_staff");
      }

      //----- $evento_adverso_id_evento_adverso
      $this->Date_part = false;
      if (isset($evento_adverso_id_evento_adverso) || $evento_adverso_id_evento_adverso_cond == "nu" || $evento_adverso_id_evento_adverso_cond == "nn" || $evento_adverso_id_evento_adverso_cond == "ep" || $evento_adverso_id_evento_adverso_cond == "ne")
      {
         $this->monta_condicao("evento_adverso.ID_EVENTO_ADVERSO", $evento_adverso_id_evento_adverso_cond, $evento_adverso_id_evento_adverso, $evento_adverso_id_evento_adverso_input_2, "evento_adverso_id_evento_adverso");
      }

      //----- $evento_adverso_pais
      $this->Date_part = false;
      if (isset($evento_adverso_pais) || $evento_adverso_pais_cond == "nu" || $evento_adverso_pais_cond == "nn" || $evento_adverso_pais_cond == "ep" || $evento_adverso_pais_cond == "ne")
      {
         $this->monta_condicao("evento_adverso.PAIS", $evento_adverso_pais_cond, $evento_adverso_pais, "", "evento_adverso_pais");
      }

      //----- $evento_adverso_tipo_reporte
      $this->Date_part = false;
      if (isset($evento_adverso_tipo_reporte) || $evento_adverso_tipo_reporte_cond == "nu" || $evento_adverso_tipo_reporte_cond == "nn" || $evento_adverso_tipo_reporte_cond == "ep" || $evento_adverso_tipo_reporte_cond == "ne")
      {
         $this->monta_condicao("evento_adverso.TIPO_REPORTE", $evento_adverso_tipo_reporte_cond, $evento_adverso_tipo_reporte, "", "evento_adverso_tipo_reporte");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['EA']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['EA']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['EA']['where_pesq_ant'] = $this->comando . $this->comando_fim;
