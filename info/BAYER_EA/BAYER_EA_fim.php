...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["fundem_____EA"]))
   {
      unset($_SESSION['session_sec_aplicacao']["fundem_____EA"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['EA']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['EA']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['EA']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['EA']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['EA']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['EA']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['EA']['embutida_filho'] as $ind => $sc_init)
          {
